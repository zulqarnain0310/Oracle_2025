...
--------------------------------------------------------
  ...
  CREATE MATERIALIZED VIEW "ACL_RBL_MISDB_PROD"."MD_REGEX_MVIEW" ("PROJECT_NAME", "PROJECT_ID", "CONNECTION_ID", "CONNECTION_NAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "PROGRAM_ID", "PROGRAM_NAME", "ITEM", "VALUE")
...
and regexp_count(p.native_sql,rg.REGEX,1,'ix')>0;
   ...
   COMMENT ON MATERIALIZED VIEW "ACL_RBL_MISDB_PROD"."MD_REGEX_MVIEW"  IS 'snapshot table for snapshot ACL_RBL_MISDB_PROD.MD_REGEX_MVIEW';
