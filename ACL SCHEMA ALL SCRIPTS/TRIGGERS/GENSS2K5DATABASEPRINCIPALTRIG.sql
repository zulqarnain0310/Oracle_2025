...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "ACL_RBL_MISDB_PROD"."GENSS2K5DATABASEPRINCIPALTRIG" BEFORE
...
/
ALTER TRIGGER "ACL_RBL_MISDB_PROD"."GENSS2K5DATABASEPRINCIPALTRIG" ENABLE;
