...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "ACL_RBL_MISDB_PROD"."GENSS2K5SCHEMATAKEYTRIG" BEFORE
...
/
ALTER TRIGGER "ACL_RBL_MISDB_PROD"."GENSS2K5SCHEMATAKEYTRIG" ENABLE;
