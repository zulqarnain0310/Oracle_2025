--------------------------------------------------------
--  DDL for Procedure OVERDUEREPORT_FINACLEANDECBF
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" 
AS
...
BEGIN
   ...
   DELETE FROM tt_OverdueReportPhase1;
   UTILS.IDENTITY_RESET('tt_OverdueReportPhase1');

   INSERT INTO tt_OverdueReportPhase1 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."OVERDUEREPORT_FINACLEANDECBF" TO "ADF_CDR_RBL_STGDB";
