--------------------------------------------------------
--  DDL for Procedure DGU_POSTMOC_TWO_REPORT_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" 
AS
...
BEGIN
   ...
   IF tt_ExceptionFinalStatusType_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_ExceptionFinalStatusType_3;
   UTILS.IDENTITY_RESET('tt_ExceptionFinalStatusType_3');

   INSERT INTO tt_ExceptionFinalStatusType_3 SELECT DISTINCT A.* ,
   ...
   DELETE tt_ExceptionFinalStatusType_3

    WHERE  RANK > 1;
   -----------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_OpeningBalance_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_OpeningBalance_3;
   UTILS.IDENTITY_RESET('tt_OpeningBalance_3');

   INSERT INTO tt_OpeningBalance_3 SELECT A.ACID ,
                                          B.PrincOutStd ,
                                          ROW_NUMBER() OVER ( PARTITION BY A.ACID ORDER BY A.ACID, B.EffectiveToTimeKey DESC  ) RANK  
        FROM tt_ExceptionFinalStatusType_3 A
       ...
       WHERE  ( ( a.EffectiveFromTimeKey <= v_LastQtrTimekey
                ...
                AND statustype = 'TWO';
   UPDATE tt_OpeningBalance_3
      SET PrincOutStd = 0
    WHERE  PrincOutStd < 0;
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_21ccountCal  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_Accountcal_3;
   UTILS.IDENTITY_RESET('tt_Accountcal_3');

   INSERT INTO tt_Accountcal_3 ( 
   	SELECT * 
   ...
   UPDATE tt_ExceptionFinalStatusType_3
   ...
   --------------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DimCustomer_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DimCustomer_3;
   UTILS.IDENTITY_RESET('tt_DimCustomer_3');

   INSERT INTO tt_DimCustomer_3 ( 
             ...
             JOIN ( SELECT DISTINCT CustomerID ,
                    ...
                    FROM CustomerBasicDetail 
                     WHERE  CustomerID IN ( SELECT DISTINCT CustomerId 
                                            FROM tt_ExceptionFinalStatusType_3  )
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_21  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_A_21;
   UTILS.IDENTITY_RESET('tt_A_21');
   	...
   	SELECT DISTINCT CustomerAcID ,
   	 ...
   	 WHERE  EffectiveFromTimeKey <= v_Timekey
              ...
              AND CustomerAcID IN ( SELECT b.CustomerAcID 
                                    FROM tt_ExceptionFinalStatusType_3 Z
                                           ...
                                           LEFT JOIN ( SELECT AcID CustomerACID  ,
                                                       ...
                                                       FROM tt_ExceptionFinalStatusType_3  ) Y   ON Z.ACID = Y.CustomerACID
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DPD_8  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_8;
   UTILS.IDENTITY_RESET('tt_DPD_8');

   INSERT INTO tt_DPD_8 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_8 
   ...
   ----/* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_41') IS NOT NULL THEN
    --drop table if exists tt_TWOReport_3_Final
   --select * into tt_TWOReport_3_Final from tt_TWOReport_3 
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_41 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_41;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_41');

   INSERT INTO tt_TEMPTABLE_41 ( 
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_TWOReport_3  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TWOReport_3;
   UTILS.IDENTITY_RESET('tt_TWOReport_3');

   INSERT INTO tt_TWOReport_3 ( 
   	SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
   	  ...
   	  FROM tt_ExceptionFinalStatusType_3 Z
             ...
             AND B.EffectiveFromTimeKey <= v_Timekey
             AND B.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_Accountcal_3 AC   ON Z.ACID = AC.CustomerACID
             LEFT JOIN PRO_RBL_MISDB_PROD.CustomerCal_Hist A   ON A.CustomerEntityID = b.CustomerEntityID
             AND A.EffectiveFromTimeKey <= v_Timekey
             AND A.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_DimCustomer_3 xyz   ON Z.CustomerID = xyz.CustomerId
             ...
             LEFT JOIN ( SELECT ACID CustomerAcID  ,
                                ...
                                StatusDate WriteOffDt  
                         FROM tt_ExceptionFinalStatusType_3  ) Y   ON Z.ACID = Y.CustomerAcID
             LEFT JOIN tt_DPD_8 DPD   ON DPD.AccountEntityID = b.AccountEntityID
   ...
   FROM A ,tt_TWOReport_3 A
          JOIN tt_Accountcal_3 B   ON A.Account_No_ = B.CustomerACID ) src
   ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DGU_POSTMOC_TWO_REPORT_04122023" TO "ADF_CDR_RBL_STGDB";
