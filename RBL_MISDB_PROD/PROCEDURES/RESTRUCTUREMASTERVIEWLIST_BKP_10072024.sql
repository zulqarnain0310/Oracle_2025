--------------------------------------------------------
--  DDL for Procedure RESTRUCTUREMASTERVIEWLIST_BKP_10072024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" 
-- =============================================
 -- Author:		<Author,,Name>
...
BEGIN
   ...
   IF utils.object_id('TempDB..#Previous') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Previous_14 ';
   END IF;
   BEGIN
   ...
   BEGIN
      IF utils.object_id('TempDB..tt_temp_243') IS NOT NULL THEN

      BEGIN
         EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_243 ';

      END;
      END IF;
      DELETE FROM tt_temp_243;
      UTILS.IDENTITY_RESET('tt_temp_243');

      INSERT INTO tt_temp_243 ( 
      	SELECT A.AccountEntityId ,
      	  ...
      	  FROM ( SELECT A.AccountEntityId ,
                       ...
                       AARDs ------Added by kapil on 1/07/2024
                       .Action 
                FROM CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail A
                       JOIN RBL_MISDB_PROD.AdvAcBasicDetail B   ON B.AccountEntityId = A.AccountEntityId
                       AND B.EffectiveFromTimeKey <= v_TimeKey
                       AND B.EffectiveToTimeKey >= v_TimeKey
                       LEFT JOIN RBL_MISDB_PROD.AdvAcRestructureDetail_Mod AARDs   ON A.AccountEntityId = AARDs.AccountEntityId
                       AND -------Added by kapil on 1/07/2024
                      AARDs.EffectiveFromTimeKey <= v_TimeKey
                       AND -------Added by kapil on 1/07/2024
                      AARDs.EffectiveToTimeKey >= v_TimeKey
                       AND NVL(AARDs.AuthorisationStatus, 'A') = 'A' -------Added by kapil on 1/07/2024
   ...
   ELSE
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_temp_2431') IS NOT NULL THEN

         BEGIN
            EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp1_17 ';

         END;
         END IF;
         DELETE FROM tt_temp1_17;
         UTILS.IDENTITY_RESET('tt_temp1_17');

         INSERT INTO tt_temp1_17 ( 
         	SELECT A.AccountEntityId ,
                 A.SystemACID ,
                 A.SourceName ,
                 A.CustomerId ,
         	  ...
         	  FROM ( SELECT A.AccountEntityId ,
                          ...
                          o.PrevQtrTotalProvision ,
                          DBS.AcBuRevisedSegmentCode AcBuSegmentDescription  ,
                          A.Action ----------------Newly added by kapil on 14/06/2024
      ...
      --set @RefSystemAcId = '9987880000000001'
      BEGIN
         IF utils.object_id('TempDB..tt_temp_2432') IS NOT NULL THEN

         BEGIN
            EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp2_10 ';

         END;
         END IF;
         DBMS_OUTPUT.PUT_LINE('Sachin11');
         DELETE FROM tt_temp2_10;
         UTILS.IDENTITY_RESET('tt_temp2_10');

         INSERT INTO tt_temp2_10 ( 
         	SELECT A.AccountEntityId ,
                 A.SystemACID ,
                 A.SourceName ,
                 A.CustomerId ,
         	  ...
         	  --,'Add' Action                                  ----------------Newly added by kapil on 14/06/2024
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERVIEWLIST_BKP_10072024" TO "ADF_CDR_RBL_STGDB";
