--------------------------------------------------------
--  DDL for Procedure RESTRUCTUREMASTERSEARCHLIST_04052023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" 
---------------------------------------------------------------------------------------------------------------------------
 ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..#Previous') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Previous_3 ';
         END IF;
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_232') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_232 ';
            END IF;
            DELETE FROM tt_temp_232;
            UTILS.IDENTITY_RESET('tt_temp_232');

            INSERT INTO tt_temp_232 ( 
            	SELECT A.AccountEntityId ,
            	  ...
            	  FROM ( SELECT A.AccountEntityId ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(AccountOpenDate,200),10,p_style=>103) AccountOpenDate  ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(B.CurrentLimitDt,200),10,p_style=>103) SanctionLimitDt  ,
                             --,E.AssetClassAlt_Key -----------chk
                             A.RestructureAssetClassAlt_key ,
                             J.AssetClassName ,
                             UTILS.CONVERT_TO_VARCHAR2(A.PreRestrucNPA_Date,10,p_style=>103) NpaDt  ,
                             --,Convert(Date,B.DtofFirstDisb,103)DtofFirstDisb
                             --,convert(varchar(10),cast(B.DtofFirstDisb as date),103) DtofFirstDisb
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.DisbursementDate,200),10,p_style=>103) DtofFirstDisb  ,
                             A.RestructureTypeAlt_Key ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.PreRestrucDefaultDate,200),10,p_style=>103) PreRestrucDefaultDate  ,
                             Q.AssetClassName PreAssetClassName  ,
                             --,Convert(Date,Y.NPADt,103)PreRestrucNPA_Date
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(Y.NPADt,200),10,p_style=>103) PreRestrucNPA_Date  ,
                             R.AssetClassName PostAssetClassName  ,
                             A.Npa_Qtr ,
                             --,Convert(Date,A.RestructureDt,103)RestructureDt
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RestructureDate,200),10,p_style=>103) RestructureDt  ,
                             --,Convert(Date,A.RestructureProposalDt,103)RestructureProposalDt
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RestructureProposalDt,200),10,p_style=>103) RestructureProposalDt  ,
                             A.RestructureAmt ,
                             A.ApprovingAuthAlt_Key ,
                             --,Convert(Date,A.RestructureApprovalDt,103)RestructureApprovalDt
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RestructureApprovalDt,200),10,p_style=>103) RestructureApprovalDt  ,
                             --,Convert(Date,A.RepaymentStartDate,103) POS_RepayStartDate
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RepaymentStartDate,200),10,p_style=>103) POS_RepayStartDate  ,
                             A.RestructurePOS ,
                             --,Convert(Date,A.IntRepayStartDate,103)IntRepayStartDate
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.IntRepayStartDate,200),10,p_style=>103) IntRepayStartDate  ,
                             --,Convert(Date,A.RefDate,103)RefDate
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RefDate,200),10,p_style=>103) RefDate  ,
                             --,Convert(Date,A.InvocationDate,103)InvocationDate
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.InvocationDate,200),10,p_style=>103) InvocationDate  ,
                             A.IsEquityCoversion ,
                             --,Convert(Date,A.ConversionDate,103)ConversionDate
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.ConversionDate,200),10,p_style=>103) ConversionDate  ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.ICA_SignDate,200),10,p_style=>103) ICA_SignDate  ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.CRILIC_Fst_DefaultDate,200),10,p_style=>103) CRILIC_Fst_DefaultDate  ,
            	  ...
            	  AND DimParameterName = 'DimYesNoNA' ) S   ON S.ParameterAlt_Key = A.Is_COVID_Morat
                      ...
                      SELECT A.AccountEntityId ,
                             ...
                             UTILS.CONVERT_TO_VARCHAR2(A.PreRestrucNPA_Date,10,p_style=>103) NpaDt  ,
                             --,Convert(Date,B.DtofFirstDisb,103)DtofFirstDisb
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(B.DtofFirstDisb,200),10,p_style=>103) DtofFirstDisb  ,
                             A.RestructureTypeAlt_Key ,
                             k.ParameterName RestructureType  ,
                             A.RestructureCatgAlt_Key ,
                             L.ParameterName RestructureFacility  ,
                             ...
                             A.Npa_Qtr ,
                             --,Convert(Date,A.RestructureDt,103)RestructureDt
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RestructureDt,200),10,p_style=>103) RestructureDt  ,
                             --,Convert(Date,A.RestructureProposalDt,103)RestructureProposalDt
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(A.RestructureProposalDt,200),10,p_style=>103) RestructureProposalDt  ,
                             A.RestructureAmt ,
                             A.ApprovingAuthAlt_Key ,
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_23216') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_185 ';
            END IF;
            DELETE FROM tt_temp16_185;
            UTILS.IDENTITY_RESET('tt_temp16_185');

            INSERT INTO tt_temp16_185 ( 
            	SELECT A.AccountEntityId ,
                    A.SystemACID ,
                    A.SourceName ,
                    A.CustomerId ,
            	  ...
            	  FROM ( SELECT A.AccountEntityId ,
                             ...
                             A.RestructureAssetClassAlt_key ,
                             J.AssetClassName ,
                             UTILS.CONVERT_TO_VARCHAR2(F.NpaDt,10,p_style=>103) NpaDt  ,
                             --,Convert(Date,B.DtofFirstDisb,103)DtofFirstDisb
                             UTILS.CONVERT_TO_VARCHAR2(UTILS.CONVERT_TO_VARCHAR2(B.DtofFirstDisb,200),10,p_style=>103) DtofFirstDisb  ,
                             A.RestructureTypeAlt_Key ,
                             k.ParameterName RestructureType  ,
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp_23220') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_150 ';
               END IF;
               DELETE FROM tt_temp20_150;
               UTILS.IDENTITY_RESET('tt_temp20_150');

               INSERT INTO tt_temp20_150 ( 
               	SELECT A.AccountEntityId ,
                       A.SystemACID ,
                       A.SourceName ,
                       A.CustomerId ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_04052023" TO "ADF_CDR_RBL_STGDB";
