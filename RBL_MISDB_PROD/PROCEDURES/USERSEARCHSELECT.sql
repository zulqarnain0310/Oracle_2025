--------------------------------------------------------
--  DDL for Procedure USERSEARCHSELECT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."USERSEARCHSELECT" 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
   ...
   -- where MenuId=@MenuID
   IF utils.object_id('TEMPDB..tt_Dept_ALTKEY') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Dept_ALTKEY ';
   END IF;
   DELETE FROM tt_Dept_ALTKEY;
   ...
   --SELECT 'tt_Dept_ALTKEY',* FROM tt_Dept_ALTKEY
   ELSE
   ...
   END;
   END IF;
   IF utils.object_id('TEMPDB..tt_BACID') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_BACID ';
   END IF;
   DELETE FROM tt_BACID;
   DBMS_OUTPUT.PUT_LINE('TABLE CREATED');
   IF NVL(v_ApplicableBacid, ' ') <> ' ' THEN

   BEGIN
      DBMS_OUTPUT.PUT_LINE(1);
      INSERT INTO tt_BACID
        ( SELECT Items BACID  
          FROM TABLE(SPLIT(v_ApplicableBacid, ','))  );

   END;

   ----SELECT * FROM tt_BACID
   ELSE
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            IF utils.object_id('TempDB..tt_temp_304') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_304 ';
            END IF;
            DELETE FROM tt_temp_304;
            UTILS.IDENTITY_RESET('tt_temp_304');

            INSERT INTO tt_temp_304 ( 
            	  ...
            	  AND DimParameterName = 'DimUserDesignation' ) Z   ON Z.ParameterAlt_Key = U.DesignationAlt_Key
                       WHERE  ( U.UserLoginID LIKE CASE 
                              ...
                              ELSE U.Activate
                                ...
                                --AND (ISNULL(DB.BACID,'') IN (SELECT BACID FROM tt_BACID))
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp_30416') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_247 ';
               END IF;
               DELETE FROM tt_temp16_247;
               UTILS.IDENTITY_RESET('tt_temp16_247');

               INSERT INTO tt_temp16_247 ( 
               	SELECT A.UserLoginID ,
                       A.UserName ,
                       A.UserRole ,
                       A.RoleDescription ,
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_30420') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_212 ';
            END IF;
            DELETE FROM tt_temp20_212;
            UTILS.IDENTITY_RESET('tt_temp20_212');

            INSERT INTO tt_temp20_212 ( 
            	SELECT A.UserLoginID ,
                    A.UserName ,
                    A.UserRole ,
                    A.RoleDescription ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERSEARCHSELECT" TO "ADF_CDR_RBL_STGDB";
