--------------------------------------------------------
--  DDL for Procedure SP_LOADBACKUPDATAINDWHMAIN
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" 
(
  iv_Date IN VARCHAR2
)
AS
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_LOADBACKUPDATAINDWHMAIN" TO "ADF_CDR_RBL_STGDB";
