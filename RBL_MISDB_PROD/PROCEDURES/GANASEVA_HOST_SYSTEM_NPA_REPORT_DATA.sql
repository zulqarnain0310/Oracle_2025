--------------------------------------------------------
--  DDL for Procedure GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" 
AS
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_TEMP_19  --SQLDEV: NOT RECOGNIZED
         ...
         -- ;with CTE as
         --(
         --select AccountID,status,ROW_NUMBER() over  (partition by AccountID order by status asc )rn from tt_TEMP_19
         --)delete  from #temp a inner join CTE b on a.accountid=b=accountid and a.status=b.status where rn>1
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_TEMP_191  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_TEMP1_14;
         UTILS.IDENTITY_RESET('tt_TEMP1_14');

         INSERT INTO tt_TEMP1_14 SELECT * 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."GANASEVA_HOST_SYSTEM_NPA_REPORT_DATA" TO "ADF_CDR_RBL_STGDB";
