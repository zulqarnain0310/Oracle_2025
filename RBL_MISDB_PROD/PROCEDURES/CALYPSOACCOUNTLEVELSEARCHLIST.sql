...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         DELETE FROM GTT_ACCOUNT_PREMOC_INVESTMENT;
         UTILS.IDENTITY_RESET('GTT_ACCOUNT_PREMOC_INVESTMENT');

         INSERT INTO GTT_ACCOUNT_PREMOC_INVESTMENT ( 
         	SELECT * 
         ...
         MERGE INTO GTT_ACCOUNT_PREMOC_INVESTMENT A
         USING (SELECT A.ROWID row_id, NVL(B.ParameterAlt_Key, 0) AS MOCReason
         FROM GTT_ACCOUNT_PREMOC_INVESTMENT A
         ...
         ----POST 
         --Select 'GTT_ACCOUNT_PREMOC_INVESTMENT',* from GTT_ACCOUNT_PREMOC_INVESTMENT
         ...
         FROM CalypsoAccountLevelMOC_Mod V
                ...
                JOIN GTT_MOCAuthorisation Z   ON X.INVID = Z.AccountID 
         ...
         FROM CalypsoAccountLevelMOC_Mod V
                ...
                JOIN GTT_MOCAuthorisation Z   ON X.DerivativeRefNo = Z.AccountID 
          WHERE X.AuthorisationStatus IN ( 'NP','MP','DP','1A' )
