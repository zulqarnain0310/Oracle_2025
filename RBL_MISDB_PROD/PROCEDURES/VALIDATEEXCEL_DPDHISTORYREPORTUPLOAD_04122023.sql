--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" 
(
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF ( v_MenuID = 27768 ) THEN
          DECLARE
            ...
            /* --------------------------------------------------------------------------------------------------------------------------------------------------------------
            			...
            			UPDATE tt_UploadDPDHistReport_2 SET    
            			...
            			FROM tt_UploadDPDHistReport_2 V    
         ...
         BEGIN
            ...
            END;
            END IF;
            IF utils.object_id('TEMPDB..tt_UploadDPDHistReport_2') IS NOT NULL THEN

            BEGIN
               EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UploadDPDHistReport_2 ';
            ...
            BEGIN
               ...
               DELETE FROM tt_UploadDPDHistReport_2;
               UTILS.IDENTITY_RESET('tt_UploadDPDHistReport_2');

               INSERT INTO tt_UploadDPDHistReport_2 ( 
               	SELECT * ,
            ...
            END;
            END IF;
            UPDATE tt_UploadDPDHistReport_2 
             ...
             WHERE  NVL(SR_No, ' ') = ' '
              ...
              AND NVL(ACCOUNT_Id, ' ') = ' '
              AND NVL(UserLoginId, ' ') = ' ';
            UPDATE tt_UploadDPDHistReport_2 V
            ...
            UPDATE tt_UploadDPDHistReport_2 V
             ...
             WHERE  NVL(SR_No, ' ') <> ' '
              ...
              AND NVL(ACCOUNT_Id, ' ') = ' '
              AND NVL(UserLoginId, ' ') <> ' ';
            --IF EXISTS(SELECT 1 FROM tt_UploadDPDHistReport_2 WHERE ISNULL(ErrorMessage,'')<>'')  
            --BEGIN  
            --	PRINT 'NO DATA'  
            --	GOTO ERRORDATA;  
            --END
            ...
            --SELECT DISTINCT UserLoginId INTO #DistinctUserId FROM tt_UploadDPDHistReport_2
            ...
            ;
            IF utils.object_id('TEMPDB..tt_DUB_UCIF_2') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_UCIF_2 ';
            END IF;
            DELETE FROM tt_DUB_UCIF_2;
            UTILS.IDENTITY_RESET('tt_DUB_UCIF_2');

            INSERT INTO tt_DUB_UCIF_2 SELECT * 
                 FROM ( SELECT * ,
                               ROW_NUMBER() OVER ( PARTITION BY UCIC_ID ORDER BY UCIC_ID  ) rw  
                        FROM tt_UploadDPDHistReport_2  ) X
                WHERE  rw > 1;
            MERGE INTO V 
            ...
            FROM V ,tt_UploadDPDHistReport_2 V
                   JOIN tt_DUB_UCIF_2 D   ON D.UCIC_Id = V.UCIC_Id ) src
            ...
            UPDATE tt_UploadDPDHistReport_2 V
             ...
             WHERE  NVL(V.CIF_Id, ' ') <> ' '
              AND V.CIF_Id NOT IN ( SELECT DISTINCT CustomerId 
                                    FROM CustomerBasicDetail  )
            ;
            IF utils.object_id('TEMPDB..tt_DUB_CIF_2') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_CIF_2 ';
            END IF;
            DELETE FROM tt_DUB_CIF_2;
            UTILS.IDENTITY_RESET('tt_DUB_CIF_2');

            INSERT INTO tt_DUB_CIF_2 SELECT * 
                 FROM ( SELECT * ,
            ...
            ELSE V.ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'CUSTOMER ID'
               END AS pos_3, V.SR_No
            FROM V ,tt_UploadDPDHistReport_2 V
                   JOIN tt_DUB_CIF_2 D   ON D.CIF_ID = V.CIF_ID ) src
            ON ( V.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET V.ErrorMessage = pos_2,
                                         V.ErrorinColumn = pos_3,
                                         V.Srnooferroneousrows = src.SR_No;
            ...
            ;
            IF utils.object_id('TEMPDB..tt_DUB_ACCOUNTID_2') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_ACCOUNTID_2 ';
            END IF;
            DELETE FROM tt_DUB_ACCOUNTID_2;
            UTILS.IDENTITY_RESET('tt_DUB_ACCOUNTID_2');

            INSERT INTO tt_DUB_ACCOUNTID_2 SELECT * 
                 FROM ( SELECT * ,
            ...
            ELSE V.ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'ACCOUNT Id'
               END AS pos_3, V.SR_No
            FROM V ,tt_UploadDPDHistReport_2 V
                   JOIN tt_DUB_ACCOUNTID_2 D   ON D.ACCOUNT_Id = V.ACCOUNT_Id ) src
            ON ( V.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET V.ErrorMessage = pos_2,
                                         V.ErrorinColumn = pos_3,
                                         V.Srnooferroneousrows = src.SR_No;
            ...
            BEGIN
               ...
               BEGIN
                  DELETE tt_UploadDPDHistReport_2
                  ;
                  DBMS_OUTPUT.PUT_LINE(1);
                  DBMS_OUTPUT.PUT_LINE('ROWS DELETED FROM tt_UploadDPDHistReport_2' || UTILS.CONVERT_TO_VARCHAR2(SQL%ROWCOUNT,100));
         ...
         --	IF EXISTS(SELECT 1 FROM tt_UploadDPDHistReport_2)
         --	BEGIN
         --		DELETE FROM tt_UploadDPDHistReport_2
         --		PRINT 1
         --		PRINT 'ROWS DELETED FROM DBO.tt_UploadDPDHistReport_2'+CAST(@@ROWCOUNT AS VARCHAR(100))
         --	END
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_04122023" TO "ADF_CDR_RBL_STGDB";
