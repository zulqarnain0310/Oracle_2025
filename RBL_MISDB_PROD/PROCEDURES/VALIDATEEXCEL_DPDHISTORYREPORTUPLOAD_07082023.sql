--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" 
(
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            ;
            IF utils.object_id('TEMPDB..tt_DUB_UCIF_3') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_UCIF_3 ';
            END IF;
            DELETE FROM tt_DUB_UCIF_3;
            UTILS.IDENTITY_RESET('tt_DUB_UCIF_3');

            INSERT INTO tt_DUB_UCIF_3 SELECT * 
                 FROM ( SELECT * ,
            ...
            FROM V ,UploadDPDHistReport V
                   JOIN tt_DUB_UCIF_3 D   ON D.UCIC_Id = V.UCIC_Id ) src
            ...
            UPDATE UploadDPDHistReport V
             ...
             WHERE  NVL(V.CIF_Id, ' ') <> ' '
              AND V.CIF_Id NOT IN ( SELECT CustomerId 
                                    FROM CustomerBasicDetail  )
            ;
            IF utils.object_id('TEMPDB..tt_DUB_CIF_3') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_CIF_3 ';
            END IF;
            DELETE FROM tt_DUB_CIF_3;
            UTILS.IDENTITY_RESET('tt_DUB_CIF_3');

            INSERT INTO tt_DUB_CIF_3 SELECT * 
                 FROM ( SELECT * ,
            ...
            ELSE V.ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'CUSTOMER ID'
               END AS pos_3, V.Srnooferroneousrows
            FROM V ,UploadDPDHistReport V
                   JOIN tt_DUB_CIF_3 D   ON D.CIF_ID = V.CIF_Id ) src
            ON ( V.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET ErrorMessage = pos_2,
                                         ErrorinColumn = pos_3,
                                         Srnooferroneousrows = src.Srnooferroneousrows;
            ...
            ;
            IF utils.object_id('TEMPDB..tt_DUB_ACCOUNTID_3') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB_ACCOUNTID_3 ';
            END IF;
            DELETE FROM tt_DUB_ACCOUNTID_3;
            UTILS.IDENTITY_RESET('tt_DUB_ACCOUNTID_3');

            INSERT INTO tt_DUB_ACCOUNTID_3 SELECT * 
                 FROM ( SELECT * ,
            ...
            ELSE V.ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'ACCOUNT Id'
               END AS pos_3, V.Srnooferroneousrows
            FROM V ,UploadDPDHistReport V
                   JOIN tt_DUB_ACCOUNTID_3 D   ON D.ACCOUNT_Id = V.ACCOUNT_Id ) src
            ON ( V.ROWID = src.row_id )
            WHEN MATCHED THEN UPDATE SET ErrorMessage = pos_2,
                                         ErrorinColumn = pos_3,
                                         Srnooferroneousrows = src.Srnooferroneousrows;
         ...
         BEGIN
            ...
            END;
            END IF;
            IF utils.object_id('TEMPDB..tt_EMPTY') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_EMPTY ';
            END IF;
            DELETE FROM tt_EMPTY;
            OPEN  v_cursor FOR
               SELECT * 
                 FROM tt_EMPTY  ;
               DBMS_SQL.RETURN_RESULT(v_cursor);
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DPDHISTORYREPORTUPLOAD_07082023" TO "ADF_CDR_RBL_STGDB";
