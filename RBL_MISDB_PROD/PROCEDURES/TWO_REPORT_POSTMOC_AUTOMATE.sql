--------------------------------------------------------
--  DDL for Procedure TWO_REPORT_POSTMOC_AUTOMATE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" 
AS
...
BEGIN
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_144') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_144 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_144;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_144');

   INSERT INTO tt_TEMPTABLE_144 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC_AUTOMATE" TO "ADF_CDR_RBL_STGDB";
