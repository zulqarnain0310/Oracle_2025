--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" 
(
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM UploadCustMocUpload V
                   LEFT JOIN PRO_RBL_MISDB_PROD.CustomerCal_Hist B   ON V.SourceAlt_Key = B.SourceAlt_Key
                   AND V.CustomerID = B.RefCustomerID 
             WHERE ( NVL(B.SourceAlt_Key, ' ') = ' '
              OR NVL(B.RefCustomerID, ' ') = ' ' )) src
            ...
            IF utils.object_id('TempDB..tt_tmp_30') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_tmp_30 ';
            END IF;
            DELETE FROM tt_tmp_30;
            UTILS.IDENTITY_RESET('tt_tmp_30');

            INSERT INTO tt_tmp_30 SELECT ROW_NUMBER() OVER ( ORDER BY UTILS.CONVERT_TO_NUMBER(Entity_Key,10,0)  ) RecentRownumber  ,
                                         Entity_Key ,
                                         CustomerID 
                 FROM UploadCustMocUpload ;
            SELECT COUNT(*)  
            ...
            LOOP 
               ...
               BEGIN
                  ...
                  SELECT COUNT(1)  
                   ...
                   WHERE  RefCustomerID = v_RefCustomerID;
            ...
            INSERT INTO AssetClassValidationData SELECT * 
                 FROM ( SELECT ROW_NUMBER() OVER ( PARTITION BY B.CustomerID ORDER BY B.CustomerID  ) ROW_  ,
                        ...
                        FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
                               ...
                               JOIN DimAssetClass C   ON A.SysAssetClassAlt_Key = C.AssetClassAlt_Key ) X
                WHERE  ROW_ = 1;
            ...
            BEGIN
               UPDATE UploadCustMocUpload V
                  SET ErrorMessage = CASE 
                                          WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid value in column ‘Asset Class’. Kindly enter the values as mentioned in the ‘Asset Class’ master and upload again. Click on ‘Download Master value’ to download the valid values for th
                      ...
                      ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid value in column ‘Asset Class’. Kindly enter the values as mentioned in the ‘Asset Class’ master and upload again. Click on ‘Download Master value’ to download the valid values for the column'
                         END,
                      ErrorinColumn = CASE 
                                           WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'Asset Clas'
                      ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'Asset Clas'
                         END,
                      Srnooferroneousrows = V.SlNo
                WHERE  NVL(AssetClass, ' ') <> ' '
            ...
            UPDATE UploadCustMocUpload V
               SET ErrorMessage = CASE 
                                       WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'You have AssetClass SUB-STANDARD and You can change it only STANDARD,DOUBTFUL I,LOS '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'You have AssetClass SUB-STANDARD and You can change it only STANDARD,DOUBTFUL I,LOS. '
                      END,
                   ErrorinColumn = CASE 
                                        WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'AssetClass'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'AssetClass'
             ...
             WHERE  V.CustomerID IN ( SELECT B.CustomerID 
                                      FROM AssetClassValidationData B
                                       WHERE  (CASE 
                                                    WHEN NVL(AssetClassOrg, ' ') = 'SUB-STANDARD'
                                                      AND NVL(AssetClassUpload, ' ') NOT IN ( 'STANDARD','DOUBTFUL I','LOS','SUB-STANDARD' )
                                                     THEN 1
                                              ELSE 0
                                                 END) = 1 )
            ;
            /*TODO:SQLDEV*/  /*END:SQLDEV*/
            --------------NPADATE-----------------------
            UPDATE UploadCustMocUpload V
               SET V.ErrorMessage = CASE 
            ...
            UPDATE UploadCustMocUpload V
             ...
             WHERE  ( NVL(AssetClass, ' ') IN ( 'STANDARD' )
              ...
              AND (NPADATE) <> ' ';
            /*TODO:SQLDEV*/ UPDATE UploadCustM /*END:SQLDEV*/
            UPDATE UploadCustMocUpload V
               SET V.ErrorMessage = CASE 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_CUSTMOCUPLOAD_BACKUP_12122021" TO "ADF_CDR_RBL_STGDB";
