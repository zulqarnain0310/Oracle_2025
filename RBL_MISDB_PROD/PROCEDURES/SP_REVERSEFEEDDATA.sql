--------------------------------------------------------
--  DDL for Procedure SP_REVERSEFEEDDATA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" 
(
  v_TimeKey IN NUMBER
)
AS
...
BEGIN
   ...
   IF tt_DPD_45  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_45;
   UTILS.IDENTITY_RESET('tt_DPD_45');

   INSERT INTO tt_DPD_45 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
           ...
           ( SELECT dATE_ 
             FROM Automate_Advances 
            WHERE  tIMEKEY = 27075 ) ProcessDate  ,
           LastCrDate ,
           ContiExcessDt ,
           OverDueSinceDt ,
           ReviewDueDt ,
   	 ...
   	 WHERE  A.EffectiveFromTimeKey <= 27075
              AND A.EffectiveToTimeKey >= 27075
              AND B.EffectiveFromTimeKey <= 27075
              AND B.EffectiveToTimeKey >= 27075 );

   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_45 
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_136') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_136 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_136;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_136');

   INSERT INTO tt_TEMPTABLE_136 ( 
   ...
   FROM A ,tt_DPD_45 A
    ...
    WHERE ( NVL(C.FlgProcessing, 'N') = 'N' )
     ...
     AND C.EffectiveFromTimeKey <= 27075
     AND C.EffectiveToTimeKey >= 27075) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET A.DPD_Max = src.DPD_Max;
   DELETE ReverseFeedData

    WHERE  EffectiveFromTimekey <= 27075
             AND EffectiveToTimeKey >= 27075;
   INSERT INTO ReverseFeedData
     ...
     ( SELECT v_Date DateofData  ,
       ...
       FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
              ...
              AND C.EffectiveFromTimeKey <= 27075
              AND C.EffectiveToTimeKey >= 27075
              ...
              AND E.EffectiveFromTimeKey <= 27075
              AND E.EffectiveToTimeKey >= 27075
              LEFT JOIN tt_DPD_45 DPD   ON A.AccountEntityID = DPD.AccountEntityID
        WHERE  A.InitialAssetClassAlt_Key = 1
                 AND A.FinalAssetClassAlt_Key > 1
                 AND A.EffectiveFromTimeKey <= 27075
                 AND A.EffectiveToTimekey >= 27075
                 AND D.EffectiveFromTimeKey <= 27075
                 AND D.EffectiveToTimekey >= 27075
       UNION 
       SELECT v_Date DateofData  ,
              A.BranchCode ,
              A.RefCustomerID ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_REVERSEFEEDDATA" TO "ADF_CDR_RBL_STGDB";
