--------------------------------------------------------
--  DDL for Procedure INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" 
AS
...
BEGIN
   ...
   IF ( utils.object_id('TEMPDB..tt_MOC_DATA_38') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOC_DATA_38 ';
   END IF;
   DELETE FROM tt_MOC_DATA_38;
   UTILS.IDENTITY_RESET('tt_MOC_DATA_38');

   INSERT INTO tt_MOC_DATA_38 ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_UcifEntityID
      ON tt_MOC_DATA_38 ( CustomerEntityId)';
   IF ( utils.object_id('TEMPDB..tt_InvestmentFinancialDetai') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_InvestmentFinancialDetai ';
   END IF;
   DELETE FROM tt_InvestmentFinancialDetai;
   UTILS.IDENTITY_RESET('tt_InvestmentFinancialDetai');

   INSERT INTO tt_InvestmentFinancialDetai ( 
   	SELECT DISTINCT UTILS.CONVERT_TO_NVARCHAR2(v_Mocdate,30,p_style=>105) Process_Date  ,
   	  ...
   	  FROM InvestmentIssuerDetail a
             JOIN tt_MOC_DATA_38 BB   ON A.IssuerEntityId = BB.CustomerEntityID
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID
      ON tt_InvestmentFinancialDetai ( ISSUERID)';
   -------------------------------------------------  
   ...
   --INNER JOIN tt_MOC_DATA_38 B                        ON A.UcifEntityID=B.UcifEntityID
   --WHERE EffectiveFromTimeKey<=@TimeKey AND EffectiveToTimeKey>=@TimeKey  
   --OPTION(RECOMPILE)  
   --CREATE NONCLUSTERED INDEX INX_CustomerEntityID ON #CustomerCal_HIST(CustomerEntityID)  
   --INCLUDE (RefCustomerID)  
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CalypsoAccountLevelMOC_M') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CalypsoAccountLevelMOC_M ';
   END IF;
   DELETE FROM tt_CalypsoAccountLevelMOC_M;
   UTILS.IDENTITY_RESET('tt_CalypsoAccountLevelMOC_M');

   INSERT INTO tt_CalypsoAccountLevelMOC_M ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_AccountID
      ON tt_CalypsoAccountLevelMOC_M ( AccountID)';
   --select * from #AccountLevelMOC_Mod
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CalypsoCustomerLevelMOC_') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CalypsoCustomerLevelMOC_ ';
   END IF;
   DELETE FROM tt_CalypsoCustomerLevelMOC_;
   UTILS.IDENTITY_RESET('tt_CalypsoCustomerLevelMOC_');

   INSERT INTO tt_CalypsoCustomerLevelMOC_ ( 
   	SELECT Entity_Key ,
           A.CustomerEntityID ,
           ChangeField ,
           EffectiveFromTimekey ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID2
      ON tt_CalypsoCustomerLevelMOC_ ( CustomerEntityID)';
   IF ( utils.object_id('TEMPDB..tt_InvestmentFinancialDetai_2') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_InvestmentFinancialDetai_2 ';
   END IF;
   DELETE FROM tt_InvestmentFinancialDetai_2;
   UTILS.IDENTITY_RESET('tt_InvestmentFinancialDetai_2');

   INSERT INTO tt_InvestmentFinancialDetai_2 ( 
   	SELECT a.EntityKey ,
           a.InvEntityId ,
           RefInvID ,
           a.HoldingNature ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID1
      ON tt_InvestmentFinancialDetai_2 ( RefIssuerID)';
   --------------------------------------------  
   ...
   INSERT INTO tt_Final SELECT 'Post Moc' Moc_Status  ,
        ...
        FROM tt_InvestmentFinancialDetai A
               JOIN tt_CalypsoAccountLevelMOC_M ALM   ON ALM.AccountId = A.InvID
               LEFT JOIN tt_CalypsoCustomerLevelMOC_ CLM   ON A.IssuerEntityId = CLM.CustomerEntityId
      ...
      SELECT 'Pre Moc' Moc_Status  ,
             ...
             --	else DABS.AcBuSegmentDescription end                        AS AcBuSegmentDescription
             clm.AuthorisationStatus 
        FROM tt_InvestmentFinancialDetai_2 A
               JOIN tt_CalypsoAccountLevelMOC_M ALM   ON ALM.AccountId = A.RefInvID
               LEFT JOIN tt_CalypsoCustomerLevelMOC_ CLM   ON A.IssuerEntityId = CLM.CustomerEntityId
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM" TO "ADF_CDR_RBL_STGDB";
