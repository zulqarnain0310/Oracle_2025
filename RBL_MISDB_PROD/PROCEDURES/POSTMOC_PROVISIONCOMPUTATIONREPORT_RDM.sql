--------------------------------------------------------
--  DDL for Procedure POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" 
AS
...
BEGIN
   ...
   --------------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_ADVACRESTRUCTUREDETAIL_6') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ADVACRESTRUCTUREDETAIL_6 ';
   END IF;
   DELETE FROM tt_ADVACRESTRUCTUREDETAIL_6;
   UTILS.IDENTITY_RESET('tt_ADVACRESTRUCTUREDETAIL_6');

   INSERT INTO tt_ADVACRESTRUCTUREDETAIL_6 SELECT * 
        FROM ( SELECT * ,
   ...
   ------------------------------------------------------------------------
   ---------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrDataAccountWise_4') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrDataAccountWise_4 ';
   END IF;
   DELETE FROM tt_PrevQtrDataAccountWise_4;
   UTILS.IDENTITY_RESET('tt_PrevQtrDataAccountWise_4');

   INSERT INTO tt_PrevQtrDataAccountWise_4 ( 
   ...
   -------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrData_7') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrData_7 ';
   END IF;
   DELETE FROM tt_PrevQtrData_7;
   UTILS.IDENTITY_RESET('tt_PrevQtrData_7');

   INSERT INTO tt_PrevQtrData_7 ( 
   ...
   IF tt_dpd2_40  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_dpd2_40;
   UTILS.IDENTITY_RESET('tt_dpd2_40');

   INSERT INTO tt_dpd2_40 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_dpd2_40 
   ...
   --UPDATE A SET DPD_NoCredit=0 FROM tt_dpd2_40 A   
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_95') IS NOT NULL THEN
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_95 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_95;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_95');

   INSERT INTO tt_TEMPTABLE_95 ( 
   ...
   INSERT INTO RBL_MISDB_PROD.ProvisionComputation_PostMOC_Automate_RDM
     SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_Date  ,
            ...
            */
            ...
            a3.AssetClassSubGroup PREV_QTR_Asset_Classification ,---added by Prashant---02052024---
       ...
       FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
              ...
              LEFT JOIN tt_PrevQtrDataAccountWise_4 Y   ON A.CustomerEntityID = Y.CustomerEntityID
              AND b.CustomerAcID = Y.CustomerAcID
              LEFT JOIN tt_dpd2_40 DPD   ON B.AccountEntityID = DPD.AccountEntityID
              LEFT JOIN tt_PrevQtrData_7 prev   ON B.AccountEntityID = PREV.ACCOUNTENTITYID
              ...
              LEFT JOIN tt_ADVACRESTRUCTUREDETAIL_6 RES   ON RES.AccountEntityId = B.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM" TO "ADF_CDR_RBL_STGDB";
