--------------------------------------------------------
--  DDL for Procedure STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" 
AS
...
BEGIN
   ...
   IF utils.object_id('tempdb..tt_temp2_37') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp2_37 ';
   END IF;
   DELETE FROM tt_temp2_37;
   --=================================================Finacle==========================================================================    
   ...
   --  Convert(Varchar(10),NPADate,105) End  as DataUtility     
    /*   
        IF OBJECT_ID('TempDB..tt_Finacle_61') Is Not Null    
      Drop Table tt_Finacle_61    
   ...
   */
   ...
   IF utils.object_id('TempDB..tt_Finacle_61') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Finacle_61 ';
   END IF;
   DELETE FROM tt_Finacle_61;
   UTILS.IDENTITY_RESET('tt_Finacle_61');

   INSERT INTO tt_Finacle_61 ( 
   ...
   --  group by a.SourceAlt_Key,a.SourceSystemName    
   /*
       IF OBJECT_ID('TempDB..tt_Ganaseva_51') Is Not Null    
      Drop Table tt_Ganaseva_51    
      ...
      Y.EffectiveFromTimeKey<=@TimeKey and Y.EffectiveToTimeKey>=@TimeKey)   
      	...
      	Delete        a
   			from          tt_Ganaseva_51 a
   			inner join    ReverseFeedData b
   			on            a.CustomerAcID=b.AccountID
   			where         DateofData=@Date
        */
   ----------------    
   IF utils.object_id('TempDB..tt_Ganaseva_51') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Ganaseva_51 ';
   END IF;
   DELETE FROM tt_Ganaseva_51;
   UTILS.IDENTITY_RESET('tt_Ganaseva_51');

   INSERT INTO tt_Ganaseva_51 ( 
   ...
   --  group by a.SourceAlt_Key,a.SourceSystemName    
   /*  
     IF OBJECT_ID('TempDB..tt_VisionPlus_20') Is Not Null      
   Drop Table tt_VisionPlus_20      

   Select A.CustomerAcID,A.FinalAssetClassAlt_Key,A.FinalNpaDt,B.SourceAssetClass,B.SourceNpaDate,      
   DA.AssetClassAlt_Key BankAssetClass ,ds.SourceAlt_Key,ds.SourceName    
     INto tt_VisionPlus_20      
    from Pro.ACCOUNTCAL A      
   Inner Join dbo.AdvAcBalanceDetail B ON A.AccountEntityID=B.AccountEntityID      
   ANd B.EffectiveFromTimeKey<=@Timekey ANd B.EffectiveToTimeKey>=@Timekey      
   Inner Join DIMSOURCEDB DS ON DS.SourceAlt_Key=A.SourceAlt_Key      
   ...
   ANd Not exists (Select 1 from ReverseFeedDataInsertSync R where A.CustomerAcID=R.CustomerAcID    
      ...
      Y.EffectiveFromTimeKey<=@TimeKey and Y.EffectiveToTimeKey>=@TimeKey)    
      	...
      	Delete        a
   			from          tt_VisionPlus_20 a
   			inner join    ReverseFeedData b
   			on            a.CustomerAcID=b.AccountID
   			where         DateofData=@Date
       */
   IF utils.object_id('TempDB..tt_VisionPlus_20') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_VisionPlus_20 ';
   END IF;
   DELETE FROM tt_VisionPlus_20;
   UTILS.IDENTITY_RESET('tt_VisionPlus_20');

   INSERT INTO tt_VisionPlus_20 ( 
   	SELECT A.RefCustomerID CustomerID  ,
           A.SysAssetClassAlt_Key FinalAssetClassAlt_Key  ,
           A.SysNPA_Dt FinalNpaDt  ,
           (CASE 
   ...
   INSERT INTO tt_temp2_37
     ( 
       ...
       FROM ( SELECT 'VisionPlusDataList' TableName  ,
              ...
              --Select 'VisionPlusDataList' as TableName, CustomerID ,'       ' as NPADate,'Upgrade' [Type] from tt_VisionPlus_20 A  
   ...
   --  group by a.SourceAlt_Key,a.SourceSystemName    
   /*
      IF OBJECT_ID('TempDB..tt_MiFin_61') Is Not Null    
      Drop Table tt_MiFin_61    
      ...
      Y.EffectiveFromTimeKey<=@TimeKey and Y.EffectiveToTimeKey>=@TimeKey)   
        	...
        	Delete        a
   			...
   			where         DateofData=@Date
      */
   IF utils.object_id('TempDB..tt_MiFin_61') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MiFin_61 ';
   END IF;
   DELETE FROM tt_MiFin_61;
   UTILS.IDENTITY_RESET('tt_MiFin_61');

   INSERT INTO tt_MiFin_61 ( 
   	SELECT A.RefCustomerID ,
           A.SysAssetClassAlt_Key ,
           A.SysNPA_Dt ,
           B.SourceAssetClass ,
   ...
   -- group by a.SourceAlt_Key,a.SourceSystemName    
   /*  
      IF OBJECT_ID('TempDB..tt_Indus_61') Is Not Null    
      Drop Table tt_Indus_61    
       ...
       */
   IF utils.object_id('TempDB..tt_Indus_61') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Indus_61 ';
   END IF;
   DELETE FROM tt_Indus_61;
   UTILS.IDENTITY_RESET('tt_Indus_61');

   INSERT INTO tt_Indus_61 ( 
   	SELECT A.RefCustomerID ,
           A.SysAssetClassAlt_Key FinalAssetClassAlt_Key  ,
           A.SysNPA_Dt FinalNpaDt  ,
           B.SourceAssetClass ,
   ...
   --)T    
   /*
     IF OBJECT_ID('TempDB..tt_ECBF_63') Is Not Null    
      Drop Table tt_ECBF_63    
      ...
      DPD,UserClassification,UserSubClassification,NpaDate,CurrentDate,SourceAlt_Key,SourceName    
       	...
       	Delete        a
   			...
   			where         DateofData=@Date
      */
   IF utils.object_id('TempDB..tt_ACCOUNTCAL_DPD_20') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_DPD_20 ';
   END IF;
   DELETE FROM tt_ACCOUNTCAL_DPD_20;
   UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_DPD_20');

   INSERT INTO tt_ACCOUNTCAL_DPD_20 ( 
   	SELECT CustomerEntityID ,
           MAX(DPD_Max)  DPD_Max  
   	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
   	  GROUP BY CustomerEntityID );
   IF utils.object_id('TempDB..tt_ECBF_63') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ECBF_63 ';
   END IF;
   DELETE FROM tt_ECBF_63;
   UTILS.IDENTITY_RESET('tt_ECBF_63');

   INSERT INTO tt_ECBF_63 ( 
   	SELECT RefCustomerID ,
   	  ...
   	  FROM ( SELECT A.RefCustomerID ,
             ...
             FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                    ...
                    AND Z.EffectiveFromTimeKey <= v_Timekey
                    AND Z.EffectiveToTimeKey >= v_Timekey
                    LEFT JOIN tt_ACCOUNTCAL_DPD_20 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
   ...
   -- group by a.SourceAlt_Key,a.SourceSystemName    
   /* 
      IF OBJECT_ID('TempDB..tt_MetaGrid_63') Is Not Null    
      Drop Table tt_MetaGrid_63    
      ...
      Y.EffectiveFromTimeKey<=@TimeKey and Y.EffectiveToTimeKey>=@TimeKey)    
       	...
       	Delete        a
   			from          tt_MetaGrid_63 a
   			inner join    ReverseFeedData b
   			on            a.CustomerAcID=b.AccountID
   			where         DateofData=@Date
       */
   IF utils.object_id('TempDB..tt_MetaGrid_63') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MetaGrid_63 ';
   END IF;
   DELETE FROM tt_MetaGrid_63;
   UTILS.IDENTITY_RESET('tt_MetaGrid_63');

   INSERT INTO tt_MetaGrid_63 ( 
   	SELECT A.RefCustomerID ,
   ...
   FROM A ,StatusReport_RERF_Customer a
          JOIN tt_temp2_37 b   ON a.SourceAlt_Key = b.SourceAlt_Key ) src
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_DEGRADE_TRACKER_RERF_TOTAL_CUSTOMER" TO "ADF_CDR_RBL_STGDB";
