--------------------------------------------------------
--  DDL for Procedure CUSTOMERDETAILSELECT_20241019_BKP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" 
...
BEGIN
   ...
   IF v_temp = 1 THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerDetailSelect_6 ';
   END IF;
   DELETE FROM tt_CustomerDetailSelect_6;
   ...
   --select * from tt_CustomerDetailSelect_6
   ...
   BEGIN
      DBMS_OUTPUT.PUT_LINE(1);
      INSERT INTO tt_CustomerDetailSelect_6
   ...
   BEGIN
      ...
      FROM T ,tt_CustomerDetailSelect_6 T
   ...
   BEGIN
      ...
      WHEN ( ES.CustomerID IS NOT NULL
        OR EWO.CustomerID IS NOT NULL )
        AND c.NPADt < '2023-09-27' THEN NULL
      ...
      SELECT CrModBy 
        ...
        FROM ( SELECT v_CustBasicCrMod CrModBy  
               ...
               SELECT v_CustCommCrMod CrModBy  
                 FROM DUAL  ) A
       WHERE  NVL(CrModBy, ' ') <> ' ';
      UPDATE tt_CustomerDetailSelect_6
         SET IsMainTable = 'N',
   ...
   OPEN  v_cursor FOR
      SELECT * 
        FROM tt_CustomerDetailSelect_6  ;
   ...
   --if exists(select EffectiveFromTimekey from tt_CustomerDetailSelect_6 )
   ...
   BEGIN
      --Select @FromDate=CAST(date as date) from SysDayMatrix where TimeKey=(select EffectiveFromTimekey from tt_CustomerDetailSelect_6)
      --Select TimeKey
      --,Convert(varchar(10),[Date],103) as [AvailableDate]
      --,@FromDate as MinDate
      --,@ToDate as MaxDate
      --from SysDayMatrix SD
      --inner join tt_CustomerDetailSelect_6 c
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241019_BKP" TO "ADF_CDR_RBL_STGDB";
