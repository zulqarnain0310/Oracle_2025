--------------------------------------------------------
--  DDL for Procedure SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" 
(
...
BEGIN
   ...
   BEGIN
      IF utils.object_id('TempDB..tt_ReverseFeedDataInsertSyn_5') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReverseFeedDataInsertSyn_5 ';
      END IF;
      DELETE FROM tt_ReverseFeedDataInsertSyn_5;
      UTILS.IDENTITY_RESET('tt_ReverseFeedDataInsertSyn_5');

      INSERT INTO tt_ReverseFeedDataInsertSyn_5 ( 
      	SELECT * 
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_Finacle_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Finacle_5 ';
         END IF;
         DELETE FROM tt_Finacle_5;
         UTILS.IDENTITY_RESET('tt_Finacle_5');

         INSERT INTO tt_Finacle_5 ( 
         	SELECT A.RefCustomerID CustomerID  ,
         	  ...
         	  FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                   JOIN tt_ReverseFeedDataInsertSyn_5 RC   ON A.RefCustomerID = RC.CustomerID
      ...
      */
      ...
      BEGIN
         --------------ECBF
         --Select * from (
         IF utils.object_id('TempDB..tt_ACCOUNTCAL_DPD_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_DPD_5 ';
         END IF;
         DELETE FROM tt_ACCOUNTCAL_DPD_5;
         UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_DPD_5');

         INSERT INTO tt_ACCOUNTCAL_DPD_5 ( 
         	SELECT CustomerEntityID ,
                 MAX(DPD_Max)  DPD_Max  
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	  GROUP BY CustomerEntityID );
         IF utils.object_id('TempDB..tt_ECBF_7') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ECBF_7 ';
         END IF;
         DELETE FROM tt_ECBF_7;
         UTILS.IDENTITY_RESET('tt_ECBF_7');

         INSERT INTO tt_ECBF_7 ( 
                   ...
                   FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                        ...
                        --ON DA.AssetClassShortName=B.SourceAssetClass  
                         -- > Edited  by Prashant by dated 03/07/2024
                          ...
                          AND Z.EffectiveFromTimeKey <= v_Timekey
                          AND Z.EffectiveToTimeKey >= v_Timekey
                          LEFT JOIN tt_ACCOUNTCAL_DPD_5 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_Indus_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Indus_5 ';
         END IF;
         DELETE FROM tt_Indus_5;
         UTILS.IDENTITY_RESET('tt_Indus_5');

         INSERT INTO tt_Indus_5 ( 
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_MiFin_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MiFin_5 ';
         END IF;
         DELETE FROM tt_MiFin_5;
         UTILS.IDENTITY_RESET('tt_MiFin_5');

         INSERT INTO tt_MiFin_5 ( 
         	SELECT A.RefCustomerID ,
         ...
         OPEN  v_cursor FOR
            SELECT * 
              FROM ( 
                   ...
                   --	from tt_MiFin_5 A Inner JOIN DIMSOURCEDB B ON A.SourceAlt_Key=B.SourceAlt_key
      ...
      */
      ...
      BEGIN
         ...
         -- --And A.AssetSubClass<>'STD'
         -- AND A.EffectiveFromTimekey<=@TimeKey AND A.EffectiveToTimeKey>=@TimeKey
         IF utils.object_id('TempDB..tt_MetaGrid_7') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MetaGrid_7 ';
         END IF;
         DELETE FROM tt_MetaGrid_7;
         UTILS.IDENTITY_RESET('tt_MetaGrid_7');

         INSERT INTO tt_MetaGrid_7 ( 
         	SELECT A.RefCustomerID ,
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_ACCOUNTCAL_TAF_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_TAF_5 ';
         END IF;
         DELETE FROM tt_ACCOUNTCAL_TAF_5;
         UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_TAF_5');

         INSERT INTO tt_ACCOUNTCAL_TAF_5 ( 
         	SELECT CustomerEntityID ,
                 MAX(DPD_Max)  DPD_Max  
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	  GROUP BY CustomerEntityID );
         IF utils.object_id('TempDB..tt_EIFS_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_EIFS_5 ';
         END IF;
         DELETE FROM tt_EIFS_5;
         UTILS.IDENTITY_RESET('tt_EIFS_5');

         INSERT INTO tt_EIFS_5 ( 
         	SELECT RefCustomerID ,
                 FinalAssetClassAlt_Key ,
                 FinalNpaDt ,
                 SourceAssetClass ,
         	  ...
         	  FROM ( SELECT A.RefCustomerID ,
                   ...
                   FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                          ...
                          AND Z.EffectiveFromTimeKey <= v_Timekey
                          AND Z.EffectiveToTimeKey >= v_Timekey
                          LEFT JOIN tt_ACCOUNTCAL_TAF_5 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
                          JOIN DimProduct DP   ON DP.ProductAlt_Key = Z.ProductAlt_Key
                          AND DP.EffectiveFromTimeKey <= v_Timekey
                          AND DP.EffectiveToTimeKey >= v_Timekey
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_06072024" TO "ADF_CDR_RBL_STGDB";
