--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" 
(
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF tt_AdvAcBasicDetail_7  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_AdvAcBasicDetail_7;
               UTILS.IDENTITY_RESET('tt_AdvAcBasicDetail_7');

               INSERT INTO tt_AdvAcBasicDetail_7 ( 
               	SELECT * 
               	  FROM AdvAcBasicDetail 
               	 WHERE  EffectiveFromTimeKey <= v_Timekey
                          AND EffectiveToTimeKey >= v_Timekey );
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_CustomerBasicDetail_7  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_CustomerBasicDetail_7;
               UTILS.IDENTITY_RESET('tt_CustomerBasicDetail_7');

               INSERT INTO tt_CustomerBasicDetail_7 ( 
               	SELECT * 
               	  FROM CustomerBasicDetail 
               	 WHERE  EffectiveFromTimeKey <= v_Timekey
                          AND EffectiveToTimeKey >= v_Timekey );
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_AdvCustNPADetail_3  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_AdvCustNPADetail_3;
               UTILS.IDENTITY_RESET('tt_AdvCustNPADetail_3');
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'Account ID'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_AdvAcBasicDetail_7 B   ON A.AccountID = B.CustomerACID 
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'CustomerID'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_CustomerBasicDetail_7 B   ON A.CustomerID = B.CustomerId 
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'ucic'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_CustomerBasicDetail_7 B   ON A.UCIC = B.UCIF_ID 
               ...
               --						If @AccountId1<>''
               --						  BEGIN
               --						       Select @AccountId=CustomerACID from tt_AdvAcBasicDetail_7  where CustomerACID=@AccountId1
               ...
               --						       Select @CustomerId=CustomerId from tt_CustomerBasicDetail_7 where CustomerId=@CustomerId1
               --							  IF @CustomerId =''
               --							       Begin
               --									   Print '@CustomerIdAf'
               --									   Print @CustomerId
               ...
               --						   If @UCIC1<>''
               --						  BEGIN
               --						       Select @UCIC=UCIF_ID from tt_CustomerBasicDetail_7 where UCIF_ID=@UCIC1
               --							   IF @UCIC =''
               --							      Begin
               --									   Update UploadAcceleratedProvision
               ...
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp3_13  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_tmp3_13;
               UTILS.IDENTITY_RESET('tt_tmp3_13');

               INSERT INTO tt_tmp3_13 ( 
               	SELECT D.AccountID ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_AdvAcBasicDetail_7 A   ON D.AccountID = A.CustomerACID
                         LEFT JOIN tt_AdvCustNPADetail_3 B   ON A.CustomerEntityId = B.CustomerEntityId
               ...
               UPDATE UploadAcceleratedProvision V
                ...
                WHERE  NVL(AccountID, ' ') NOT IN ( SELECT AccountID 
                 ...
                 AND NVL(AccountID, ' ') <> ' ';
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp1_19  --SQLDEV: NOT RECOGNIZED
               DBMS_OUTPUT.PUT_LINE('Valid Customer/Account/UCIC START 2');
               DELETE FROM tt_tmp1_19;
               UTILS.IDENTITY_RESET('tt_tmp1_19');

               INSERT INTO tt_tmp1_19 ( 
               	SELECT D.CustomerID ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_CustomerBasicDetail_8 B   ON D.CustomerID = B.CustomerId
                         JOIN tt_AdvAcBasicDetail_8 A   ON A.CustomerEntityId = B.CustomerEntityId
                         LEFT JOIN tt_AdvCustNPAdetail_19 C   ON A.CustomerEntityId = C.CustomerEntityId
               ...
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp2_28  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_tmp2_28;
               UTILS.IDENTITY_RESET('tt_tmp2_28');

               INSERT INTO tt_tmp2_28 ( 
               	SELECT D.UCIC ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_CustomerBasicDetail_8 B   ON D.UCIC = B.UCIF_ID
                         JOIN tt_AdvAcBasicDetail_8 A   ON A.CustomerEntityId = B.CustomerEntityId
                         LEFT JOIN tt_AdvCustNPAdetail_19 C   ON A.CustomerEntityId = C.CustomerEntityId
               	 WHERE  C.Cust_AssetClassAlt_Key = D.AssetClassification
                          AND A.FlgSecured = CASE 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD_22122023" TO "ADF_CDR_RBL_STGDB";
