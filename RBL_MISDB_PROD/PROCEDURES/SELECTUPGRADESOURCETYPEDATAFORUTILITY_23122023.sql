--------------------------------------------------------
--  DDL for Procedure SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" 
...
BEGIN
   ...
   IF utils.object_id('TempDB..tt_ReverseFeedDataInsertSyn_14') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReverseFeedDataInsertSyn_14 ';
   END IF;
   DELETE FROM tt_ReverseFeedDataInsertSyn_14;
   UTILS.IDENTITY_RESET('tt_ReverseFeedDataInsertSyn_14');

   INSERT INTO tt_ReverseFeedDataInsertSyn_14 ( 
   	SELECT * 
   ...
   BEGIN
      --------------Finacle
      ----------Added on 04/04/2022
      IF utils.object_id('TempDB..tt_Finacle_47') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Finacle_47 ';
      END IF;
      DELETE FROM tt_Finacle_47;
      UTILS.IDENTITY_RESET('tt_Finacle_47');

      INSERT INTO tt_Finacle_47 ( 
      	SELECT A.CustomerAcID ,
      	  ...
      	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL A
                JOIN tt_ReverseFeedDataInsertSyn_14 RC   ON A.CustomerAcID = RC.CustomerAcID
   ...
   BEGIN
      --------------MiFin
      ----------Added on 04/04/2022
      IF utils.object_id('TempDB..tt_MiFin_47') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MiFin_47 ';
      END IF;
      DELETE FROM tt_MiFin_47;
      UTILS.IDENTITY_RESET('tt_MiFin_47');

      INSERT INTO tt_MiFin_47 ( 
      	SELECT A.CustomerAcID ,
              A.FinalAssetClassAlt_Key ,
              A.FinalNpaDt ,
              A.UpgDate ,
   ...
   BEGIN
      --------------Indus
      ----------Added on 04/04/2022
      IF utils.object_id('TempDB..tt_Indus_47') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Indus_47 ';
      END IF;
      DELETE FROM tt_Indus_47;
      UTILS.IDENTITY_RESET('tt_Indus_47');

      INSERT INTO tt_Indus_47 ( 
      	SELECT A.CustomerAcID ,
              A.FinalAssetClassAlt_Key ,
              A.FinalNpaDt ,
              A.UpgDate ,
   ...
   BEGIN
      --------------ECBF
      ----------------Added on 04/04/2022
      IF utils.object_id('TempDB..tt_ECBF_49') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ECBF_49 ';
      END IF;
      DELETE FROM tt_ECBF_49;
      UTILS.IDENTITY_RESET('tt_ECBF_49');

      INSERT INTO tt_ECBF_49 ( 
      	SELECT CustomerAcID ,
   ...
   BEGIN
      --------------MetaGrid
      ----------Added on 04/04/2022
      IF utils.object_id('TempDB..tt_MetaGrid_49') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MetaGrid_49 ';
      END IF;
      DELETE FROM tt_MetaGrid_49;
      UTILS.IDENTITY_RESET('tt_MetaGrid_49');

      INSERT INTO tt_MetaGrid_49 ( 
      	SELECT A.CustomerAcID ,
   ...
   BEGIN
      IF utils.object_id('TempDB..tt_EIFS_28') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_EIFS_28 ';
      END IF;
      DELETE FROM tt_EIFS_28;
      UTILS.IDENTITY_RESET('tt_EIFS_28');

      INSERT INTO tt_EIFS_28 ( 
      	SELECT CustomerAcID ,
              FinalAssetClassAlt_Key ,
              FinalNpaDt ,
              SourceAssetClass ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTUPGRADESOURCETYPEDATAFORUTILITY_23122023" TO "ADF_CDR_RBL_STGDB";
