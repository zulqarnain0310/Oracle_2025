--------------------------------------------------------
--  DDL for Procedure CUSTOMERDETAILSELECT_18042024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" 
...
BEGIN
   ...
   IF v_temp = 1 THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerDetailSelect_3 ';
   END IF;
   DELETE FROM tt_CustomerDetailSelect_3;
   ...
   --select * from tt_CustomerDetailSelect_3
   ...
   BEGIN
      DBMS_OUTPUT.PUT_LINE(1);
      INSERT INTO tt_CustomerDetailSelect_3
        ...
        ( 
          ...
          SELECT C.CustomerEntityId ,
                 ...
                 NVL(DA.AssetClassName, 'STANDARD') CurrentAssetClassAlt_Key  ,
   ...
   BEGIN
      ...
      FROM T ,tt_CustomerDetailSelect_3 T
      ...
      SELECT CrModBy 
        ...
        FROM ( SELECT v_CustBasicCrMod CrModBy  
               ...
               SELECT v_CustCommCrMod CrModBy  
                 FROM DUAL  ) A
       WHERE  NVL(CrModBy, ' ') <> ' ';
      UPDATE tt_CustomerDetailSelect_3
         SET IsMainTable = 'N',
   ...
   OPEN  v_cursor FOR
      SELECT * 
        FROM tt_CustomerDetailSelect_3  ;
   ...
   --if exists(select EffectiveFromTimekey from tt_CustomerDetailSelect_3 )
   ...
   BEGIN
      --Select @FromDate=CAST(date as date) from SysDayMatrix where TimeKey=(select EffectiveFromTimekey from tt_CustomerDetailSelect_3)
      --Select TimeKey
      --,Convert(varchar(10),[Date],103) as [AvailableDate]
      --,@FromDate as MinDate
      --,@ToDate as MaxDate
      --from SysDayMatrix SD
      --inner join tt_CustomerDetailSelect_3 c
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_18042024" TO "ADF_CDR_RBL_STGDB";
