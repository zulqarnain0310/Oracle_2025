--------------------------------------------------------
--  DDL for Procedure ACCOUNTPREPOSDETAILS_SELECTLIST_08112021
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_ACCOUNT_PREMOC_8  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_PREMOC_8;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_PREMOC_8');

         INSERT INTO tt_ACCOUNT_PREMOC_8 ( 
         	SELECT * 
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_ACCOUNT_POSTMOC_8  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_ACCOUNT_POSTMOC_8;
         UTILS.IDENTITY_RESET('tt_ACCOUNT_POSTMOC_8');

         INSERT INTO tt_ACCOUNT_POSTMOC_8 ( 
         	SELECT AccountEntityId ,
                 AccountID AccountID  ,
                 POS Balance  ,
                 InterestReceivable ,
         ...
         OPEN  v_cursor FOR
            SELECT A.CustomerACID AccountID  ,
              ...
              FROM tt_ACCOUNT_PREMOC_8 A
                     LEFT JOIN tt_ACCOUNT_POSTMOC_8 B   ON A.AccountID = B.AccountID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTPREPOSDETAILS_SELECTLIST_08112021" TO "ADF_CDR_RBL_STGDB";
