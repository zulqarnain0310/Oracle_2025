--------------------------------------------------------
--  DDL for Procedure TWO_REPORT_POSTMOC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" 
AS
...
BEGIN
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_141') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_141 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_141;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_141');

   INSERT INTO tt_TEMPTABLE_141 ( 
   ...
   DELETE FROM tt_TEMP4;
   UTILS.IDENTITY_RESET('tt_TEMP4');

   INSERT INTO tt_TEMP4 ( 
   ...
   --select sum([Closing Balance POS]) from tt_TEMP4 WHERE Addition =0
   --select count(*) from tt_TEMP4 WHERE Addition =0
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWO_REPORT_POSTMOC" TO "ADF_CDR_RBL_STGDB";
