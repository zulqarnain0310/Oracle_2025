--------------------------------------------------------
--  DDL for Procedure POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" 
AS
...
BEGIN
   ...
   --------------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_ADVACRESTRUCTUREDETAIL_9') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ADVACRESTRUCTUREDETAIL_9 ';
   END IF;
   DELETE FROM tt_ADVACRESTRUCTUREDETAIL_9;
   UTILS.IDENTITY_RESET('tt_ADVACRESTRUCTUREDETAIL_9');

   INSERT INTO tt_ADVACRESTRUCTUREDETAIL_9 SELECT * 
        FROM ( SELECT * ,
   ...
   ------------------------------------------------------------------------
   ---------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrDataAccountWise_7') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrDataAccountWise_7 ';
   END IF;
   DELETE FROM tt_PrevQtrDataAccountWise_7;
   UTILS.IDENTITY_RESET('tt_PrevQtrDataAccountWise_7');

   INSERT INTO tt_PrevQtrDataAccountWise_7 ( 
   ...
   -------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrData_10') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrData_10 ';
   END IF;
   DELETE FROM tt_PrevQtrData_10;
   UTILS.IDENTITY_RESET('tt_PrevQtrData_10');

   INSERT INTO tt_PrevQtrData_10 ( 
   ...
   IF tt_dpd2_43  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_dpd2_43;
   UTILS.IDENTITY_RESET('tt_dpd2_43');

   INSERT INTO tt_dpd2_43 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_dpd2_43 
   ...
   --UPDATE A SET DPD_NoCredit=0 FROM tt_dpd2_43 A   
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_98') IS NOT NULL THEN
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_98 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_98;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_98');

   INSERT INTO tt_TEMPTABLE_98 ( 
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE RBL_MISDB_PROD.ProvisionComputation_PostMOC_Automate_RDM ';
   INSERT INTO RBL_MISDB_PROD.ProvisionComputation_PostMOC_Automate_RDM
     SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_Date  ,
       ...
       FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
              ...
              LEFT JOIN tt_PrevQtrDataAccountWise_7 Y   ON A.CustomerEntityID = Y.CustomerEntityID
              AND b.CustomerAcID = Y.CustomerAcID
              LEFT JOIN tt_dpd2_43 DPD   ON B.AccountEntityID = DPD.AccountEntityID
              LEFT JOIN tt_PrevQtrData_10 prev   ON B.AccountEntityID = PREV.ACCOUNTENTITYID
              ...
              LEFT JOIN tt_ADVACRESTRUCTUREDETAIL_9 RES   ON RES.AccountEntityId = B.AccountEntityID
   ...
   OPEN  v_cursor FOR
      SELECT * 
        FROM RBL_MISDB_PROD.ProvisionComputation_PostMOC_Automate_RDM  ;
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_05012024" TO "ADF_CDR_RBL_STGDB";
