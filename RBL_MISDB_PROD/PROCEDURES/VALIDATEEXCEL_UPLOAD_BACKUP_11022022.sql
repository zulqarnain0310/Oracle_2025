--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_UPLOAD_BACKUP_11022022
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
   ...
   IF utils.object_id('tempdb..tt_OAOLMasterUploadData_5') IS NOT NULL THEN

   BEGIN
      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_OAOLMasterUploadData_5 ';

   END;
   END IF;
   DELETE FROM tt_OAOLMasterUploadData_5;
   ...
   BEGIN
      IF utils.object_id('TEMPDB..tt_UserMasterUploadData_15') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserMasterUploadData_15 ';
      END IF;
      --Select * from DimUserInfo
      DELETE FROM tt_UserMasterUploadData_15;
      UTILS.IDENTITY_RESET('tt_UserMasterUploadData_15');

      INSERT INTO tt_UserMasterUploadData_15 ( 
      ...
      --SELECT * FROM tt_UserMasterUploadData_15
      --uPDATE tt_UserMasterUploadData_15 SET --ApplicableSolID =REPLACE(REPLACE(ApplicableSolID, CHAR(13), ''), CHAR(10), '')
      --ApplicableBACID =REPLACE(REPLACE(ApplicableBACID, CHAR(13), ''), CHAR(10), ''),UserRole=LTRIM(RTRIM(UserRole))
      --SELECT * FROM tt_UserMasterUploadData_15
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT SrNo ,
                 -- ,RowNo  
                 'Sr No' ColumnName  ,
                 NULL ErrorData  ,
                 ...
                 T.UserID 
          FROM tt_UserMasterUploadData_15 T
      ...
      BEGIN
         SELECT 1 INTO v_temp
          ...
          WHERE EXISTS ( SELECT 1 
                         FROM tt_OAOLMasterUploadData_5  );
      EXCEPTION
         WHEN OTHERS THEN
            NULL;
      END;
          ...
          WHERE EXISTS ( SELECT 1 
                         FROM tt_UserMasterUploadData_15 T
                          WHERE  T.UserID IN ( SELECT UserID 
                                               FROM tt_UserMasterUploadData_15 
                                                 GROUP BY UserID
      ...
      --(
      --   Select UserEmailId from tt_UserMasterUploadData_15
      --   group by UserEmailId
      --   having COUNT(UserEmailId) > 1
      ...
      --		(
      --		   Select UserExtensionNumber from tt_UserMasterUploadData_15
      --		   group by UserExtensionNumber
      --		   having COUNT(UserExtensionNumber) > 1
      --		) AND ISNULL(T.UserExtensionNumber,'') <> ''
      --GOTO RETURNDATA
      ---- 
      IF utils.object_id('TEMPDB..tt_TempAlreadyExists_5') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempAlreadyExists_5 ';
      END IF;
      DELETE FROM tt_TempAlreadyExists_5;
      UTILS.IDENTITY_RESET('tt_TempAlreadyExists_5');

      INSERT INTO tt_TempAlreadyExists_5 ( 
      	SELECT * 
      ...
      BEGIN
         SELECT 1 INTO v_temp
          ...
          WHERE EXISTS ( SELECT 1 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_15 T
                                JOIN tt_TempAlreadyExists_5 E   ON E.Email_ID = T.UserEmailId
                                AND T.Perform = 'A'
                                AND NVL(T.UserEmailId, ' ') <> ' '
                         UNION 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_15 T
                                JOIN tt_TempAlreadyExists_5 E   ON E.MobileNo = T.UserMobileNumber
                                AND T.Perform = 'A'
                                AND NVL(T.UserMobileNumber, ' ') <> ' '
                         UNION 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_15 T
                                JOIN tt_TempAlreadyExists_5 E   ON E.ExtensionNo = T.UserExtensionNumber
                                AND T.Perform = 'A'
                                AND NVL(T.UserExtensionNumber, ' ') <> ' '
                         UNION 
      ...
      --  ,T.UserID
      --FROM tt_UserMasterUploadData_15 T  
      --inner join tt_TempAlreadyExists_5 E ON E.ExtensionNo=T.UserExtensionNumber
      --AND T.Perform='A'
      --AND ISNULL(T.UserExtensionNumber,'') <> ''
      --UNION
      ----INSERT INTO tt_OAOLMasterUploadData_5 
      ...
      --FROM tt_UserMasterUploadData_15 T  
      --inner join tt_TempAlreadyExists_5 E ON E.ExtensionNo=T.UserExtensionNumber
      --AND T.UserID NOT IN (Select UserLoginID from tt_TempAlreadyExists_5)
      --AND T.Perform='U'
      --AND ISNULL(T.UserExtensionNumber,'') <> ''
      -- GOTO RETURNDATA 
      -----
      ...
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT SrNo ,
                 ...
                 CASE 
                      WHEN NVL(T.UserDepartment, ' ') = 'FNA ' THEN 'Invalid User Role,User Role Should be one of Super Admin, Admin, Operator, Viewer '
      ...
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT SrNo ,
                 ...
                 'User Role' ColumnName  ,
                 T.UserRole ErrorData  ,
                 'Only Super Admin/Admin Can access 2nd level Authorize' ErrorType  ,
                 T.UserID 
          FROM tt_UserMasterUploadData_15 T
                 JOIN DimUserRole R   ON R.RoleDescription = T.UserRole
                 AND R.UserRoleAlt_Key NOT IN ( 1,2 )
      ...
      ----	inner join tt_UserMasterUploadData_15 U ON U.UserDepartment=D.DepartmentCode
      ...
      ----inner join tt_UserMasterUploadData_15 U ON U.UserID=T.UserID
      ...
      ------SELECT * FROM #TempSelectedBACIDsUserWise
      ------SELECT * FROM tt_OAOLMasterUploadData_5
      --INSERT INTO tt_OAOLMasterUploadData_5    
      --SELECT Distinct  t.SrNo  
      --    -- ,RowNo  
      --     ,'Applicable BAC ID' ColumnName  
      ...
      --inner join tt_UserMasterUploadData_15 U ON 
      ----U.UserID=T.UserID
      ----AND 
      ...
      -- )
      -- A 
      -- INNER JOIN tt_UserMasterUploadData_15 B 
      ...
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT DISTINCT t.SrNo ,
          ...
          WHERE  LENGTH(SUBSTR(T.UserEmailId, 1, INSTR(T.UserEmailId, '@', 1) - 1)) < 5
                   AND NVL(T.UserEmailId, ' ') <> ' ' );
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT DISTINCT t.SrNo ,
                          -- ,RowNo  
      ...
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT DISTINCT t.SrNo ,
                          ...
                          T.UserID 
          FROM tt_UserMasterUploadData_15 T
           WHERE  LENGTH(T.UserMobileNumber) > 15
                    AND NVL(T.UserMobileNumber, ' ') <> ' ' );
      INSERT INTO tt_OAOLMasterUploadData_5
        ( SELECT DISTINCT t.SrNo ,
                          -- ,RowNo  
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_BACKUP_11022022" TO "ADF_CDR_RBL_STGDB";
