--------------------------------------------------------
--  DDL for Procedure RESTRUCTUREOUTPUT_27032023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" 
--USE [RBL_MISDB]
 --GO
...
BEGIN
   ...
   ------------------------------------------------------------------------------------------------------------------------------------------
   IF utils.object_id('TEMPDB..tt_UcifEntityID_10') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UcifEntityID_10 ';
   END IF;
   DELETE FROM tt_UcifEntityID_10;
   UTILS.IDENTITY_RESET('tt_UcifEntityID_10');

   INSERT INTO tt_UcifEntityID_10 ( 
   ...
   IF utils.object_id('TEMPDB..tt_AccountEntityId_6') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountEntityId_6 ';
   END IF;
   DELETE FROM tt_AccountEntityId_6;
   UTILS.IDENTITY_RESET('tt_AccountEntityId_6');

   INSERT INTO tt_AccountEntityId_6 ( 
   	SELECT DISTINCT AccountEntityId 
   	  FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
             JOIN tt_UcifEntityID_10 b   ON a.UcifEntityID = b.UcifEntityID
   	 WHERE  a.EffectiveFromTimeKey <= v_timekey
              AND a.EffectiveToTimeKey >= v_timekey );
   ------------------------------------------------------------------------------------------------------------
   IF utils.object_id('TEMPDB..tt_UcifRestructure_6') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UcifRestructure_6 ';
   END IF;
   DELETE FROM tt_UcifRestructure_6;
   UTILS.IDENTITY_RESET('tt_UcifRestructure_6');

   INSERT INTO tt_UcifRestructure_6 SELECT a.RefCustomerID CustomerID  ,
                                           a.CustomerAcID ,
        ...
        FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL A
               JOIN tt_AccountEntityId_6 AE   ON a.AccountEntityID = AE.AccountEntityID
        ...
        ORDER BY 3,
                 4;
   ------------------------------------------------Percolation Code---------------------------------------------
   DELETE FROM tt_TempCust_7;
   UTILS.IDENTITY_RESET('tt_TempCust_7');

   INSERT INTO tt_TempCust_7 SELECT * 
        FROM ( SELECT CustomerID ,
               ...
               FROM tt_UcifRestructure_6 
                WHERE  TypeOfRestructure IS NOT NULL ) A
       WHERE  RN = 1;
   --select * from tt_TempCust_7 where  CustomerID='0217081063000247493'
   MERGE INTO A 
   USING (SELECT A.ROWID row_id, b.TypeOfRestructure, b.RestructureDt, b.Pre_Restr_AssetClass, b.PreRestructureNPA_Date
   FROM A ,tt_UcifRestructure_6 a
          JOIN tt_TempCust_7 b   ON a.CustomerID = b.CustomerID 
   ...
   DELETE FROM tt_TempUcic_6;
   UTILS.IDENTITY_RESET('tt_TempUcic_6');

   INSERT INTO tt_TempUcic_6 SELECT * 
        FROM ( SELECT UCIC ,
                      TypeOfRestructure ,
                      RestructureDt ,
                      Pre_Restr_AssetClass ,
   ...
   USING (SELECT A.ROWID row_id, b.TypeOfRestructure, b.RestructureDt, b.Pre_Restr_AssetClass, b.PreRestructureNPA_Date
   FROM A ,tt_UcifRestructure_6 a
          JOIN tt_TempUcic_6 b   ON a.UCIC = b.UCIC 
    WHERE a.TypeOfRestructure IS NULL) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET a.TypeOfRestructure = src.TypeOfRestructure,
                                a.RestructureDt = src.RestructureDt,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREOUTPUT_27032023" TO "ADF_CDR_RBL_STGDB";
