--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_UPLOAD_PROD_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
BEGIN
   ...
   IF utils.object_id('tempdb..tt_OAOLMasterUploadData_7') IS NOT NULL THEN

   BEGIN
      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_OAOLMasterUploadData_7 ';

   END;
   END IF;
   DELETE FROM tt_OAOLMasterUploadData_7;
   ...
   BEGIN
      IF utils.object_id('TEMPDB..tt_UserMasterUploadData_17') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserMasterUploadData_17 ';
      END IF;
      --Select * from DimUserInfo
      DELETE FROM tt_UserMasterUploadData_17;
      UTILS.IDENTITY_RESET('tt_UserMasterUploadData_17');

      INSERT INTO tt_UserMasterUploadData_17 ( 
      ...
      --SELECT * FROM tt_UserMasterUploadData_17
      --uPDATE tt_UserMasterUploadData_17 SET --ApplicableSolID =REPLACE(REPLACE(ApplicableSolID, CHAR(13), ''), CHAR(10), '')
      --ApplicableBACID =REPLACE(REPLACE(ApplicableBACID, CHAR(13), ''), CHAR(10), ''),UserRole=LTRIM(RTRIM(UserRole))
      --SELECT * FROM tt_UserMasterUploadData_17
      INSERT INTO tt_OAOLMasterUploadData_7
        ( SELECT SrNo ,
                 -- ,RowNo  
                 'Sr No' ColumnName  ,
                 NULL ErrorData  ,
                 ...
                 T.UserID 
          FROM tt_UserMasterUploadData_17 T
      ...
      BEGIN
         SELECT 1 INTO v_temp
          ...
          WHERE EXISTS ( SELECT 1 
                         FROM tt_OAOLMasterUploadData_7  );
      EXCEPTION
         WHEN OTHERS THEN
            NULL;
      END;
          ...
          WHERE EXISTS ( SELECT 1 
                         FROM tt_UserMasterUploadData_17 T
                          WHERE  T.UserID IN ( SELECT UserID 
                                               FROM tt_UserMasterUploadData_17 
                                                 GROUP BY UserID
      ...
      --(
      --   Select UserEmailId from tt_UserMasterUploadData_17
      --   group by UserEmailId
      --   having COUNT(UserEmailId) > 1
      ...
      --		(
      --		   Select UserExtensionNumber from tt_UserMasterUploadData_17
      --		   group by UserExtensionNumber
      --		   having COUNT(UserExtensionNumber) > 1
      --		) AND ISNULL(T.UserExtensionNumber,'') <> ''
      --GOTO RETURNDATA
      ---- 
      IF utils.object_id('TEMPDB..tt_TempAlreadyExists_7') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempAlreadyExists_7 ';
      END IF;
      DELETE FROM tt_TempAlreadyExists_7;
      UTILS.IDENTITY_RESET('tt_TempAlreadyExists_7');

      INSERT INTO tt_TempAlreadyExists_7 ( 
      	SELECT * 
      ...
      BEGIN
         SELECT 1 INTO v_temp
          ...
          WHERE EXISTS ( SELECT 1 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_17 T
                                JOIN tt_TempAlreadyExists_7 E   ON E.Email_ID = T.UserEmailId
                                AND T.Perform = 'A'
                                AND NVL(T.UserEmailId, ' ') <> ' '
                         UNION 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_17 T
                                JOIN tt_TempAlreadyExists_7 E   ON E.MobileNo = T.UserMobileNumber
                                AND T.Perform = 'A'
                                AND NVL(T.UserMobileNumber, ' ') <> ' '
                         UNION 
                         ...
                         SELECT 1 
                         FROM tt_UserMasterUploadData_17 T
                                JOIN tt_TempAlreadyExists_7 E   ON E.ExtensionNo = T.UserExtensionNumber
                                AND T.Perform = 'A'
                                AND NVL(T.UserExtensionNumber, ' ') <> ' '
                         UNION 
      ...
      --  ,T.UserID
      --FROM tt_UserMasterUploadData_17 T  
      --inner join tt_TempAlreadyExists_7 E ON E.ExtensionNo=T.UserExtensionNumber
      --AND T.Perform='A'
      --AND ISNULL(T.UserExtensionNumber,'') <> ''
      --UNION
      ----INSERT INTO tt_OAOLMasterUploadData_7 
      ...
      --FROM tt_UserMasterUploadData_17 T  
      --inner join tt_TempAlreadyExists_7 E ON E.ExtensionNo=T.UserExtensionNumber
      --AND T.UserID NOT IN (Select UserLoginID from tt_TempAlreadyExists_7)
      --AND T.Perform='U'
      --AND ISNULL(T.UserExtensionNumber,'') <> ''
      -- GOTO RETURNDATA 
      -----
      ...
      ----	inner join tt_UserMasterUploadData_17 U ON U.UserDepartment=D.DepartmentCode
      ...
      ----inner join tt_UserMasterUploadData_17 U ON U.UserID=T.UserID
      ...
      ------SELECT * FROM #TempSelectedBACIDsUserWise
      ------SELECT * FROM tt_OAOLMasterUploadData_7
      --INSERT INTO tt_OAOLMasterUploadData_7    
      --SELECT Distinct  t.SrNo  
      --    -- ,RowNo  
      --     ,'Applicable BAC ID' ColumnName  
      ...
      --inner join tt_UserMasterUploadData_17 U ON 
      ----U.UserID=T.UserID
      ----AND 
      ...
      -- )
      -- A 
      -- INNER JOIN tt_UserMasterUploadData_17 B 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_UPLOAD_PROD_04122023" TO "ADF_CDR_RBL_STGDB";
