--------------------------------------------------------
--  DDL for Procedure RPT_041_ACCELERATEDE_PROVISION_REPORT
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" 
(
  v_Timekey IN NUMBER
)
AS
...
BEGIN
   ...
   BEGIN
      ...
      IF tt_ACCT_NPA_QTR_NO_REPORT_3  --SQLDEV: NOT RECOGNIZED
      DELETE FROM tt_ACCT_NPA_QTR_NO_REPORT_3;
      UTILS.IDENTITY_RESET('tt_ACCT_NPA_QTR_NO_REPORT_3');

      INSERT INTO tt_ACCT_NPA_QTR_NO_REPORT_3 ( 
      ...
      DELETE FROM tt_ACCT_NPA_QTR_NO_Account_3;
      IF  --SQLDEV: NOT RECOGNIZED
      IF tt_ACCT_NPA_QTR_NO_Account_3  --SQLDEV: NOT RECOGNIZED
      --select * from tt_ACCT_NPA_QTR_NO_REPORT_3
      INSERT INTO tt_ACCT_NPA_QTR_NO_Account_3
        ( 
          --select * from tt_ACCT_NPA_QTR_NO_Account_3    
          ...
          FROM AcceleratedProvision A
                 ...
                 JOIN tt_ACCT_NPA_QTR_NO_REPORT_3 D   ON D.AccountEntityID = b.AccountEntityId
          ...
          FROM BucketWiseAcceleratedProvision A
                 JOIN tt_ACCT_NPA_QTR_NO_REPORT_3 b   ON A.SegmentName = B.AcBuRevisedSegmentCode
   ...
   IF utils.object_id('tempdb..tt_DPD_28') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DPD_28 ';
   END IF;
   DELETE FROM tt_DPD_28;
   UTILS.IDENTITY_RESET('tt_DPD_28');

   INSERT INTO tt_DPD_28 ( 
   	SELECT * 
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_28 
   ...
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_127') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_127 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_127;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_127');

   INSERT INTO tt_TEMPTABLE_127 ( 
   ...
   ELSE NVL(A.DPD_StockStmt, 0)
      END) AS DPD_Max
   FROM A ,tt_DPD_28 A
          JOIN tt_CustomerCal_Hist C   ON C.CustomerEntityID = A.CustomerEntityID
          AND C.EffectiveFromTimeKey <= v_TimeKey
          AND C.EffectiveToTimeKey >= v_TimeKey 
   ...
   OPEN  v_cursor FOR
      SELECT CCL.UCIF_ID ,
        ...
        FROM tt_ACCT_NPA_QTR_NO_REPORT_3 ACL
               JOIN tt_ACCT_NPA_QTR_NO_Account_3 ANA   ON ACL.AccountEntityID = ANA.AccountEntityId
               JOIN tt_CustomerCal_Hist CCL   ON ACL.CustomerEntityID = CCL.CustomerEntityID
               ...
               LEFT JOIN tt_DPD_28 DPD   ON DPD.AccountEntityID = ACL.AccountEntityID ;
      DBMS_SQL.RETURN_RESULT(v_cursor);--select * from tt_ACCT_NPA_QTR_NO_Account_3
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_041_ACCELERATEDE_PROVISION_REPORT" TO "ADF_CDR_RBL_STGDB";
