--------------------------------------------------------
--  DDL for Procedure INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" 
AS
...
BEGIN
   ...
   IF ( utils.object_id('TEMPDB..tt_MOC_DATA_42') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOC_DATA_42 ';
   END IF;
   DELETE FROM tt_MOC_DATA_42;
   UTILS.IDENTITY_RESET('tt_MOC_DATA_42');

   INSERT INTO tt_MOC_DATA_42 ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_UcifEntityID
      ON tt_MOC_DATA_42 ( CustomerEntityId)';
   IF ( utils.object_id('TEMPDB..tt_InvestmentFinancialDetai_9') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_InvestmentFinancialDetai_9 ';
   END IF;
   DELETE FROM tt_InvestmentFinancialDetai_9;
   UTILS.IDENTITY_RESET('tt_InvestmentFinancialDetai_9');

   INSERT INTO tt_InvestmentFinancialDetai_9 ( 
   	SELECT DISTINCT UTILS.CONVERT_TO_NVARCHAR2(v_Mocdate,30,p_style=>105) Process_Date  ,
   	  ...
   	  FROM InvestmentIssuerDetail a
             JOIN tt_MOC_DATA_42 BB   ON A.IssuerEntityId = BB.CustomerEntityID
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID
      ON tt_InvestmentFinancialDetai_9 ( ISSUERID)';
   -------------------------------------------------  
   ...
   --INNER JOIN tt_MOC_DATA_42 B                        ON A.UcifEntityID=B.UcifEntityID
   --WHERE EffectiveFromTimeKey<=@TimeKey AND EffectiveToTimeKey>=@TimeKey  
   --OPTION(RECOMPILE)  
   --CREATE NONCLUSTERED INDEX INX_CustomerEntityID ON #CustomerCal_HIST(CustomerEntityID)  
   --INCLUDE (RefCustomerID)  
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CalypsoAccountLevelMOC_M_5') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CalypsoAccountLevelMOC_M_5 ';
   END IF;
   DELETE FROM tt_CalypsoAccountLevelMOC_M_5;
   UTILS.IDENTITY_RESET('tt_CalypsoAccountLevelMOC_M_5');

   INSERT INTO tt_CalypsoAccountLevelMOC_M_5 ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_AccountID
      ON tt_CalypsoAccountLevelMOC_M_5 ( AccountID)';
   --select * from #AccountLevelMOC_Mod
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CalypsoCustomerLevelMOC__5') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CalypsoCustomerLevelMOC__5 ';
   END IF;
   DELETE FROM tt_CalypsoCustomerLevelMOC__5;
   UTILS.IDENTITY_RESET('tt_CalypsoCustomerLevelMOC__5');

   INSERT INTO tt_CalypsoCustomerLevelMOC__5 ( 
   	SELECT Entity_Key ,
           A.CustomerEntityID ,
           ChangeField ,
           EffectiveFromTimekey ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID2
      ON tt_CalypsoCustomerLevelMOC__5 ( CustomerEntityID)';
   IF ( utils.object_id('TEMPDB..tt_InvestmentFinancialDetai_10') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_InvestmentFinancialDetai_10 ';
   END IF;
   DELETE FROM tt_InvestmentFinancialDetai_10;
   UTILS.IDENTITY_RESET('tt_InvestmentFinancialDetai_10');

   INSERT INTO tt_InvestmentFinancialDetai_10 ( 
   	SELECT a.EntityKey ,
           a.InvEntityId ,
           RefInvID ,
           a.HoldingNature ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID1
      ON tt_InvestmentFinancialDetai_10 ( RefIssuerID)';
   --------------------------------------------  
   ...
   --OPTION(RECOMPILE)  
   ---------------------PreMOC_DATA----------------------  
   IF utils.object_id('Tempdb..tt_Final_5') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Final_5 ';
   END IF;
   --DECLARE  @TimeKey AS INT=26479
   DELETE FROM tt_Final_5;
   UTILS.IDENTITY_RESET('tt_Final_5');

   INSERT INTO tt_Final_5 SELECT 'Post Moc' Moc_Status  ,
        ...
        FROM tt_InvestmentFinancialDetai_9 A
               JOIN tt_CalypsoAccountLevelMOC_M_5 ALM   ON ALM.AccountId = A.InvID
               LEFT JOIN tt_CalypsoCustomerLevelMOC__5 CLM   ON A.IssuerEntityId = CLM.CustomerEntityId
      ...
      SELECT 'Pre Moc' Moc_Status  ,
             ...
             --	else DABS.AcBuSegmentDescription end                        AS AcBuSegmentDescription
             clm.AuthorisationStatus 
        FROM tt_InvestmentFinancialDetai_10 A
               JOIN tt_CalypsoAccountLevelMOC_M_5 ALM   ON ALM.AccountId = A.RefInvID
               LEFT JOIN tt_CalypsoCustomerLevelMOC__5 CLM   ON A.IssuerEntityId = CLM.CustomerEntityId
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INVESTMENT_MOCVERIFICATIONACCOUNTREPORT_RDM_22042024" TO "ADF_CDR_RBL_STGDB";
