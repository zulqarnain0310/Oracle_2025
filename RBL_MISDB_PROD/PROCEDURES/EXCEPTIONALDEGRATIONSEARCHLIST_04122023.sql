--------------------------------------------------------
--  DDL for Procedure EXCEPTIONALDEGRATIONSEARCHLIST_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" 
(
  --declare												
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_Reminder_2') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Reminder_2 ';
         END IF;
         DELETE FROM tt_Reminder_2;
         UTILS.IDENTITY_RESET('tt_Reminder_2');

         INSERT INTO tt_Reminder_2 ( 
         	SELECT * 
         	  FROM ( SELECT B.ParameterAlt_Key FlagAlt_Key  ,
                 ...
                 A );
         --Select * from tt_Reminder_2
         IF utils.object_id('TempDB..tt_Reminder_2Report') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReminderReport_2 ';
         END IF;
         DELETE FROM tt_ReminderReport_2;
         INSERT INTO tt_ReminderReport_2
           ...
           ( SELECT A.Businesscolvalues1 FlagAlt_Key  ,
             ...
             FROM ( SELECT AccountID ,
                    ...
                    FROM ( SELECT UTILS.CONVERT_TO_CLOB('<M>' || REPLACE(FlagAlt_Key, ',', '</M><M>') || '</M>') Businesscolvalues1  ,
                                  AccountID 
                           FROM tt_Reminder_2  ) A
                            /*TODO:SQLDEV*/ CROSS APPLY Businesscolvalues1.nodes ('/M') AS Split(a) /*END:SQLDEV*/  ) A
              WHERE  A.Businesscolvalues1 <> ' ' );
         --Select * from tt_Reminder_2Report1
         IF utils.object_id('TempDB..tt_Reminder_2Report1') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReminderReport1_2 ';
         END IF;
         DELETE FROM tt_ReminderReport1_2;
         UTILS.IDENTITY_RESET('tt_ReminderReport1_2');

         INSERT INTO tt_ReminderReport1_2 ( 
         	SELECT A.* ,
                 B.ParameterName FlagName  
         	  FROM tt_ReminderReport_2 A
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF utils.object_id('TempDB..tt_temp_135') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_135 ';
               END IF;
               DELETE FROM tt_temp_135;
               UTILS.IDENTITY_RESET('tt_temp_135');

               INSERT INTO tt_temp_135 ( 
               	SELECT A.DegrationAlt_Key ,
               	  ...
               	  FROM ( SELECT A.DegrationAlt_Key ,
                         ...
                         FROM ExceptionFinalStatusType D
                                ...
                                AND A.EffectiveToTimeKey >= v_TimeKey
                                LEFT JOIN tt_ReminderReport1_2 S   ON S.AccountID = D.ACID
               	 ...
               	 WHERE  DimParameterName = 'DimYesNo'
                         ...
                         FROM RBL_MISDB_PROD.ExceptionalDegrationDetail_Mod A
                                LEFT JOIN tt_ReminderReport1_2 S   ON S.AccountID = A.AccountID
                                AND A.FlagAlt_Key = S.FlagAlt_Key
                                LEFT JOIN ( SELECT ParameterAlt_Key ,
                                                   ParameterName ,
                                                   'DimYesNo' Tablename  
                       ...
                       --LEFT JOIn tt_Reminder_2Report1 S ON S.AccountID=A.ACID
            ...
            -- IF NOT EXISTS (select 1 from tt_temp_135 where AccountID=@AccountID)
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_13516') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_104 ';
                  END IF;
                  DELETE FROM tt_temp16_104;
                  UTILS.IDENTITY_RESET('tt_temp16_104');

                  INSERT INTO tt_temp16_104 ( 
                  	SELECT A.DegrationAlt_Key ,
                          A.SourceName ,
                          A.SourceAlt_Key ,
                          A.AccountID ,
               ...
               ELSE
                  ...
                  BEGIN
                     IF utils.object_id('TemrefpDB..tt_temp_13520') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_69 ';
                     END IF;
                     DELETE FROM tt_temp20_69;
                     UTILS.IDENTITY_RESET('tt_temp20_69');

                     INSERT INTO tt_temp20_69 ( 
                     	SELECT A.DegrationAlt_Key ,
                             A.SourceName ,
                             A.SourceAlt_Key ,
                             A.AccountID ,
         ...
         BEGIN
            ...
            BEGIN
               DBMS_OUTPUT.PUT_LINE('AKSHAY');
               IF utils.object_id('TempDB..tt_temp_13530') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp30_2 ';
               END IF;
               DELETE FROM tt_temp30_2;
               UTILS.IDENTITY_RESET('tt_temp30_2');

               INSERT INTO tt_temp30_2 ( 
               	SELECT A.DegrationAlt_Key ,
                       A.SourceName ,
                       A.SourceAlt_Key ,
                       A.AccountID ,
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_135161') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp161_5 ';
                  END IF;
                  DELETE FROM tt_temp161_5;
                  UTILS.IDENTITY_RESET('tt_temp161_5');

                  INSERT INTO tt_temp161_5 ( 
                  	SELECT A.DegrationAlt_Key ,
                          A.SourceName ,
                          A.SourceAlt_Key ,
                          A.AccountID ,
               ...
               ELSE
                  ...
                  BEGIN
                     IF utils.object_id('TemrefpDB..tt_temp_135201') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp201_5 ';
                     END IF;
                     DELETE FROM tt_temp201_5;
                     UTILS.IDENTITY_RESET('tt_temp201_5');

                     INSERT INTO tt_temp201_5 ( 
                     	SELECT A.DegrationAlt_Key ,
                             A.SourceName ,
                             A.SourceAlt_Key ,
                             A.AccountID ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_04122023" TO "ADF_CDR_RBL_STGDB";
