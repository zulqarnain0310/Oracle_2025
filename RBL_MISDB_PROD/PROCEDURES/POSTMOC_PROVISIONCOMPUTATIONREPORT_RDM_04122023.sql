--------------------------------------------------------
--  DDL for Procedure POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" 
AS
...
BEGIN
   ...
   --------------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_ADVACRESTRUCTUREDETAIL_8') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ADVACRESTRUCTUREDETAIL_8 ';
   END IF;
   DELETE FROM tt_ADVACRESTRUCTUREDETAIL_8;
   UTILS.IDENTITY_RESET('tt_ADVACRESTRUCTUREDETAIL_8');

   INSERT INTO tt_ADVACRESTRUCTUREDETAIL_8 SELECT * 
        FROM ( SELECT * ,
   ...
   ------------------------------------------------------------------------
   ---------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrDataAccountWise_6') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrDataAccountWise_6 ';
   END IF;
   DELETE FROM tt_PrevQtrDataAccountWise_6;
   UTILS.IDENTITY_RESET('tt_PrevQtrDataAccountWise_6');

   INSERT INTO tt_PrevQtrDataAccountWise_6 ( 
   ...
   -------------------------------------------------------------------------------------------------
   IF ( utils.object_id('TEMPDB..tt_PrevQtrData_9') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_PrevQtrData_9 ';
   END IF;
   DELETE FROM tt_PrevQtrData_9;
   UTILS.IDENTITY_RESET('tt_PrevQtrData_9');

   INSERT INTO tt_PrevQtrData_9 ( 
   ...
   IF tt_dpd2_42  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_dpd2_42;
   UTILS.IDENTITY_RESET('tt_dpd2_42');

   INSERT INTO tt_dpd2_42 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_dpd2_42 
   ...
   --UPDATE A SET DPD_NoCredit=0 FROM tt_dpd2_42 A   
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_97') IS NOT NULL THEN
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_97 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_97;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_97');

   INSERT INTO tt_TEMPTABLE_97 ( 
   ...
   INSERT INTO RBL_MISDB_PROD.ProvisionComputation_PostMOC_Automate_RDM
     SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_Date  ,
       ...
       FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
              ...
              LEFT JOIN tt_PrevQtrDataAccountWise_6 Y   ON A.CustomerEntityID = Y.CustomerEntityID
              AND b.CustomerAcID = Y.CustomerAcID
              LEFT JOIN tt_dpd2_42 DPD   ON B.AccountEntityID = DPD.AccountEntityID
              LEFT JOIN tt_PrevQtrData_9 prev   ON B.AccountEntityID = PREV.ACCOUNTENTITYID
              ...
              LEFT JOIN tt_ADVACRESTRUCTUREDETAIL_8 RES   ON RES.AccountEntityId = B.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_PROVISIONCOMPUTATIONREPORT_RDM_04122023" TO "ADF_CDR_RBL_STGDB";
