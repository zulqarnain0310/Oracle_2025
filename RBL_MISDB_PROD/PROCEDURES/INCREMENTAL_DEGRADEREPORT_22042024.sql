--------------------------------------------------------
--  DDL for Procedure INCREMENTAL_DEGRADEREPORT_22042024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" 
AS
...
BEGIN
   ...
   IF utils.object_id('TEMPDB..tt_ACL_NPA_DATA1') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACL_NPA_DATA1 ';
   END IF;
   DELETE FROM tt_ACL_NPA_DATA1;
   UTILS.IDENTITY_RESET('tt_ACL_NPA_DATA1');

   INSERT INTO tt_ACL_NPA_DATA1 ( 
   	SELECT * 
   	  FROM ACL_NPA_DATA 
   	 WHERE  UTILS.CONVERT_TO_VARCHAR2(Process_date,200,p_style=>105) BETWEEN v_From1 AND v_to1 );
   ---------------------DEGRADATION  Report----------------------
   ---------------------------======================================DPD CalCULATION  Start===========================================
   IF utils.object_id('TEMPDB..tt_IntNoserviedDt_28') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_IntNoserviedDt_28 ';
   END IF;
   DELETE FROM tt_IntNoserviedDt_28;
   UTILS.IDENTITY_RESET('tt_IntNoserviedDt_28');

   INSERT INTO tt_IntNoserviedDt_28 ( 
   ...
   INSERT INTO DegradeReport_package_Monthwise
     ( SELECT
       ...
       FROM tt_ACL_NPA_DATA1 B
              ...
              LEFT JOIN tt_IntNoserviedDt_28 DT   ON B.CustomerAcid = Dt.CustomerAcID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."INCREMENTAL_DEGRADEREPORT_22042024" TO "ADF_CDR_RBL_STGDB";
