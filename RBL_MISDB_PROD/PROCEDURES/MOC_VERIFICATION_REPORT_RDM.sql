--------------------------------------------------------
--  DDL for Procedure MOC_VERIFICATION_REPORT_RDM
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" 
AS
...
BEGIN
   ...
   IF ( utils.object_id('TEMPDB..tt_MOC_DATA_50') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOC_DATA_50 ';
   END IF;
   DELETE FROM tt_MOC_DATA_50;
   UTILS.IDENTITY_RESET('tt_MOC_DATA_50');

   INSERT INTO tt_MOC_DATA_50 ( 
   	SELECT UcifEntityID 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_UcifEntityID
      ON tt_MOC_DATA_50 ( UcifEntityID)';
   IF ( utils.object_id('TEMPDB..tt_AccountCal_Hist_13') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountCal_Hist_13 ';
   END IF;
   DELETE FROM tt_AccountCal_Hist_13;
   UTILS.IDENTITY_RESET('tt_AccountCal_Hist_13');

   INSERT INTO tt_AccountCal_Hist_13 ( 
   	SELECT A.UcifEntityID ,
   	  ...
   	  FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
             JOIN tt_MOC_DATA_50 B   ON A.UcifEntityID = B.UcifEntityID
   	 WHERE  EffectiveFromTimeKey <= v_TimeKey
              AND EffectiveToTimeKey >= v_TimeKey );
   --select * from tt_AccountCal_Hist_13 where CustomerAcID='809002712795'
   --select * from tt_DimAcBuSegment_5 where AcBuSegmentcode='1326'
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID
      ON tt_AccountCal_Hist_13 ( CustomerACID)';
   -------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CustomerCal_HIST') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerCal_HIST ';
   END IF;
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID
      ON tt_CustomerCal_HIST ( CustomerEntityID)';
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_AccountLevelMOC_Mod') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountLevelMOC_Mod ';
   END IF;
   DELETE FROM tt_AccountLevelMOC_Mod;
   UTILS.IDENTITY_RESET('tt_AccountLevelMOC_Mod');

   INSERT INTO tt_AccountLevelMOC_Mod ( 
   	SELECT AccountID ,
           ChangeField ,
           EffectiveFromTimekey ,
           EffectiveToTimekey ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_AccountID
      ON tt_AccountLevelMOC_Mod ( AccountID)';
   --select * from tt_AccountLevelMOC_Mod
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CustomerLevelMOC_Mod') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerLevelMOC_Mod ';
   END IF;
   DELETE FROM tt_CustomerLevelMOC_Mod;
   UTILS.IDENTITY_RESET('tt_CustomerLevelMOC_Mod');

   INSERT INTO tt_CustomerLevelMOC_Mod ( 
   	SELECT Entity_Key ,
           CustomerEntityID ,
           ChangeField ,
           EffectiveFromTimekey ,
   ...
   --select * from tt_CustomerLevelMOC_Mod
   --select * from CustomerLevelMOC_Mod where CustomerID='2074381'
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID2
      ON tt_CustomerLevelMOC_Mod ( CustomerEntityID)';
   --select * from tt_CustomerLevelMOC_Mod 
   --select * from CustomerLevelMOC_Mod where CustomerID='0215012763000004599'
   --MOCDate='2022-06-30'
   -------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_AccountCal_27') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountCal_27 ';
   END IF;
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID1
      ON tt_AccountCal_27 ( CustomerACID)';
   --------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CustomerCal_16') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerCal_16 ';
   END IF;
   DELETE FROM tt_CustomerCal_16;
   UTILS.IDENTITY_RESET('tt_CustomerCal_16');

   INSERT INTO tt_CustomerCal_16 ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID1
      ON tt_CustomerCal_16 ( CustomerEntityID)';
   ------------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_DimAcBuSegment_5') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DimAcBuSegment_5 ';
   END IF;
   DELETE FROM tt_DimAcBuSegment_5;
   UTILS.IDENTITY_RESET('tt_DimAcBuSegment_5');

   INSERT INTO tt_DimAcBuSegment_5 SELECT DENSE_RANK() OVER ( PARTITION BY AcBuRevisedSegmentCode ORDER BY AcBuSegmentCode  ) RN  ,
                                          AcBuSegmentCode ,
       ...
       WHERE  EffectiveFromTimeKey <= v_TimeKey
                AND EffectiveToTimeKey >= v_TimeKey;
   ---------------------PreMOC_DATA----------------------  
   IF utils.object_id('Tempdb..tt_Final_13') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Final_13 ';
   END IF;
   --DECLARE  @TimeKey AS INT=26479
   DELETE FROM tt_Final_13;
   UTILS.IDENTITY_RESET('tt_Final_13');

   INSERT INTO tt_Final_13 SELECT ROW_NUMBER() OVER ( ORDER BY A.UcifEntityId  ) SrNo  ,
                                  'Post Moc' Moc_Status  ,
                                  ...
                                  D.AssetClassSubGroup InitalAssetClassName ,---added by Prashant---02052024---
                                  ...
                                  E.AssetClassSubGroup FinalAssetClassName ,---added by Prashant---02052024---
        ...
        FROM tt_AccountCal_Hist_13 A
               JOIN DimProduct C   ON C.ProductAlt_Key = A.ProductAlt_Key
               AND C.EffectiveFromTimeKey <= v_TimeKey
               AND C.EffectiveToTimeKey >= v_TimeKey
               LEFT JOIN tt_AccountLevelMOC_Mod ALM   ON ALM.AccountId = A.CustomerAcID
               LEFT JOIN tt_CustomerCal_HIST F   ON F.CustomerEntityId = A.CustomerEntityId
               LEFT JOIN tt_CustomerLevelMOC_Mod CLM   ON F.CustomerEntityId = CLM.CustomerEntityId
               ...
               LEFT JOIN tt_DimAcBuSegment_5 DABS   ON A.ActSegmentCode = DABS.AcBuSegmentCode
      ...
      SELECT ROW_NUMBER() OVER ( ORDER BY A.UcifEntityId  ) SrNo  ,
        ...
        FROM tt_AccountCal_27 A
               ...
               AND C.EffectiveToTimeKey >= v_TimeKey
               LEFT JOIN tt_AccountLevelMOC_Mod ALM   ON ALM.AccountId = A.CustomerAcID
               LEFT JOIN tt_CustomerCal_16 F   ON F.CustomerEntityId = A.CustomerEntityId
               LEFT JOIN tt_CustomerLevelMOC_Mod CLM   ON F.CustomerEntityId = CLM.CustomerEntityId
               LEFT JOIN MOC_ChangeDetails MOC   ON MOC.CustomerEntityId = CLM.CustomerEntityId
               AND MOC.EffectiveFromTimeKey <= v_TimeKey
               AND MOC.EffectiveToTimeKey >= v_TimeKey
      ...
      WHERE  A.CustomerAcID IN ( SELECT CustomerAcID 
                                 FROM tt_AccountCal_Hist_13 A
                                        LEFT JOIN tt_CustomerCal_HIST C   ON C.CustomerEntityId = A.CustomerEntityId
                                  WHERE  ( A.FlgMoc = 'Y'
                                           OR C.FlgMoc = 'Y' ) )
   ...
   OPEN  v_cursor FOR
      SELECT SrNo ,
        ...
        ORDER BY CustomerAcID,
                 CustomerID,
                 Moc_Status DESC ;
      DBMS_SQL.RETURN_RESULT(v_cursor);--DROP TABLE tt_AccountCal_Hist_13,tt_CustomerCal_16_Hist,tt_AccountLevelMOC_Mod,tt_CustomerLevelMOC_Mod,tt_AccountCal_27,tt_CustomerCal_16,tt_DimAcBuSegment_5  
   --select * from tt_DimAcBuSegment_5 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM" TO "ADF_CDR_RBL_STGDB";
