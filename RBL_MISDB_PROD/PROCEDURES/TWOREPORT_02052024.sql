--------------------------------------------------------
--  DDL for Procedure TWOREPORT_02052024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."TWOREPORT_02052024" 
AS
...
BEGIN
   ...
   IF tt_ExceptionFinalStatusType_13  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_ExceptionFinalStatusType_13;
   UTILS.IDENTITY_RESET('tt_ExceptionFinalStatusType_13');

   INSERT INTO tt_ExceptionFinalStatusType_13 SELECT DISTINCT A.* ,
   ...
   DELETE tt_ExceptionFinalStatusType_13

    WHERE  RANK > 1;
   -----------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_OpeningBalance_13  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_OpeningBalance_13;
   UTILS.IDENTITY_RESET('tt_OpeningBalance_13');

   INSERT INTO tt_OpeningBalance_13 SELECT A.ACID ,
                                           B.PrincOutStd ,
                                           ROW_NUMBER() OVER ( PARTITION BY A.ACID ORDER BY A.ACID, B.EffectiveToTimeKey DESC  ) RANK  
        FROM tt_ExceptionFinalStatusType_13 A
       ...
       WHERE  ( ( a.EffectiveFromTimeKey <= v_LastQtrTimekey
                ...
                AND statustype = 'TWO';
   UPDATE tt_OpeningBalance_13
      SET PrincOutStd = 0
    WHERE  PrincOutStd < 0;
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_44ccountCal  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_Accountcal_13;
   UTILS.IDENTITY_RESET('tt_Accountcal_13');

   INSERT INTO tt_Accountcal_13 ( 
   	SELECT * 
   	  FROM ( SELECT UCIF_ID ,
                    RefCustomerID ,
                    CustomerAcID ,
   ...
   UPDATE tt_ExceptionFinalStatusType_13
   ...
   --------------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DimCustomer_13  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DimCustomer_13;
   UTILS.IDENTITY_RESET('tt_DimCustomer_13');

   INSERT INTO tt_DimCustomer_13 ( 
             ...
             JOIN ( SELECT DISTINCT CustomerID ,
                    ...
                    FROM CustomerBasicDetail 
                     WHERE  CustomerID IN ( SELECT DISTINCT CustomerId 
                                            FROM tt_ExceptionFinalStatusType_13  )
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_44  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_A_44;
   UTILS.IDENTITY_RESET('tt_A_44');
   	...
   	SELECT DISTINCT CustomerAcID ,
   	 ...
   	 WHERE  EffectiveFromTimeKey <= v_Timekey
              ...
              AND CustomerAcID IN ( SELECT b.CustomerAcID 
                                    FROM tt_ExceptionFinalStatusType_13 Z
                                           ...
                                           LEFT JOIN ( SELECT AcID CustomerACID  ,
                                                       ...
                                                       FROM tt_ExceptionFinalStatusType_13  ) Y   ON Z.ACID = Y.CustomerACID
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DPD_56  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_56;
   UTILS.IDENTITY_RESET('tt_DPD_56');

   INSERT INTO tt_DPD_56 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_56 
   ...
   ----/* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_150') IS NOT NULL THEN
    --drop table if exists tt_TWOReport_18_Final
   --select * into tt_TWOReport_18_Final from tt_TWOReport_18 
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_150 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_150;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_150');

   INSERT INTO tt_TEMPTABLE_150 ( 
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_TWOReport_18  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TWOReport_18;
   UTILS.IDENTITY_RESET('tt_TWOReport_18');

   INSERT INTO tt_TWOReport_18 ( 
   	SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
           ...
           IntOverdue ----Added by Prashant---26022024------

   	  FROM tt_ExceptionFinalStatusType_13 Z
             LEFT JOIN PRO_RBL_MISDB_PROD.AccountCal_Hist B   ON Z.ACID = B.CustomerACID
             AND B.EffectiveFromTimeKey <= v_Timekey
             AND B.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_Accountcal_13 AC   ON Z.ACID = AC.CustomerACID
             LEFT JOIN PRO_RBL_MISDB_PROD.CustomerCal_Hist A   ON A.CustomerEntityID = b.CustomerEntityID
             AND A.EffectiveFromTimeKey <= v_Timekey
             AND A.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_DimCustomer_13 xyz   ON Z.CustomerID = xyz.CustomerId
             ...
             LEFT JOIN ( SELECT ACID CustomerAcID  ,
                                ...
                                StatusDate WriteOffDt  
                         FROM tt_ExceptionFinalStatusType_13  ) Y   ON Z.ACID = Y.CustomerAcID
             LEFT JOIN tt_DPD_56 DPD   ON DPD.AccountEntityID = b.AccountEntityID
   ...
   FROM A ,tt_TWOReport_18 A
          JOIN tt_Accountcal_13 B   ON A.Account_No_ = B.CustomerACID ) src
   ON ( A.ROWID = src.row_id )
   ...
   INSERT INTO TWOReport_Final
     ( SELECT Report_date ,
              ...
              Host_System ,
              Business_Segment 
       FROM tt_TWOReport_18 
        WHERE  NOT ( Opening_Balance = 0.00
                 AND Addition = 0.00
                 AND Closing_Balance_POS = 0.00
                 AND IntOverdue = 0 ) );----Added by Prashant---26022024------add intoverdue=0 condition---------------
   OPEN  v_cursor FOR
      SELECT Report_date ,
             UCIC ,
             CIF_ID ,
             ...
             Write_off ,
             Closing_Balance_POS ,
             Reduction_in_Balance ,--[Reporting_Period]
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TWOREPORT_02052024" TO "ADF_CDR_RBL_STGDB";
