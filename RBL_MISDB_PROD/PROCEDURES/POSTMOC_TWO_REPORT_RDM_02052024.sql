--------------------------------------------------------
--  DDL for Procedure POSTMOC_TWO_REPORT_RDM_02052024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" 
AS
...
BEGIN
   ...
   IF tt_ExceptionFinalStatusType_7  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_ExceptionFinalStatusType_7;
   UTILS.IDENTITY_RESET('tt_ExceptionFinalStatusType_7');

   INSERT INTO tt_ExceptionFinalStatusType_7 SELECT DISTINCT A.* ,
   ...
   DELETE tt_ExceptionFinalStatusType_7

    WHERE  RANK > 1;
   -----------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_OpeningBalance_7  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_OpeningBalance_7;
   UTILS.IDENTITY_RESET('tt_OpeningBalance_7');

   INSERT INTO tt_OpeningBalance_7 SELECT A.ACID ,
                                          B.PrincOutStd ,
                                          ROW_NUMBER() OVER ( PARTITION BY A.ACID ORDER BY A.ACID, B.EffectiveToTimeKey DESC  ) RANK  
        FROM tt_ExceptionFinalStatusType_7 A
       ...
       WHERE  ( ( a.EffectiveFromTimeKey <= v_LastQtrTimekey
                ...
                AND statustype = 'TWO';
   UPDATE tt_OpeningBalance_7
      SET PrincOutStd = 0
    WHERE  PrincOutStd < 0;
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_31ccountCal  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_Accountcal_7;
   UTILS.IDENTITY_RESET('tt_Accountcal_7');

   INSERT INTO tt_Accountcal_7 ( 
   	SELECT * 
   	  FROM ( SELECT CustomerAcID ,
             ...
             FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
              WHERE  A.EFFECTIVEFROMTIMEKEY <= v_Timekey
                       AND A.EffectiveToTimeKey >= v_LastQtrTimekey ) A );
   MERGE INTO A 
   USING (SELECT A.ROWID row_id, B.fis_acct_no
   FROM A ,tt_Accountcal_7 A
   ...
   UPDATE tt_ExceptionFinalStatusType_7
   ...
   --------------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DimCustomer_7  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DimCustomer_7;
   UTILS.IDENTITY_RESET('tt_DimCustomer_7');

   INSERT INTO tt_DimCustomer_7 ( 
             ...
             JOIN ( SELECT DISTINCT CustomerID ,
                    ...
                    FROM CustomerBasicDetail 
                     WHERE  CustomerID IN ( SELECT DISTINCT CustomerId 
                                            FROM tt_ExceptionFinalStatusType_7  )
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_31  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_A_31;
   UTILS.IDENTITY_RESET('tt_A_31');
   	...
   	SELECT DISTINCT CustomerAcID ,
   	 ...
   	 WHERE  EffectiveFromTimeKey <= v_Timekey
              ...
              AND CustomerAcID IN ( SELECT b.CustomerAcID 
                                    FROM tt_ExceptionFinalStatusType_7 Z
                                           ...
                                           LEFT JOIN ( SELECT AcID CustomerACID  ,
                                                       ...
                                                       FROM tt_ExceptionFinalStatusType_7  ) Y   ON Z.ACID = Y.CustomerACID
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DPD_13  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_13;
   UTILS.IDENTITY_RESET('tt_DPD_13');

   INSERT INTO tt_DPD_13 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_13 
   ...
   ----/* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_100') IS NOT NULL THEN
    --drop table if exists tt_TWOReport_7_Final
   --select * into tt_TWOReport_7_Final from tt_TWOReport_7 
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_100 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_100;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_100');

   INSERT INTO tt_TEMPTABLE_100 ( 
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_TWOReport_7  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TWOReport_7;
   UTILS.IDENTITY_RESET('tt_TWOReport_7');

   INSERT INTO tt_TWOReport_7 ( 
   	SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
           ...
           CASE 
                ...
                WHEN SourceName = 'VisionPlus'
                  AND AC.ProductCode IN ( '777','780' )
                 THEN 'Retail'
                WHEN SourceName = 'VisionPlus'
                  AND AC.ProductCode NOT IN ( '777','780' )
                 THEN 'Credit Card'
   	  ...
   	  FROM tt_ExceptionFinalStatusType_7 Z
             ...
             AND B.EffectiveFromTimeKey <= v_Timekey
             AND B.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_Accountcal_7 AC   ON Z.ACID = AC.CustomerACID
             LEFT JOIN PRO_RBL_MISDB_PROD.CustomerCal_Hist A   ON A.CustomerEntityID = b.CustomerEntityID
             AND A.EffectiveFromTimeKey <= v_Timekey
             AND A.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_DimCustomer_7 xyz   ON Z.CustomerID = xyz.CustomerId
             ...
             LEFT JOIN ( SELECT ACID CustomerAcID  ,
                                ...
                                StatusDate WriteOffDt  
                         FROM tt_ExceptionFinalStatusType_7  ) Y   ON Z.ACID = Y.CustomerAcID
             LEFT JOIN tt_DPD_13 DPD   ON DPD.AccountEntityID = b.AccountEntityID
   ...
   FROM A ,tt_TWOReport_7 A
          JOIN tt_Accountcal_7 B   ON A.Account_No_ = B.CustomerACID ) src
   ON ( A.ROWID = src.row_id )
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE RBL_MISDB_PROD.TWOReport_Final_postmoc_RDM ';
   INSERT INTO RBL_MISDB_PROD.TWOReport_Final_postmoc_RDM
     ( SELECT * 
       FROM tt_TWOReport_7 
   ...
   OPEN  v_cursor FOR
      SELECT Report_date ,
             ...
             --,[Reporting_Period]
             UTILS.CONVERT_TO_NVARCHAR2(UTILS.CONVERT_TO_VARCHAR2(Reporting_Period,200,p_style=>105),10,p_style=>23) Reporting_Period  ,
             DPD ,
             --,[NPA Date]
             UTILS.CONVERT_TO_NVARCHAR2(UTILS.CONVERT_TO_VARCHAR2(NPA_Date,200,p_style=>105),10,p_style=>23) NPA_Date  ,
             Asset_Classification ,
             --,[Date of Technical Write-off]
             UTILS.CONVERT_TO_NVARCHAR2(UTILS.CONVERT_TO_VARCHAR2(Date_of_Technical_Write_off,200,p_style=>105),10,p_style=>23) Date_of_Technical_Write_off  ,
             Host_System ,
             Business_Segment 
        FROM RBL_MISDB_PROD.TWOReport_Final_postmoc_RDM  ;
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
