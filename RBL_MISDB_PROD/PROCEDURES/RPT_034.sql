--------------------------------------------------------
--  DDL for Procedure RPT_034
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RPT_034" /*
...
BEGIN
   ...
   BEGIN
      ----------------------------------------
      IF utils.object_id('TEMPDB..tt_A_34') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_A_34 ';
      END IF;
      DELETE FROM tt_A_34;
      UTILS.IDENTITY_RESET('tt_A_34');
      ...
      IF tt_DPD_25  --SQLDEV: NOT RECOGNIZED
      DELETE FROM tt_DPD_25;
      UTILS.IDENTITY_RESET('tt_DPD_25');

      INSERT INTO tt_DPD_25 ( 
      	SELECT CustomerACID ,
              AccountEntityid ,
      ...
      EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_25 
      ...
      /* CALCULATE MAX DPD */
      IF utils.object_id('TEMPDB..tt_TEMPTABLE_124') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_124 ';
      END IF;
      DELETE FROM tt_TEMPTABLE_124;
      UTILS.IDENTITY_RESET('tt_TEMPTABLE_124');

      INSERT INTO tt_TEMPTABLE_124 ( 
      ...
      --------------------------------------------------------------
      IF utils.object_id('TEMPDB..tt_TWOReport_10') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TWOReport_10 ';
      END IF;
      DELETE FROM tt_TWOReport_10;
      UTILS.IDENTITY_RESET('tt_TWOReport_10');

      INSERT INTO tt_TWOReport_10 ( 
      	SELECT ( SELECT date_ 
                FROM SysDayMatrix 
      	  ...
      	  FROM ExceptionFinalStatusType Z
                ...
                LEFT JOIN ( SELECT ACID CustomerAcID  ,
                            ...
                            FROM ExceptionFinalStatusType 
                             WHERE  UTILS.CONVERT_TO_VARCHAR2(StatusDate,200) <= v_LastQtrDate
                                      AND EffectiveToTimeKey = 49999 ) Y   ON B.CustomerAcID = Y.CustomerAcID
                LEFT JOIN tt_DPD_25 DPD   ON DPD.AccountEntityID = B.AccountEntityID
      ...
      ELSE B.SMA_Class
         END) AS pos_3
      FROM A ,tt_TWOReport_10 A
             JOIN tt_A_34 B   ON A.Account_No_ = B.CustomerACID ) src
      ON ( A.ROWID = src.row_id )
      ...
      OPEN  v_cursor FOR
         SELECT Report_date ,
                ...
                Host_System ,
                Business_Segment 
           FROM tt_TWOReport_10  ;
         DBMS_SQL.RETURN_RESULT(v_cursor);

   END;
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_A_34 ';
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DPD_25 ';
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_124 ';
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TWOReport_10 ';
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPT_034" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPT_034" TO "ADF_CDR_RBL_STGDB";
