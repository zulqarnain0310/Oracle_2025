--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" 
(
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Address Type is blank . Please check the values and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Address Type is blank . Please check the values and upload again'
                      END,
                   V.ErrorinColumn = CASE 
            ...
            INSERT INTO AddressCategoryData SELECT * 
                 FROM ( SELECT ROW_NUMBER() OVER ( PARTITION BY AddressType ORDER BY AddressType  ) ROW_  ,
                               AddressType 
                        FROM UploadOtherOwnerDetail  ) X
                WHERE  ROW_ = 1;
            SELECT COUNT(*)  
              ...
              FROM AddressCategoryData A
                     LEFT JOIN DimRelCategory B   ON A.AddressType = B.RelCategoryName
             WHERE  B.RelCategoryName IS NULL;
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
            ...
            --				SELECT  A.AddressType FROM AddressCategoryData A
            --					 LEFT JOIN DimRelCategory B
            --					 ON  A.AddressType=B.RelCategoryName
            --					 Where B.RelCategoryName IS NULL
            --				 )
            --END 
            -----------------------------------------------
            ...
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Std Code (O)  cannot be blank . Please check the values and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Std Code (O)  cannot be blank . Please check the values and upload again'
                      END,
                   V.ErrorinColumn = CASE 
            ...
            UPDATE UploadOtherOwnerDetail V
             ...
             WHERE  ( utils.isnumeric(StdCodeO) = 0
              AND NVL(StdCodeO, ' ') <> ' ' )
              OR REGEXP_LIKE(utils.isnumeric(StdCodeO), '%^[0-9]%');
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid STD CODE (O), please check and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid STD CODE (O), please check and upload again'
            ...
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Phone No (O)  cannot be blank . Please check the values and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Phone No (O)  cannot be blank . Please check the values and upload again'
                      END,
                   V.ErrorinColumn = CASE 
            ...
            UPDATE UploadOtherOwnerDetail V
             ...
             WHERE  ( utils.isnumeric(PhoneNoO) = 0
              AND NVL(PhoneNoO, ' ') <> ' ' )
              OR REGEXP_LIKE(utils.isnumeric(PhoneNoO), '%^[0-9]%');
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid STD CODE (O), please check and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid STD CODE (O), please check and upload again'
            ...
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Std Code (R)  cannot be blank . Please check the values and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Std Code (R)  cannot be blank . Please check the values and upload again'
                      END,
                   V.ErrorinColumn = CASE 
            ...
            UPDATE UploadOtherOwnerDetail V
             ...
             WHERE  ( utils.isnumeric(StdCodeR) = 0
              AND NVL(StdCodeR, ' ') <> ' ' )
              OR REGEXP_LIKE(utils.isnumeric(StdCodeR), '%^[0-9]%');
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid Std Code (R), please check and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid Std Code (R), please check and upload again'
            ...
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Phone No (R) cannot be blank . Please check the values and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Phone No (R)  cannot be blank . Please check the values and upload again'
                      END,
                   V.ErrorinColumn = CASE 
            ...
            UPDATE UploadOtherOwnerDetail V
             ...
             WHERE  ( utils.isnumeric(PhoneNoR) = 0
              AND NVL(PhoneNoR, ' ') <> ' ' )
              OR REGEXP_LIKE(utils.isnumeric(PhoneNoR), '%^[0-9]%');
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid Phone No (R), please check and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid Phone No (R), please check and upload again'
            ...
            UPDATE UploadOtherOwnerDetail V
             ...
             WHERE  ( utils.isnumeric(MobileNo) = 0
              AND NVL(MobileNo, ' ') <> ' ' )
              OR REGEXP_LIKE(utils.isnumeric(MobileNo), '%^[0-9]%');
            UPDATE UploadOtherOwnerDetail V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid Mobile No., please check and upload again'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid Mobile No., please check and upload again'
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_COLLETRALOTHEROWNERUPLOAD_18082021" TO "ADF_CDR_RBL_STGDB";
