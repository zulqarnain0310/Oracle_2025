--------------------------------------------------------
--  DDL for Procedure POSTMOC_TWO_REPORT_RDM_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" 
AS
...
BEGIN
   ...
   IF tt_ExceptionFinalStatusType_8  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_ExceptionFinalStatusType_8;
   UTILS.IDENTITY_RESET('tt_ExceptionFinalStatusType_8');

   INSERT INTO tt_ExceptionFinalStatusType_8 SELECT DISTINCT A.* ,
   ...
   DELETE tt_ExceptionFinalStatusType_8

    WHERE  RANK > 1;
   -----------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_OpeningBalance_8  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_OpeningBalance_8;
   UTILS.IDENTITY_RESET('tt_OpeningBalance_8');

   INSERT INTO tt_OpeningBalance_8 SELECT A.ACID ,
                                          B.PrincOutStd ,
                                          ROW_NUMBER() OVER ( PARTITION BY A.ACID ORDER BY A.ACID, B.EffectiveToTimeKey DESC  ) RANK  
        FROM tt_ExceptionFinalStatusType_8 A
       ...
       WHERE  ( ( a.EffectiveFromTimeKey <= v_LastQtrTimekey
                ...
                AND statustype = 'TWO';
   UPDATE tt_OpeningBalance_8
      SET PrincOutStd = 0
    WHERE  PrincOutStd < 0;
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_32ccountCal  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_Accountcal_8;
   UTILS.IDENTITY_RESET('tt_Accountcal_8');

   INSERT INTO tt_Accountcal_8 ( 
   	SELECT * 
   ...
   UPDATE tt_ExceptionFinalStatusType_8
   ...
   --------------------------------------------------------------------------------------------------------
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DimCustomer_8  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DimCustomer_8;
   UTILS.IDENTITY_RESET('tt_DimCustomer_8');

   INSERT INTO tt_DimCustomer_8 ( 
             ...
             JOIN ( SELECT DISTINCT CustomerID ,
                    ...
                    FROM CustomerBasicDetail 
                     WHERE  CustomerID IN ( SELECT DISTINCT CustomerId 
                                            FROM tt_ExceptionFinalStatusType_8  )
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_A_32  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_A_32;
   UTILS.IDENTITY_RESET('tt_A_32');
   	...
   	SELECT DISTINCT CustomerAcID ,
   	 ...
   	 WHERE  EffectiveFromTimeKey <= v_Timekey
              ...
              AND CustomerAcID IN ( SELECT b.CustomerAcID 
                                    FROM tt_ExceptionFinalStatusType_8 Z
                                           ...
                                           LEFT JOIN ( SELECT AcID CustomerACID  ,
                                                       ...
                                                       FROM tt_ExceptionFinalStatusType_8  ) Y   ON Z.ACID = Y.CustomerACID
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_DPD_14  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_14;
   UTILS.IDENTITY_RESET('tt_DPD_14');

   INSERT INTO tt_DPD_14 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_14 
   ...
   ----/* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_101') IS NOT NULL THEN
    --drop table if exists tt_TWOReport_8_Final
   --select * into tt_TWOReport_8_Final from tt_TWOReport_8 
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_101 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_101;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_101');

   INSERT INTO tt_TEMPTABLE_101 ( 
   ...
   IF  --SQLDEV: NOT RECOGNIZED
   IF tt_TWOReport_8  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_TWOReport_8;
   UTILS.IDENTITY_RESET('tt_TWOReport_8');

   INSERT INTO tt_TWOReport_8 ( 
   	SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_date  ,
   	  ...
   	  FROM tt_ExceptionFinalStatusType_8 Z
             ...
             AND B.EffectiveFromTimeKey <= v_Timekey
             AND B.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_Accountcal_8 AC   ON Z.ACID = AC.CustomerACID
             LEFT JOIN PRO_RBL_MISDB_PROD.CustomerCal_Hist A   ON A.CustomerEntityID = b.CustomerEntityID
             AND A.EffectiveFromTimeKey <= v_Timekey
             AND A.EffectiveToTimeKey >= v_Timekey
             LEFT JOIN tt_DimCustomer_8 xyz   ON Z.CustomerID = xyz.CustomerId
             ...
             LEFT JOIN ( SELECT ACID CustomerAcID  ,
                                ...
                                StatusDate WriteOffDt  
                         FROM tt_ExceptionFinalStatusType_8  ) Y   ON Z.ACID = Y.CustomerAcID
             LEFT JOIN tt_DPD_14 DPD   ON DPD.AccountEntityID = b.AccountEntityID
   ...
   FROM A ,tt_TWOReport_8 A
          JOIN tt_Accountcal_8 B   ON A.Account_No_ = B.CustomerACID ) src
   ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_TWO_REPORT_RDM_04122023" TO "ADF_CDR_RBL_STGDB";
