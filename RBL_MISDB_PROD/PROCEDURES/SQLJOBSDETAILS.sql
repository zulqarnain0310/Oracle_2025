--------------------------------------------------------
--  DDL for Procedure SQLJOBSDETAILS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SQLJOBSDETAILS" 
(
...
BEGIN
   ...
   INSERT INTO tt_Temp_114 SELECT j.job_id ,
                                  j.NAME Jobname  ,
   ...
   IF utils.object_id('TEMPDB..tt_JobStartEndTimeDesc') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_JobStartEndTimeDesc ';
   END IF;
   DELETE FROM tt_JobStartEndTimeDesc;
   UTILS.IDENTITY_RESET('tt_JobStartEndTimeDesc');

   INSERT INTO tt_JobStartEndTimeDesc SELECT sj.NAME JobName  ,
   ...
   BEGIN
      INSERT INTO tt_JobStartEndTimeDesc
   ...
   END;
   END IF;
   IF utils.object_id('TEMPDB..tt_TMPJobStepCount') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TMPJobStepCount ';
   END IF;
   DELETE FROM tt_TMPJobStepCount;
   UTILS.IDENTITY_RESET('tt_TMPJobStepCount');

   INSERT INTO tt_TMPJobStepCount ( 
   	SELECT A.job_id ,
           A.Name JobName  ,
   ...
   IF utils.object_id('TEMPDB..tt_SQLJobStatus') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SQLJobStatus ';
   END IF;
   DELETE FROM tt_SQLJobStatus;
   UTILS.IDENTITY_RESET('tt_SQLJobStatus');

   INSERT INTO tt_SQLJobStatus SELECT JobName ,
                                      JobStatus ,
                                      RunDate ,
                                      RunningStatus ,
                                      TotalJobSteps ,
        ...
        FROM ( SELECT B.NAME JOBNAME  ,
               ...
               FROM MSDB.sysjobs B
                      ...
                      LEFT JOIN tt_Temp_114 C   ON B.job_id = C.job_id
                      LEFT JOIN tt_TMPJobStepCount D   ON B.NAME = D.JobName ) A
       WHERE  RN = 1;
   MERGE INTO A 
   USING (SELECT A.ROWID row_id, b.RunningStatus
   FROM A ,tt_SQLJobStatus a
          JOIN tt_Temp_114 b   ON a.JOBNAME = b.Jobname ) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET a.RunningStatus = src.RunningStatus;
   OPEN  v_cursor FOR
      SELECT A.* 
        FROM tt_SQLJobStatus A
           ...
           FROM ( SELECT * ,
                  ...
                  FROM ( SELECT --A.UserId
                         ...
                         FROM JobLogsHistory A
                                ...
                                LEFT JOIN tt_JobStartEndTimeDesc C   ON A.JobName = C.Jobname
   ...
   --		AND start_execution_date is not null
   --		AND stop_execution_date is null
   IF utils.object_id('Tempdb..tt_temp2_11') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp2_11 ';
   END IF;
   DELETE FROM tt_temp2_11;
   UTILS.IDENTITY_RESET('tt_temp2_11');

   INSERT INTO tt_temp2_11 SELECT j.NAME ,
                                  'IN-PROGRESS' STATUS  
        FROM msdb.sysjobactivity ja
               LEFT JOIN msdb.sysjobhistory jh   ON ja.job_history_id = jh.instance_id
               JOIN msdb.sysjobs j   ON ja.job_id = j.job_id
   ...
   OPEN  v_cursor FOR
      ...
      DBMS_SQL.RETURN_RESULT(v_cursor);--SELECT * FROM tt_JobStartEndTimeDesc
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SQLJOBSDETAILS" TO "ADF_CDR_RBL_STGDB";
