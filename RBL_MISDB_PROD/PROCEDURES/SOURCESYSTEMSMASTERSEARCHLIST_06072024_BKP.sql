--------------------------------------------------------
--  DDL for Procedure SOURCESYSTEMSMASTERSEARCHLIST_06072024_BKP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERSEARCHLIST_06072024_BKP" 
(
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_271') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_271 ';
            END IF;
            DELETE FROM tt_temp_271;
            UTILS.IDENTITY_RESET('tt_temp_271');

            INSERT INTO tt_temp_271 ( 
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp_27116') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_218 ';
               END IF;
               DELETE FROM tt_temp16_218;
               UTILS.IDENTITY_RESET('tt_temp16_218');

               INSERT INTO tt_temp16_218 ( 
               	SELECT A.SourceAlt_Key ,
                       A.SourceSysName ,
                       A.AuthorisationStatus ,
                       A.EffectiveFromTimeKey ,
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_27120') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_183 ';
                  END IF;
                  DELETE FROM tt_temp20_183;
                  UTILS.IDENTITY_RESET('tt_temp20_183');

                  INSERT INTO tt_temp20_183 ( 
                  	SELECT A.SourceAlt_Key ,
                          A.SourceSysName ,
                          A.AuthorisationStatus ,
                          A.EffectiveFromTimeKey ,
