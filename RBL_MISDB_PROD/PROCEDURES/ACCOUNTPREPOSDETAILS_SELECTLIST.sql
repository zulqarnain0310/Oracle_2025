...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         DELETE FROM GTT_ACCOUNT_PREMOC_1;
         UTILS.IDENTITY_RESET('GTT_ACCOUNT_PREMOC_1');

         INSERT INTO GTT_ACCOUNT_PREMOC_1 ( AccountEntityId,	AccountID,	Balance,	InttServiced,	FLGFITL,	DFVAmt,	RePossession,	RepossessionDate,	Sarfaesi,	AddlProvision,	FlgMoc,	UCICID,	AuthorisationStatus,	CreatedBy,	DateCreated,	ModifiedBy,	DateModified,	ApprovedBy,	DateApproved)
         	SELECT * 
         ...
         DELETE FROM GTT_ACCOUNT_POSTMOC_1;
         UTILS.IDENTITY_RESET('GTT_ACCOUNT_POSTMOC_1');

         INSERT INTO GTT_ACCOUNT_POSTMOC_1 ( ACCOUNTENTITYID,	ACCOUNTID,	BALANCE,	INTTSERVICED,	DFVAMT,	REPOSSESSION,	REPOSSESSIONDATE,	SARFAESI,	FLGMOC,	UCICID,	AUTHORISATIONSTATUS,	CREATEDBY,	DATECREATED,	MODIFIEDBY,	DATEMODIFIED,	APPROVEDBY,	DATEAPPROVED)
         	SELECT AccountEntityId ,
                 AccountID AccountID  ,
                 POS Balance  ,
                 InterestReceivable ,
         ...
         BEGIN
            INSERT INTO GTT_ACCOUNT_POSTMOC_1
              ( SELECT AccountEntityId ,
                       CustomerACID AccountID  ,
                       Balance ,
                       InttServiced ,
         ...
         OPEN  v_cursor FOR
            SELECT A.CustomerACID AccountID  ,
                   ...
                   B.INTTSERVICED InterestReceivable_POS  ,
                   B.DFVAmt DFVAmount_POS  ,
              ...
              FROM GTT_ACCOUNT_PREMOC_1 A
                     LEFT JOIN GTT_ACCOUNT_POSTMOC_1 B   ON A.AccountID = B.AccountID
