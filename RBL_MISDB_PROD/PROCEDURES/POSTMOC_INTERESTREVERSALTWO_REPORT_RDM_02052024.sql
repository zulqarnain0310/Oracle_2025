--------------------------------------------------------
--  DDL for Procedure POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" 
AS
...
BEGIN
   ...
   IF tt_dpd2_32  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_dpd2_32;
   UTILS.IDENTITY_RESET('tt_dpd2_32');

   INSERT INTO tt_dpd2_32 ( 
   	SELECT CustomerACID ,
           AccountEntityid ,
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_dpd2_32 
   ...
   --UPDATE A SET DPD_NoCredit=0 FROM tt_dpd2_32 A   
   /* CALCULATE MAX DPD */
   IF utils.object_id('TEMPDB..tt_TEMPTABLE_87') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMPTABLE_87 ';
   END IF;
   DELETE FROM tt_TEMPTABLE_87;
   UTILS.IDENTITY_RESET('tt_TEMPTABLE_87');

   INSERT INTO tt_TEMPTABLE_87 ( 
   ...
   INSERT INTO RBL_MISDB_PROD.PostMOC_INTEREST_TWO_Automate_RDM
     ( SELECT UTILS.CONVERT_TO_NVARCHAR2(v_Date,30,p_style=>105) Report_Date  ,
       ...
       FROM PRO_RBL_MISDB_PROD.CustomerCal_Hist A
              ...
              LEFT JOIN tt_dpd2_32 DPD   ON B.accountentityid = DPD.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."POSTMOC_INTERESTREVERSALTWO_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
