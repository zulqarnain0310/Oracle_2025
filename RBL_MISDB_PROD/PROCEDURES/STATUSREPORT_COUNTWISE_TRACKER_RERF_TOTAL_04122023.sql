--------------------------------------------------------
--  DDL for Procedure STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" 
AS
...
BEGIN
   ...
   --------------Finacle          
   IF utils.object_id('tempdb..tt_temp1_55') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp1_55 ';
   END IF;
   DELETE FROM tt_temp1_55;
   DBMS_OUTPUT.PUT_LINE('Finacle ');
   IF utils.object_id('TempDB..tt_Finacle_71') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Finacle_71 ';
   END IF;
   DELETE FROM tt_Finacle_71;
   UTILS.IDENTITY_RESET('tt_Finacle_71');

   INSERT INTO tt_Finacle_71 ( 
   ...
   --------------Ganaseva---------------------------------------------------------------------------------------------------------------        
   IF utils.object_id('TempDB..tt_Ganaseva_62') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Ganaseva_62 ';
   END IF;
   DELETE FROM tt_Ganaseva_62;
   UTILS.IDENTITY_RESET('tt_Ganaseva_62');

   INSERT INTO tt_Ganaseva_62 ( 
   ...
   INSERT INTO tt_temp1_55
     ( SELECT SourceAlt_Key ,
       ...
       FROM ( SELECT * 
         ...
         GROUP BY SourceAlt_Key,SourceName );
   --------------ECBF  ----------------------------------------------------------------------------------------------------
   IF utils.object_id('TempDB..tt_ACCOUNTCAL_DPD_29') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_DPD_29 ';
   END IF;
   DELETE FROM tt_ACCOUNTCAL_DPD_29;
   UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_DPD_29');

   INSERT INTO tt_ACCOUNTCAL_DPD_29 ( 
   	SELECT CustomerEntityID ,
           MAX(DPD_Max)  DPD_Max  
   	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
   	  GROUP BY CustomerEntityID );
   IF utils.object_id('TempDB..tt_ECBF_73') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ECBF_73 ';
   END IF;
   DELETE FROM tt_ECBF_73;
   UTILS.IDENTITY_RESET('tt_ECBF_73');

   INSERT INTO tt_ECBF_73 ( 
   	SELECT RefCustomerID ,
   	  ...
   	  FROM ( SELECT A.RefCustomerID ,
             ...
             FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                    ...
                    AND Z.EffectiveFromTimeKey <= v_Timekey
                    AND Z.EffectiveToTimeKey >= v_Timekey
                    LEFT JOIN tt_ACCOUNTCAL_DPD_29 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
   ...
   INSERT INTO tt_temp1_55
     ( SELECT SourceAlt_Key ,
       ...
       FROM ( SELECT * 
         ...
         GROUP BY SourceAlt_Key,SourceName );
   --------------Indus  -----------------------------------------------------------------------------------------------------------------
   IF utils.object_id('TempDB..tt_Indus_71') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Indus_71 ';
   END IF;
   DELETE FROM tt_Indus_71;
   UTILS.IDENTITY_RESET('tt_Indus_71');

   INSERT INTO tt_Indus_71 ( 
   	SELECT A.RefCustomerID ,
           A.SysAssetClassAlt_Key FinalAssetClassAlt_Key  ,
           A.SysNPA_Dt FinalNpaDt  ,
           B.SourceAssetClass ,
   ...
   INSERT INTO tt_temp1_55
     ( SELECT SourceAlt_Key ,
       ...
       FROM ( SELECT * 
         ...
         GROUP BY SourceAlt_Key,SourceName );
   --------------MiFin            
   IF utils.object_id('TempDB..tt_MiFin_71') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MiFin_71 ';
   END IF;
   DELETE FROM tt_MiFin_71;
   UTILS.IDENTITY_RESET('tt_MiFin_71');

   INSERT INTO tt_MiFin_71 ( 
   	SELECT A.RefCustomerID ,
           A.SysAssetClassAlt_Key ,
           A.SysNPA_Dt ,
           B.SourceAssetClass ,
   ...
   INSERT INTO tt_temp1_55
     ( SELECT SourceAlt_Key ,
       ...
       FROM ( SELECT * 
         ...
         GROUP BY SourceAlt_Key,SourceName );
   --------------VisionPlus ----------------------------------------------------------------------------
   IF utils.object_id('TempDB..tt_CorporateCustID_10') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CorporateCustID_10 ';
   END IF;
   DELETE FROM tt_CorporateCustID_10;
   UTILS.IDENTITY_RESET('tt_CorporateCustID_10');

   INSERT INTO tt_CorporateCustID_10 ( 
   ...
   IF utils.object_id('TempDB..#VisionPlus') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_VisionPlus_32 ';
   END IF;
   DELETE FROM tt_VisionPlus1_10;
   UTILS.IDENTITY_RESET('tt_VisionPlus1_10');

   INSERT INTO tt_VisionPlus1_10 ( 
   	SELECT A.RefCustomerID CustomerID  ,
           A.SysAssetClassAlt_Key FinalAssetClassAlt_Key  ,
           A.SysNPA_Dt FinalNpaDt  ,
           (CASE 
   	  ...
   	  FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
             ...
             LEFT JOIN tt_CorporateCustID_10 CC   ON a.RefCustomerID = CC.RefCustomerID
   ...
   DELETE A
    WHERE ROWID IN 
   ( SELECT A.ROWID
     FROM tt_VisionPlus1_10 a
            JOIN ReverseFeedData b   ON A.CustomerID = b.CustomerID,
          A
    WHERE  b.DateofData = v_Date );
   IF utils.object_id('TempDB..tt_AssetClass_10') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AssetClass_10 ';
   END IF;
   DELETE FROM tt_AssetClass_10;
   UTILS.IDENTITY_RESET('tt_AssetClass_10');

   INSERT INTO tt_AssetClass_10 ( 
       ...
       FROM ( SELECT * 
              FROM ( SELECT A.Corporate_Customer_ID CustomerID  ,
                     ...
                     SELECT CorporateCustomerID CustomerID  ,
                            ...
                            SourceName 
                     FROM tt_VisionPlus1_10 A
                            JOIN tt_AssetClass_10 b   ON a.FinalAssetClassAlt_Key = b.AssetClassAlt_key
                      WHERE  A.BankAssetClass = 1
                               AND A.FinalAssetClassAlt_Key > 1
                     UNION 
                     SELECT CorporateCustomerID CustomerID  ,
         ...
         GROUP BY SourceAlt_Key,SourceName );
   --------------MetaGrid----------------------------------------------------------------------------------------------------------------
   IF utils.object_id('TempDB..tt_MetaGrid_73') IS NOT NULL THEN
   ...
   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MetaGrid_73 ';
   END IF;
   DELETE FROM tt_MetaGrid_73;
   UTILS.IDENTITY_RESET('tt_MetaGrid_73');

   INSERT INTO tt_MetaGrid_73 ( 
   	SELECT A.RefCustomerID ,
   ...
   --select * from tt_temp1_55          
   MERGE INTO A 
   USING (SELECT A.ROWID row_id, b.CNT
   FROM A ,StatusReport_RERF a
          JOIN tt_temp1_55 b   ON a.SourceAlt_Key = b.SourceAlt_Key ) src
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."STATUSREPORT_COUNTWISE_TRACKER_RERF_TOTAL_04122023" TO "ADF_CDR_RBL_STGDB";
