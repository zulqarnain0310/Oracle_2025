--------------------------------------------------------
--  DDL for Procedure CUSTOMERDETAILSELECT_20241003_BKP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" 
...
BEGIN
   ...
   IF v_temp = 1 THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerDetailSelect_5 ';
   END IF;
   DELETE FROM tt_CustomerDetailSelect_5;
   ...
   --select * from tt_CustomerDetailSelect_5
   ...
   BEGIN
      DBMS_OUTPUT.PUT_LINE(1);
      INSERT INTO tt_CustomerDetailSelect_5
        ...
        ( 
          ...
          SELECT C.CustomerEntityId ,
                 ...
                 CASE 
                      WHEN ES.CustomerID IS NOT NULL THEN 'NPA Write OFF'
                      WHEN EWO.CustomerID IS NOT NULL THEN 'NPA Write OFF'
          ...
          FROM CurDat_RBL_MISDB_PROD.CustomerBasicDetail C
                 ...
                 LEFT JOIN ExceptionFinalStatusType EWO   ON C.CustomerID = EWO.CustomerID
                 AND EWO.EffectiveFromTimeKey <= v_TimeKey
                 AND EWO.EffectiveToTimeKey >= v_TimeKey
                 AND EWO.StatusType = 'WO'
   ...
   BEGIN
      ...
      FROM T ,tt_CustomerDetailSelect_5 T
   ...
   BEGIN
      ...
      MERGE INTO T 
      USING (SELECT T.ROWID row_id, UTILS.CONVERT_TO_VARCHAR2(C.NPADt,10,p_style=>103) AS pos_2, UTILS.CONVERT_TO_VARCHAR2(C.DbtDt,10,p_style=>103) AS pos_3, C.StaffAccountability
      ...
      , CASE 
      WHEN ES.CustomerID IS NOT NULL THEN 'Actual Write Off'
      WHEN EWO.CustomerID IS NOT NULL THEN 'Actual Write Off'
      ELSE C.NPA_Reason
         END AS pos_7
      FROM T ,tt_CustomerDetailSelect_5 T
           ...
           --Added by Prashant--18042024--------
             ...
             AND ES.EffectiveToTimeKey >= v_TimeKey
             AND ES.StatusType = 'Charge Off'
             LEFT JOIN ExceptionFinalStatusType EWO   ON T.CustomerID = EWO.CustomerID
             AND EWO.EffectiveFromTimeKey <= v_TimeKey
             AND EWO.EffectiveToTimeKey >= v_TimeKey
             AND EWO.StatusType = 'WO' ) src
      ON ( T.ROWID = src.row_id )
      WHEN MATCHED THEN UPDATE SET
      --T.CurrentAssetClassAlt_Key=C.Cust_AssetClassAlt_Key,
       --T.FCRA_YN=C.FCRA_YN,
       T.NPA_Date
       --Added by Prashant--18042024--------
        --T.NPA_Date = CASE WHEN ES.CustomerID IS NOT NULL THEN convert(varchar(10),ES.StatusDate,103)
        --                  WHEN EWO.CustomerID IS NOT NULL THEN convert(varchar(10),EWO.StatusDate,103)
        --else convert(varchar(10),C.NPADt,103) END
        = pos_2,
       T.DbtDt = pos_3,
      ...
      SELECT CrModBy 
        ...
        FROM ( SELECT v_CustBasicCrMod CrModBy  
               ...
               SELECT v_CustCommCrMod CrModBy  
                 FROM DUAL  ) A
       WHERE  NVL(CrModBy, ' ') <> ' ';
      UPDATE tt_CustomerDetailSelect_5
         SET IsMainTable = 'N',
   ...
   OPEN  v_cursor FOR
      SELECT * 
        FROM tt_CustomerDetailSelect_5  ;
   ...
   --if exists(select EffectiveFromTimekey from tt_CustomerDetailSelect_5 )
   ...
   BEGIN
      --Select @FromDate=CAST(date as date) from SysDayMatrix where TimeKey=(select EffectiveFromTimekey from tt_CustomerDetailSelect_5)
      --Select TimeKey
      --,Convert(varchar(10),[Date],103) as [AvailableDate]
      --,@FromDate as MinDate
      --,@ToDate as MaxDate
      --from SysDayMatrix SD
      --inner join tt_CustomerDetailSelect_5 c
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERDETAILSELECT_20241003_BKP" TO "ADF_CDR_RBL_STGDB";
