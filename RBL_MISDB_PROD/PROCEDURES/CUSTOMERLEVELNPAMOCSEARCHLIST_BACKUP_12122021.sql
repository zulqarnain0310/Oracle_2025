--------------------------------------------------------
--  DDL for Procedure CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" 
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_CUST_PREMOC_6  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CUST_PREMOC_6;
         UTILS.IDENTITY_RESET('tt_CUST_PREMOC_6');

         INSERT INTO tt_CUST_PREMOC_6 ( 
         	SELECT * 
         ...
         ----POST 
         --Select 'tt_CUST_PREMOC_6',* from tt_CUST_PREMOC_6
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_CUST_POSTMOC_6  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CUST_POSTMOC_6;
         UTILS.IDENTITY_RESET('tt_CUST_POSTMOC_6');

         INSERT INTO tt_CUST_POSTMOC_6 ( 
         	SELECT CustomerEntityId ,
                 CustomerID ,
                 CustomerName ,
                 AssetClassAlt_Key ,
         ...
         END;
         END IF;
         --Select 'tt_CUST_POSTMOC_6',* from tt_CUST_POSTMOC_6
         OPEN  v_cursor FOR
            SELECT A.CustomerID CustomerId  ,
                   ...
                   A.SourceSystem 
              FROM tt_CUST_PREMOC_6 A
                     LEFT JOIN tt_CUST_POSTMOC_6 B   ON A.CustomerID = b.CustomerID
         ...
         IF utils.object_id('tempdb..tt_MOCAuthorisation_13') IS NOT NULL THEN

         BEGIN
            EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOCAuthorisation_13 ';

         END;
         END IF;
         DELETE FROM tt_MOCAuthorisation_13;
         UTILS.IDENTITY_RESET('tt_MOCAuthorisation_13');

         INSERT INTO tt_MOCAuthorisation_13 ( 
         	SELECT * ,
         ...
         --Select ' tt_MOCAuthorisation_13',* from  tt_MOCAuthorisation_13
         --where abc=1
         UPDATE tt_MOCAuthorisation_13 V
         ...
         ;
         MERGE INTO tt_MOCAuthorisation_13 G
         ...
         FROM AccountLevelMOC_Mod A
                ...
                JOIN tt_MOCAuthorisation_13 G   ON F.RefCustomerId = G.CustomerID 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERLEVELNPAMOCSEARCHLIST_BACKUP_12122021" TO "ADF_CDR_RBL_STGDB";
