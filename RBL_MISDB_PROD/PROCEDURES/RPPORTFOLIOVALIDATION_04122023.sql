--------------------------------------------------------
--  DDL for Procedure RPPORTFOLIOVALIDATION_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" 
(
...
BEGIN
   ...
   BEGIN
      IF utils.object_id('TEMPDB..tt_RPPortfoilioData_2') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_RPPortfoilioData_2 ';
      END IF;
      DELETE FROM tt_RPPortfoilioData_2;
      UTILS.IDENTITY_RESET('tt_RPPortfoilioData_2');

      INSERT INTO tt_RPPortfoilioData_2 SELECT ROW_NUMBER() OVER ( ORDER BY ( SELECT (1) 
                                                                                FROM DUAL  )  ) RowNum_  ,
      ...
      --select * from tt_RPPortfoilioData_2
      /****************************************************************************************************************
      ...
      ****************************************************************************************************************/
      ...
      ELSE A.ERROR || ',' || LPAD(' ', 1, ' ') || 'UCIC Id should not be Empty. Please check the values and upload again'
         END AS ERROR
      FROM A ,tt_RPPortfoilioData_2 A 
      ...
      ****************************************************************************************************************/
      ...
      --(
      ----SELECT 1
      --	SELECT RowNum ,1 correct FROM tt_RPPortfoilioData_2
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RPPORTFOLIOVALIDATION_04122023" TO "ADF_CDR_RBL_STGDB";
