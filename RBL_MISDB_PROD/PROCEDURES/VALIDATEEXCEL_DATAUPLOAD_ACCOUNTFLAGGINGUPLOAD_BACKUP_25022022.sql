--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" 
(
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            -- UPDATE TwoAc
            --SET  
            --       ErrorMessage=CASE WHEN ISNULL(ErrorMessage,'')='' THEN  'Account ID is pending from Authorization. Please Approve or Reject . '     
            --					ELSE ErrorMessage+','+SPACE(1)+'Account ID is pending from Authorization. Please Approve or Reject .'     END
            --	,ErrorinColumn=CASE WHEN ISNULL(ErrorinColumn,'')='' THEN 'ACID' ELSE ErrorinColumn +','+SPACE(1)+  'ACID' END  
            --	,Srnooferroneousrows=V.SrNo
            --	FROM TwoAc V  
            --WHERE ISNULL(V.ACID,'') <>''
            --AND ISNULL(V.ACID,'') IN(
            --Select AccountID from 
            --ExceptionalDegrationDetail_Mod
            --Where EffectiveFromTimeKey<=@TimeKey And EffectiveToTimeKey>=@TimeKey AND ISNULL(AuthorisationStatus,'A')
            --IN('NP','MP','1A')
            --)
            IF utils.object_id('TEMPDB..tt_DUB2_9') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB2_9 ';
            END IF;
            DELETE FROM tt_DUB2_9;
            UTILS.IDENTITY_RESET('tt_DUB2_9');

            INSERT INTO tt_DUB2_9 SELECT * 
                 FROM ( SELECT * ,
            ...
            UPDATE TwoAc V
               SET ErrorMessage = CASE 
                   ...
                   --	STUFF((SELECT ','+SRNO 
                    ...
                    ----AND SRNO IN(SELECT Srno FROM tt_DUB2_9))
                    --AND ACID IN(SELECT ACID FROM tt_DUB2_9 GROUP BY ACID))
                    --							FOR XML PATH ('')
                    --							),1,1,'')   
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCOUNTFLAGGINGUPLOAD_BACKUP_25022022" TO "ADF_CDR_RBL_STGDB";
