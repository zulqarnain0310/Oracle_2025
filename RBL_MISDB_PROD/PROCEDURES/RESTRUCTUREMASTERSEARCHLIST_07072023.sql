--------------------------------------------------------
--  DDL for Procedure RESTRUCTUREMASTERSEARCHLIST_07072023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" 
---------------------------------------------------------------------------------------------------------------------------
 ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 --1
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..#Previous') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Previous_5 ';
         END IF;
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_234') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_234 ';
            END IF;
            DELETE FROM tt_temp_234;
            UTILS.IDENTITY_RESET('tt_temp_234');

            INSERT INTO tt_temp_234 ( 
         ...
         BEGIN
            IF utils.object_id('TempDB..tt_temp_23416') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_187 ';
            END IF;
            DELETE FROM tt_temp16_187;
            UTILS.IDENTITY_RESET('tt_temp16_187');

            INSERT INTO tt_temp16_187 ( 
            	SELECT A.AccountEntityId ,
                    A.SystemACID ,
                    A.SourceName ,
                    A.CustomerId ,
         ...
         ELSE
            ...
            BEGIN
               IF utils.object_id('TempDB..tt_temp_23420') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_152 ';
               END IF;
               DELETE FROM tt_temp20_152;
               UTILS.IDENTITY_RESET('tt_temp20_152');

               INSERT INTO tt_temp20_152 ( 
               	SELECT A.AccountEntityId ,
                       A.SystemACID ,
                       A.SourceName ,
                       A.CustomerId ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREMASTERSEARCHLIST_07072023" TO "ADF_CDR_RBL_STGDB";
