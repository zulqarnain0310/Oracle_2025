--------------------------------------------------------
--  DDL for Procedure SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" 
(
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_Finacle_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Finacle_4 ';
         END IF;
         DELETE FROM tt_Finacle_4;
         UTILS.IDENTITY_RESET('tt_Finacle_4');

         INSERT INTO tt_Finacle_4 ( 
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_Ganaseva_2') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Ganaseva_2 ';
         END IF;
         DELETE FROM tt_Ganaseva_2;
         UTILS.IDENTITY_RESET('tt_Ganaseva_2');

         INSERT INTO tt_Ganaseva_2 ( 
      ...
      BEGIN
         --------------ECBF
         --Select * from (
         IF utils.object_id('TempDB..tt_ACCOUNTCAL_DPD_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_DPD_4 ';
         END IF;
         DELETE FROM tt_ACCOUNTCAL_DPD_4;
         UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_DPD_4');

         INSERT INTO tt_ACCOUNTCAL_DPD_4 ( 
         	SELECT CustomerEntityID ,
                 MAX(DPD_Max)  DPD_Max  
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	  GROUP BY CustomerEntityID );
         IF utils.object_id('TempDB..tt_ECBF_6') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ECBF_6 ';
         END IF;
         DELETE FROM tt_ECBF_6;
         UTILS.IDENTITY_RESET('tt_ECBF_6');

         INSERT INTO tt_ECBF_6 ( 
         	SELECT RefCustomerID ,
         	  ...
         	  FROM ( SELECT A.RefCustomerID ,
                   ...
                   FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                          ...
                          AND Z.EffectiveFromTimeKey <= v_Timekey
                          AND Z.EffectiveToTimeKey >= v_Timekey
                          LEFT JOIN tt_ACCOUNTCAL_DPD_4 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_Indus_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Indus_4 ';
         END IF;
         DELETE FROM tt_Indus_4;
         UTILS.IDENTITY_RESET('tt_Indus_4');

         INSERT INTO tt_Indus_4 ( 
         	SELECT A.RefCustomerID ,
                 A.SysAssetClassAlt_Key FinalAssetClassAlt_Key  ,
                 A.SysNPA_Dt FinalNpaDt  ,
                 B.SourceAssetClass ,
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..tt_MiFin_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MiFin_4 ';
         END IF;
         DELETE FROM tt_MiFin_4;
         UTILS.IDENTITY_RESET('tt_MiFin_4');

         INSERT INTO tt_MiFin_4 ( 
         	SELECT A.RefCustomerID ,
                 A.SysAssetClassAlt_Key ,
                 A.SysNPA_Dt ,
                 B.SourceAssetClass ,
      ...
      BEGIN
         ...
         -- --And A.AssetSubClass<>'STD'
         -- AND A.EffectiveFromTimekey<=@TimeKey AND A.EffectiveToTimeKey>=@TimeKey
         IF utils.object_id('TempDB..tt_MetaGrid_6') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MetaGrid_6 ';
         END IF;
         DELETE FROM tt_MetaGrid_6;
         UTILS.IDENTITY_RESET('tt_MetaGrid_6');

         INSERT INTO tt_MetaGrid_6 ( 
         	SELECT A.RefCustomerID ,
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_ACCOUNTCAL_TAF_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ACCOUNTCAL_TAF_4 ';
         END IF;
         DELETE FROM tt_ACCOUNTCAL_TAF_4;
         UTILS.IDENTITY_RESET('tt_ACCOUNTCAL_TAF_4');

         INSERT INTO tt_ACCOUNTCAL_TAF_4 ( 
         	SELECT CustomerEntityID ,
                 MAX(DPD_Max)  DPD_Max  
         	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL 
         	  GROUP BY CustomerEntityID );
         IF utils.object_id('TempDB..tt_EIFS_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_EIFS_4 ';
         END IF;
         DELETE FROM tt_EIFS_4;
         UTILS.IDENTITY_RESET('tt_EIFS_4');

         INSERT INTO tt_EIFS_4 ( 
         	SELECT RefCustomerID ,
                 FinalAssetClassAlt_Key ,
                 FinalNpaDt ,
                 SourceAssetClass ,
         	  ...
         	  FROM ( SELECT A.RefCustomerID ,
                   ...
                   FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL A
                          ...
                          AND Z.EffectiveFromTimeKey <= v_Timekey
                          AND Z.EffectiveToTimeKey >= v_Timekey
                          LEFT JOIN tt_ACCOUNTCAL_TAF_4 AD   ON AD.CustomerEntityID = Z.CustomerEntityID
                          JOIN DimProduct DP   ON DP.ProductAlt_Key = Z.ProductAlt_Key
                          AND DP.EffectiveFromTimeKey <= v_Timekey
                          AND DP.EffectiveToTimeKey >= v_Timekey
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SELECTASSETCLASSIFICATIONSOURCETYPEDATAFORUTILITY_05012024" TO "ADF_CDR_RBL_STGDB";
