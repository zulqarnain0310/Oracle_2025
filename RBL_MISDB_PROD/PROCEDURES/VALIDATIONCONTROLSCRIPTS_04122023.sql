--------------------------------------------------------
--  DDL for Procedure VALIDATIONCONTROLSCRIPTS_04122023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" 
AS
...
BEGIN
   ...
   DELETE ControlScripts
    ...
    WHERE  ExceptionCode = 6
             AND EffectiveFromTimeKey = ( SELECT timekey 
                                          FROM SysDataMatrix 
                                           WHERE  CurrentStatus = 'C' );
   IF utils.object_id('TEMPDB..tt_TempTableNpaCustomers_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableNpaCustomers_2 ';
   END IF;
   DELETE FROM tt_TempTableNpaCustomers_2;
   UTILS.IDENTITY_RESET('tt_TempTableNpaCustomers_2');

   INSERT INTO tt_TempTableNpaCustomers_2 ( 
   	SELECT UCIF_ID ,
           RefCustomerID ,
           SourceSystemCustomerID ,
           PANNO ,
   ...
   IF utils.object_id('TEMPDB..tt_DuplicateNpaDt_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DuplicateNpaDt_2 ';
   END IF;
   DELETE FROM tt_DuplicateNpaDt_2;
   UTILS.IDENTITY_RESET('tt_DuplicateNpaDt_2');

   INSERT INTO tt_DuplicateNpaDt_2 ( 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableNpaCustomers_2 A
             JOIN tt_TempTableNpaCustomers_2 B   ON A.SourceSystemCustomerID = B.SourceSystemCustomerID
             AND A.SysNPA_Dt <> B.SysNPA_Dt
   	UNION 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableNpaCustomers_2 A
             JOIN tt_TempTableNpaCustomers_2 B   ON A.PANNO = B.PANNO
             AND A.SysNPA_Dt <> B.SysNPA_Dt
   ...
   INSERT INTO ControlScripts
     ...
     ( SELECT CH.UCIF_ID ,
       ...
       FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL CH
              ...
              AND DimAssetClass.EffectiveFromTimeKey <= v_Timekey
              AND DimAssetClass.EffectiveToTimeKey >= v_Timekey
              JOIN tt_DuplicateNpaDt_2    ON tt_DuplicateNpaDt_2.SourceSystemCustomerID = CH.SourceSystemCustomerID
              LEFT JOIN DimProduct    ON DimProduct.ProductAlt_Key = AH.ProductAlt_Key
              AND DimProduct.EffectiveFromTimeKey <= v_Timekey
              AND DimProduct.EffectiveToTimeKey >= v_Timekey
              LEFT JOIN DimCurrency    ON DimCurrency.CurrencyAlt_Key = AH.CurrencyAlt_Key
   ...
   DELETE ControlScripts
    ...
    WHERE  ExceptionCode = 7
             AND EffectiveFromTimeKey = ( SELECT timekey 
                                          FROM SysDataMatrix 
                                           WHERE  CurrentStatus = 'C' );
   IF utils.object_id('TEMPDB..tt_TempTableCustomersAsset_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableCustomersAsset_2 ';
   END IF;
   DELETE FROM tt_TempTableCustomersAsset_2;
   UTILS.IDENTITY_RESET('tt_TempTableCustomersAsset_2');

   INSERT INTO tt_TempTableCustomersAsset_2 ( 
   	SELECT UCIF_ID ,
           RefCustomerID ,
           SourceSystemCustomerID ,
           PANNO ,
   	...
   	GROUP BY UCIF_ID,RefCustomerID,SourceSystemCustomerID,PANNO,SysAssetClassAlt_Key,SysNPA_Dt );
   IF utils.object_id('TEMPDB..tt_DuplicateAssetClass_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DuplicateAssetClass_2 ';
   END IF;
   DELETE FROM tt_DuplicateAssetClass_2;
   UTILS.IDENTITY_RESET('tt_DuplicateAssetClass_2');

   INSERT INTO tt_DuplicateAssetClass_2 ( 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableCustomersAsset_2 A
             JOIN tt_TempTableCustomersAsset_2 B   ON A.SourceSystemCustomerID = B.SourceSystemCustomerID
             AND A.SysAssetClassAlt_Key <> B.SysAssetClassAlt_Key
   	UNION 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableCustomersAsset_2 A
             JOIN tt_TempTableCustomersAsset_2 B   ON A.PANNO = B.PANNO
             AND A.SysAssetClassAlt_Key <> B.SysAssetClassAlt_Key
   	 WHERE  A.PANNO IS NOT NULL
              AND B.PANNO IS NOT NULL );
   INSERT INTO ControlScripts
     ...
     ( SELECT CH.UCIF_ID ,
       ...
       FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL CH
              ...
              AND DimAssetClass.EffectiveFromTimeKey <= v_Timekey
              AND DimAssetClass.EffectiveToTimeKey >= v_Timekey
              JOIN tt_DuplicateAssetClass_2    ON tt_DuplicateAssetClass_2.SourceSystemCustomerID = CH.SourceSystemCustomerID
              LEFT JOIN DimProduct    ON DimProduct.ProductAlt_Key = AH.ProductAlt_Key
              AND DimProduct.EffectiveFromTimeKey <= v_Timekey
              AND DimProduct.EffectiveToTimeKey >= v_Timekey
              LEFT JOIN DimCurrency    ON DimCurrency.CurrencyAlt_Key = AH.CurrencyAlt_Key
   ...
   DELETE ControlScripts
    ...
    WHERE  ExceptionCode = 8
             AND EffectiveFromTimeKey = ( SELECT timekey 
                                          FROM SysDataMatrix 
                                           WHERE  CurrentStatus = 'C' );
   IF utils.object_id('TEMPDB..tt_TempTableFreshSillapge_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableFreshSillapge_2 ';
   END IF;
   DELETE FROM tt_TempTableFreshSillapge_2;
   UTILS.IDENTITY_RESET('tt_TempTableFreshSillapge_2');

   INSERT INTO tt_TempTableFreshSillapge_2 ( 
   	SELECT UCIF_ID ,
           RefCustomerID ,
           SourceSystemCustomerID ,
           CustomerAcID 
   	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL Ah
             ...
             AND B.EffectiveToTimeKey >= v_TIMEKEY
   	 WHERE  Ah.FlgDeg = 'Y' );
   IF utils.object_id('TEMPDB..tt_TempTableUpgrade_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableUpgrade_2 ';
   END IF;
   DELETE FROM tt_TempTableUpgrade_2;
   UTILS.IDENTITY_RESET('tt_TempTableUpgrade_2');

   INSERT INTO tt_TempTableUpgrade_2 ( 
   	SELECT UCIF_ID ,
           RefCustomerID ,
           SourceSystemCustomerID ,
           CustomerAcID 
   	  FROM PRO_RBL_MISDB_PROD.ACCOUNTCAL Ah
             ...
             AND B.EffectiveToTimeKey >= v_TIMEKEY
   	 WHERE  Ah.FlgUpg = 'U' );
   IF utils.object_id('TEMPDB..tt_TempTableFreshSillapge_2Upgrade') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableFreshSillapgeUp_2 ';
   END IF;
   DELETE FROM tt_TempTableFreshSillapgeUp_2;
   UTILS.IDENTITY_RESET('tt_TempTableFreshSillapgeUp_2');

   INSERT INTO tt_TempTableFreshSillapgeUp_2 ( 
   	SELECT A.CustomerAcID 
   	  FROM tt_TempTableFreshSillapge_2 A
             JOIN tt_TempTableUpgrade_2 B   ON A.CustomerAcID = B.CustomerAcID );
   INSERT INTO ControlScripts
     ( UCIF_ID, PANNO, CustomerAcID, RefCustomerID, SourceSystemCustomerID, CustomerName, SourceName, DPD_Max, POS, BalanceInCrncy, Balance, SysNPA_Dt, FinalAssetClassName, ExceptionCode, ExceptionDescription, EffectiveFromTimeKey, EffectiveToTimeKey )
     ( SELECT CH.UCIF_ID ,
              CH.PANNO ,
       ...
       FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL CH
              ...
              AND CH.EffectiveFromTimeKey <= v_Timekey
              AND CH.EffectiveToTimeKey >= v_Timekey
              JOIN tt_TempTableFreshSillapgeUp_2 SU   ON SU.CustomerAcID = AH.CustomerAcID
              JOIN DIMSOURCEDB DB   ON DB.SourceAlt_Key = AH.SourceAlt_Key
              AND DB.EffectiveFromTimeKey <= v_Timekey
              AND DB.EffectiveToTimeKey >= v_Timekey
              JOIN DimAssetClass DA   ON DA.AssetClassAlt_Key = AH.FinalAssetClassAlt_Key
   ...
   DELETE ControlScripts
    ...
    WHERE  ExceptionCode = 14
             AND EffectiveFromTimeKey = ( SELECT timekey 
                                          FROM SysDataMatrix 
                                           WHERE  CurrentStatus = 'C' );
   IF utils.object_id('TEMPDB..tt_TempTableAllCustomers_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TempTableAllCustomers_2 ';
   END IF;
   DELETE FROM tt_TempTableAllCustomers_2;
   UTILS.IDENTITY_RESET('tt_TempTableAllCustomers_2');

   INSERT INTO tt_TempTableAllCustomers_2 ( 
   	SELECT UCIF_ID ,
           RefCustomerID ,
           SourceSystemCustomerID ,
           PANNO 
   ...
   IF utils.object_id('TEMPDB..tt_DuplicatePan_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DuplicatePan_2 ';
   END IF;
   DELETE FROM tt_DuplicatePan_2;
   UTILS.IDENTITY_RESET('tt_DuplicatePan_2');

   INSERT INTO tt_DuplicatePan_2 ( 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableAllCustomers_2 A
             JOIN tt_TempTableAllCustomers_2 B   ON A.SourceSystemCustomerID = B.SourceSystemCustomerID
             AND A.PANNO <> B.PANNO
   	UNION 
   	SELECT A.SourceSystemCustomerID 
   	  FROM tt_TempTableAllCustomers_2 A
             JOIN tt_TempTableAllCustomers_2 B   ON A.UCIF_ID = B.UCIF_ID
             AND A.PANNO <> B.PANNO );
   INSERT INTO ControlScripts
     ( UCIF_ID, PANNO, CustomerAcID, RefCustomerID, SourceSystemCustomerID, CustomerName, SourceName, DPD_Max, POS, BalanceInCrncy, Balance, SysNPA_Dt, FinalAssetClassName, ExceptionCode, ExceptionDescription, EffectiveFromTimeKey, EffectiveToTimeKey )
     ( SELECT CH.UCIF_ID ,
       ...
       FROM PRO_RBL_MISDB_PROD.CUSTOMERCAL CH
              ...
              AND DA.EffectiveFromTimeKey <= v_Timekey
              AND DA.EffectiveToTimeKey >= v_Timekey
              JOIN tt_DuplicatePan_2    ON tt_DuplicatePan_2.SourceSystemCustomerID = CH.SourceSystemCustomerID
              JOIN DimAssetClass    ON DimAssetClass.AssetClassAlt_Key = AH.InitialAssetClassAlt_Key
              AND DimAssetClass.EffectiveFromTimeKey <= v_Timekey
              AND DimAssetClass.EffectiveToTimeKey >= v_Timekey
              LEFT JOIN DimProduct    ON DimProduct.ProductAlt_Key = AH.ProductAlt_Key
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATIONCONTROLSCRIPTS_04122023" TO "ADF_CDR_RBL_STGDB";
