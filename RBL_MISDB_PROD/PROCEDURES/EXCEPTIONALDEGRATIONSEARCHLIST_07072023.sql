--------------------------------------------------------
--  DDL for Procedure EXCEPTIONALDEGRATIONSEARCHLIST_07072023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" 
(
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         IF utils.object_id('TempDB..tt_Reminder_3') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Reminder_3 ';
         END IF;
         DELETE FROM tt_Reminder_3;
         UTILS.IDENTITY_RESET('tt_Reminder_3');

         INSERT INTO tt_Reminder_3 ( 
         	SELECT * 
         	  FROM ( SELECT B.ParameterAlt_Key FlagAlt_Key  ,
                 ...
                 A );
         --Select * from tt_Reminder_3
         IF utils.object_id('TempDB..tt_Reminder_3Report') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReminderReport_3 ';
         END IF;
         DELETE FROM tt_ReminderReport_3;
         INSERT INTO tt_ReminderReport_3
           ...
           ( SELECT A.Businesscolvalues1 FlagAlt_Key  ,
             ...
             FROM ( SELECT AccountID ,
                    ...
                    FROM ( SELECT UTILS.CONVERT_TO_CLOB('<M>' || REPLACE(FlagAlt_Key, ',', '</M><M>') || '</M>') Businesscolvalues1  ,
                                  AccountID 
                           FROM tt_Reminder_3  ) A
                            /*TODO:SQLDEV*/ CROSS APPLY Businesscolvalues1.nodes ('/M') AS Split(a) /*END:SQLDEV*/  ) A
              WHERE  A.Businesscolvalues1 <> ' ' );
         --Select * from tt_Reminder_3Report1
         IF utils.object_id('TempDB..tt_Reminder_3Report1') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_ReminderReport1_3 ';
         END IF;
         DELETE FROM tt_ReminderReport1_3;
         UTILS.IDENTITY_RESET('tt_ReminderReport1_3');

         INSERT INTO tt_ReminderReport1_3 ( 
         	SELECT A.* ,
                 B.ParameterName FlagName  
         	  FROM tt_ReminderReport_3 A
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF utils.object_id('TempDB..tt_temp_136') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_136 ';
               END IF;
               DELETE FROM tt_temp_136;
               UTILS.IDENTITY_RESET('tt_temp_136');

               INSERT INTO tt_temp_136 ( 
               	SELECT A.DegrationAlt_Key ,
               	  ...
               	  FROM ( SELECT A.DegrationAlt_Key ,
                         ...
                         FROM ExceptionFinalStatusType D
                                ...
                                AND A.EffectiveToTimeKey >= v_TimeKey
                                LEFT JOIN tt_ReminderReport1_3 S   ON S.AccountID = D.ACID
               	 ...
               	 WHERE  DimParameterName = 'DimYesNo'
                         ...
                         FROM RBL_MISDB_PROD.ExceptionalDegrationDetail_Mod A
                                LEFT JOIN tt_ReminderReport1_3 S   ON S.AccountID = A.AccountID
                                AND A.FlagAlt_Key = S.FlagAlt_Key
                                LEFT JOIN ( SELECT ParameterAlt_Key ,
                                                   ParameterName ,
                                                   'DimYesNo' Tablename  
                       ...
                       --LEFT JOIn tt_Reminder_3Report1 S ON S.AccountID=A.ACID
            ...
            -- IF NOT EXISTS (select 1 from tt_temp_136 where AccountID=@AccountID)
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_13616') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp16_105 ';
                  END IF;
                  DELETE FROM tt_temp16_105;
                  UTILS.IDENTITY_RESET('tt_temp16_105');

                  INSERT INTO tt_temp16_105 ( 
                  	SELECT A.DegrationAlt_Key ,
                          A.SourceName ,
                          A.SourceAlt_Key ,
                          A.AccountID ,
               ...
               ELSE
                  ...
                  BEGIN
                     IF utils.object_id('TemrefpDB..tt_temp_13620') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp20_70 ';
                     END IF;
                     DELETE FROM tt_temp20_70;
                     UTILS.IDENTITY_RESET('tt_temp20_70');

                     INSERT INTO tt_temp20_70 ( 
                     	SELECT A.DegrationAlt_Key ,
                             A.SourceName ,
                             A.SourceAlt_Key ,
                             A.AccountID ,
         ...
         BEGIN
            ...
            BEGIN
               DBMS_OUTPUT.PUT_LINE('AKSHAY');
               IF utils.object_id('TempDB..tt_temp_13630') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp30_3 ';
               END IF;
               DELETE FROM tt_temp30_3;
               UTILS.IDENTITY_RESET('tt_temp30_3');

               INSERT INTO tt_temp30_3 ( 
               	SELECT A.DegrationAlt_Key ,
                       A.SourceName ,
                       A.SourceAlt_Key ,
                       A.AccountID ,
            ...
            ELSE
               ...
               BEGIN
                  IF utils.object_id('TempDB..tt_temp_136161') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp161_6 ';
                  END IF;
                  DELETE FROM tt_temp161_6;
                  UTILS.IDENTITY_RESET('tt_temp161_6');

                  INSERT INTO tt_temp161_6 ( 
                  	SELECT A.DegrationAlt_Key ,
                          A.SourceName ,
                          A.SourceAlt_Key ,
                          A.AccountID ,
               ...
               ELSE
                  ...
                  BEGIN
                     IF utils.object_id('TemrefpDB..tt_temp_136201') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp201_6 ';
                     END IF;
                     DELETE FROM tt_temp201_6;
                     UTILS.IDENTITY_RESET('tt_temp201_6');

                     INSERT INTO tt_temp201_6 ( 
                     	SELECT A.DegrationAlt_Key ,
                             A.SourceName ,
                             A.SourceAlt_Key ,
                             A.AccountID ,
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONSEARCHLIST_07072023" TO "ADF_CDR_RBL_STGDB";
