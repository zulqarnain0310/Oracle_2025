--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" 
(
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF tt_AdvAcBasicDetail  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_AdvAcBasicDetail;
               UTILS.IDENTITY_RESET('tt_AdvAcBasicDetail');

               INSERT INTO tt_AdvAcBasicDetail ( 
               	SELECT * 
               	  FROM AdvAcBasicDetail 
               	 WHERE  EffectiveFromTimeKey <= v_Timekey
                          AND EffectiveToTimeKey >= v_Timekey );
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_CustomerBasicDetail  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_CustomerBasicDetail;
               UTILS.IDENTITY_RESET('tt_CustomerBasicDetail');

               INSERT INTO tt_CustomerBasicDetail ( 
               	SELECT * 
               	  FROM CustomerBasicDetail 
               	 WHERE  EffectiveFromTimeKey <= v_Timekey
                          AND EffectiveToTimeKey >= v_Timekey );
               --DROP TABLE IF EXISTS #AdvCustNPADetail
               --SELECT * INTO #AdvCustNPADetail FROM AdvCustNPADetail
               --WHERE EffectiveFromTimeKey<=@Timekey AND EffectiveToTimeKey>=@Timekey
               --PRINT 'TEMP COMPLETE'
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_CustomerCal_Hist_3  --SQLDEV: NOT RECOGNIZED
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'Account ID'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_AdvAcBasicDetail B   ON A.AccountID = B.CustomerACID 
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'CustomerID'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_CustomerBasicDetail B   ON A.CustomerID = B.CustomerId 
               ...
               ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'ucic'
                  END AS pos_3
               FROM A ,UploadAcceleratedProvision A
                      LEFT JOIN tt_CustomerBasicDetail B   ON A.UCIC = B.UCIF_ID 
               ...
               --						If @AccountId1<>''
               --						  BEGIN
               --						       Select @AccountId=CustomerACID from tt_AdvAcBasicDetail  where CustomerACID=@AccountId1
               ...
               --						       Select @CustomerId=CustomerId from tt_CustomerBasicDetail where CustomerId=@CustomerId1
               --							  IF @CustomerId =''
               --							       Begin
               --									   Print '@CustomerIdAf'
               --									   Print @CustomerId
               ...
               --						   If @UCIC1<>''
               --						  BEGIN
               --						       Select @UCIC=UCIF_ID from tt_CustomerBasicDetail where UCIF_ID=@UCIC1
               --							   IF @UCIC =''
               --							      Begin
               --									   Update UploadAcceleratedProvision
               ...
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp3_9  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_tmp3_9;
               UTILS.IDENTITY_RESET('tt_tmp3_9');

               INSERT INTO tt_tmp3_9 ( 
               	SELECT D.AccountID ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_AdvAcBasicDetail A   ON D.AccountID = A.CustomerACID
                         JOIN tt_CustomerCal_Hist_3 B   ON A.CustomerEntityId = B.CustomerEntityId --added by prashant

               	 WHERE  B.SysAssetClassAlt_Key = D.AssetClassification

                          --B.Cust_AssetClassAlt_Key=D.AssetClassification
               ...
               UPDATE UploadAcceleratedProvision V
                ...
                WHERE  NVL(AccountID, ' ') NOT IN ( SELECT AccountID 
                 ...
                 AND NVL(AccountID, ' ') <> ' ';
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp1_15  --SQLDEV: NOT RECOGNIZED
               DBMS_OUTPUT.PUT_LINE('Valid Customer/Account/UCIC START 2');
               DELETE FROM tt_tmp1_15;
               UTILS.IDENTITY_RESET('tt_tmp1_15');

               INSERT INTO tt_tmp1_15 ( 
               	SELECT D.CustomerID ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_CustomerBasicDetail_2 B   ON D.CustomerID = B.CustomerId
                         JOIN tt_AdvAcBasicDetail_2 A   ON A.CustomerEntityId = B.CustomerEntityId
                         JOIN tt_CustomerCal_Hist_3 C   ON A.CustomerEntityId = C.CustomerEntityId
               	 WHERE  C.SysAssetClassAlt_Key = D.AssetClassification
                          AND A.FlgSecured = CASE 
                                                  WHEN SecuredUnsecured = 'Secured' THEN 'S'
                                                  WHEN SecuredUnsecured = 'Unsecured' THEN 'U'   END
                          AND D.CustomerID <> ' '
               ...
               IF  --SQLDEV: NOT RECOGNIZED
               IF tt_tmp2_24  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_tmp2_24;
               UTILS.IDENTITY_RESET('tt_tmp2_24');

               INSERT INTO tt_tmp2_24 ( 
               	SELECT D.UCIC ,
                       COUNT(1)  CountRecord  
               	  FROM UploadAcceleratedProvision D
                         JOIN tt_CustomerBasicDetail_2 B   ON D.UCIC = B.UCIF_ID
                         JOIN tt_AdvAcBasicDetail_2 A   ON A.CustomerEntityId = B.CustomerEntityId
                         JOIN tt_CustomerCal_Hist_3 C   ON A.CustomerEntityId = C.CustomerEntityId
               	 WHERE  C.SysAssetClassAlt_Key = D.AssetClassification
                          AND A.FlgSecured = CASE 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_ACCELERATEDPROVISIONUPLOAD" TO "ADF_CDR_RBL_STGDB";
