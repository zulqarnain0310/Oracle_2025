...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TempDB..GTT_tmp2') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE GTT_tmp2 ';
         END IF;
         DELETE FROM GTT_tmp2;
         UTILS.IDENTITY_RESET('GTT_tmp2');

         INSERT INTO GTT_tmp2 SELECT * 
