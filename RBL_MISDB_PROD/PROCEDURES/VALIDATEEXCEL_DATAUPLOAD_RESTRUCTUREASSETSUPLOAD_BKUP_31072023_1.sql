--------------------------------------------------------
--  DDL for Procedure VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" /*--------------------------------------------------------------------------
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            ;
            IF utils.object_id('TEMPDB..tt_DUB2_40') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DUB2_40 ';
            END IF;
            DELETE FROM tt_DUB2_40;
            UTILS.IDENTITY_RESET('tt_DUB2_40');

            INSERT INTO tt_DUB2_40 SELECT * 
                 FROM ( SELECT * ,
            ...
            FROM V ,RestructureAssets V
                   JOIN tt_DUB2_40 D   ON D.AccountID = V.AccountID ) src
            ...
            /*
            IF EXISTS (SELECT 1 FROM RestructureAssets WHERE DisbursementDate LIKE  '__-__-____'  AND ISDATE(DisbursementDate)=1)
            BEGIN

            UPDATE RestructureAssets
            	SET  
                    ErrorMessage=CASE WHEN ISNULL(ErrorMessage,'')='' THEN 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’  Day part in DisbursementDate not between in 1 to 31'     
            						ELSE ErrorMessage+','+SPACE(1)+ 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’  Day part in DisbursementDate not between in 1 to 31'      END
            		,ErrorinColumn=CASE WHEN ISNULL(ErrorinColumn,'')='' THEN 'DisbursementDate' ELSE   ErrorinColumn +','+SPACE(1)+'DisbursementDate' END      
            		,Srnooferroneousrows=V.SrNo

             FROM RestructureAssets V  
              WHERE (left(DisbursementDate,2) not between 1 and 31 ) 



              UPDATE RestructureAssets
            	SET  
                    ErrorMessage=CASE WHEN ISNULL(ErrorMessage,'')='' THEN 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ Month part in DisbursementDate will be in 1 to 12'     
            						ELSE ErrorMessage+','+SPACE(1)+ 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ Month part in DisbursementDate will be in 1 to 12'      END
            		,ErrorinColumn=CASE WHEN ISNULL(ErrorinColumn,'')='' THEN 'DisbursementDate' ELSE   ErrorinColumn +','+SPACE(1)+'DisbursementDate' END      
            		,Srnooferroneousrows=V.SrNo


             FROM RestructureAssets V  
              WHERE (right(left(DisbursementDate,5),2) not between 1 and 12 )
             ...
             FROM RestructureAssets V  
              WHERE (Case When ISDATE(DisbursementDate)=1 
                         Then Case When Cast(DisbursementDate as date)>Cast(GETDATE() as Date) 
            			           Then 1 
                              Else 0 END END) =1
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                   ...
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ in InvocationDate'
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DisbursementDate'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'DisbursementDate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ 
                                         		Day in InvocationDate not between 1 and 31'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ in InvocationDate'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ in InvocationDate'
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DisbursementDate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'DateofConversionintoEquity in to Equity Format is wrong. Please insert in proper format DD-MM-YYYY  Day part in DateofConversionintoEquity will be in 1 to 31'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'DateofConversionintoEquity in to Equity Format is wrong. Please insert in proper format DD-MM-YYYY Day part in DateofConversionintoEquity will be in 1 to 31 '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DateofConversionintoEquity'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'DateofConversionintoEquity'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'PrinRpymntStartDate Format is wrong. Please insert in proper format DD-MM-YYYY  Day part in PrinRpymntStartDate will be in 1 to 31 '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'PrinRpymntStartDate Format is wrong. Please insert in proper format DD-MM-YYYY. Please check and Upload again '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'PrinRpymntStartDate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'PrinRpymntStartDate Format is wrong. Please insert in proper format DD-MM-YYYY  Month part in PrinRpymntStartDate will be in 1 to 12 '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'PrinRpymntStartDate Format is wrong. Please insert in proper format DD-MM-YYYY. Please check and Upload again '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'PrinRpymntStartDate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’ Day part in InttRpymntStartDate will be in 1 to 31'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid date format. Please enter the date in format ‘dd-mm-yyyy’'
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'InttRpymntStartDate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'NPADate Format is wrong. Please insert Date not between 1 to 31 in NPADate column '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'NPADate Format is wrong. Please insert Date not between 1 to 31 in NPADate column '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'NPADate'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'NPADate'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'NPADate Format is wrong. Please insert month not between 1 to 12 in NPADate column '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'NPADate Format is wrong. Please insert Date not between 1 to 12 in NPADate column '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'NPADate'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'NPADate'
            ...
            BEGIN
               SELECT 1 INTO v_temp
                ...
                WHERE EXISTS ( SELECT 1 
                               FROM RestructureAssets 
                                WHERE  utils.isdate(DisbursementDate) = 1
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Date of Restructuring Format is wrong. Date of DateofRestructuring in not between 1 to 31  '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Date of Restructuring Format is wrong. Date of DateofRestructuring in not between 1 to 31 '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DateofRestructuring'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'DateofRestructuring'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Date of Restructuring Format is wrong. Month of DateofRestructuring in not between 1 to 31  '
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Date of Restructuring Format is wrong. Month of DateofRestructuring in not between 1 to 12 '
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DateofRestructuring'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'DateofRestructuring'
            ...
            */
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid date format. Day part in DateofSigningICA will be in 1 to 31’'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid date format. Please enter the date in format ‘DD-MM-YYYY’'
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DateofSigningICA'
            ...
            UPDATE RestructureAssets V
               SET V.ErrorMessage = CASE 
                                         WHEN NVL(ErrorMessage, ' ') = ' ' THEN 'Invalid date format. Month part in DateofSigningICA will be in 1 to 12'
                   ELSE ErrorMessage || ',' || LPAD(' ', 1, ' ') || 'Invalid date format. Month part in DateofSigningICA will be in 1 to 12'
                      END,
                   V.ErrorinColumn = CASE 
                                          WHEN NVL(ErrorinColumn, ' ') = ' ' THEN 'DateofSigningICA'
                   ELSE ErrorinColumn || ',' || LPAD(' ', 1, ' ') || 'DateofSigningICA'
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."VALIDATEEXCEL_DATAUPLOAD_RESTRUCTUREASSETSUPLOAD_BKUP_31072023_1" TO "ADF_CDR_RBL_STGDB";
