--------------------------------------------------------
--  DDL for Procedure ADHOC_MOC_REPORT_02052024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" --'01/01/2021','15/04/2023'
...
BEGIN
   ...
   IF utils.object_id('TEMPDB..tt_TEMP1_2') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TEMP1_2 ';
   END IF;
   --select Timekey,date,ROW_NUMBER() over (order by Timekey) rn INTO tt_TEMP1_2 from Automate_Advances
   --where date >=@FromDate and date <=@ToDate
   --order by 1
   DELETE FROM tt_TEMP1_2;
   UTILS.IDENTITY_RESET('tt_TEMP1_2');

   INSERT INTO tt_TEMP1_2 SELECT Timekey ,
                                 date_ ,
       ...
       WHERE  UTILS.CONVERT_TO_VARCHAR2(b.DateCreated,200) >= v_FromDate
        ...
        ORDER BY 1;
   IF utils.object_id('TEMPDB..tt_temp_5') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_temp_5 ';
   END IF;
   ...
   LOOP
      ...
      DECLARE
         v_Process_Date VARCHAR2(200) := ( SELECT date_ 
           FROM tt_TEMP1_2 
          WHERE  rn = v_counter );
      ...
      BEGIN
         ...
         IF ( utils.object_id('TEMPDB..tt_DimAcBuSegment_2') IS NOT NULL ) THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DimAcBuSegment_2 ';
         END IF;
         DELETE FROM tt_DimAcBuSegment_2;
         UTILS.IDENTITY_RESET('tt_DimAcBuSegment_2');

         INSERT INTO tt_DimAcBuSegment_2 SELECT DENSE_RANK() OVER ( PARTITION BY AcBuRevisedSegmentCode ORDER BY AcBuSegmentCode  ) RN  ,
                                                AcBuSegmentCode ,
         ...
         INSERT INTO tt_temp_5
           SELECT 
                  ...
                  DA.AssetClassName InitalAssetClassName  ,
                  ----Edit--------  
                  ...
                  DA1.AssetClassName FinalAssetClassName  ,
                  A.NPA_Reason ,
                  A.FlgDeg ,
                  A.FlgUpg ,
             ...
             FROM PRO_RBL_MISDB_PROD.AccountCal_Hist a
                    ...
                    LEFT JOIN tt_DimAcBuSegment_2 DABS   ON A.ActSegmentCode = DABS.AcBuSegmentCode
                  --AND DABS.RN=1  
   ...
   OPEN  v_cursor FOR
      SELECT Moc_Status ,
             ...
             CoverGovGur ,
             CASE 
                  WHEN SUBSTR(DegReason, 0, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(DegReason, ',', ' & '), -LENGTH(DegReason) - 1, LENGTH(DegReason) - 1))
                  WHEN SUBSTR(DegReason, -1, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(DegReason, ',', ' & '), 0, LENGTH(DegReason) - 1))
             ...
             FinalAssetClassName ,
             CASE 
                  WHEN SUBSTR(NPA_Reason, 0, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(NPA_Reason, ',', ' & '), -LENGTH(NPA_Reason) - 1, LENGTH(NPA_Reason) - 1))
                  WHEN SUBSTR(NPA_Reason, -1, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(NPA_Reason, ',', ' & '), 0, LENGTH(NPA_Reason) - 1))
             ...
             SMA_Class ,
             CASE 
                  WHEN SUBSTR(SMA_Reason, 0, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(SMA_Reason, ',', ' & '), -LENGTH(SMA_Reason) - 1, LENGTH(SMA_Reason) - 1))
                  WHEN SUBSTR(SMA_Reason, -1, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(SMA_Reason, ',', ' & '), 0, LENGTH(SMA_Reason) - 1))
             ...
             PNPA_DATE ,
             CASE 
                  WHEN SUBSTR(PNPA_Reason, 0, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(PNPA_Reason, ',', ' & '), -LENGTH(PNPA_Reason) - 1, LENGTH(PNPA_Reason) - 1))
                  WHEN SUBSTR(PNPA_Reason, -1, 1) = ', ' THEN TRIM(SUBSTR(REPLACE(PNPA_Reason, ',', ' & '), 0, LENGTH(PNPA_Reason) - 1))
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ADHOC_MOC_REPORT_02052024" TO "ADF_CDR_RBL_STGDB";
