--------------------------------------------------------
--  DDL for Procedure SP_DGU_SMA_REPORT_07072023
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" 
AS
...
BEGIN
   ...
   --Drop table if exists   tt_DPD_42 
   IF utils.object_id('TEMPDB..tt_DPD_42') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DPD_42 ';
   END IF;
   DELETE FROM tt_DPD_42;
   UTILS.IDENTITY_RESET('tt_DPD_42');

   INSERT INTO tt_DPD_42 ( 
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_42 
   ...
   */
   ...
   IF tt_DPD_42_UCIF_ID  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_UCIF_ID_9;
   UTILS.IDENTITY_RESET('tt_DPD_UCIF_ID_9');

   INSERT INTO tt_DPD_UCIF_ID_9 ( 
   	SELECT UCIF_ID ,
   ...
   FROM A ,tt_DPD_42 A
          JOIN tt_DPD_UCIF_ID_9 B   ON A.UCIF_ID = B.UCIF_ID ) src
   ON ( A.ROWID = src.row_id )
   WHEN MATCHED THEN UPDATE SET A.DPD_UCIF_ID = src.DPD_UCIF_ID;
   EXECUTE IMMEDIATE ' TRUNCATE TABLE DGU_SMA_Report ';
   INSERT INTO DGU_SMA_Report
     SELECT v_PROCESSDATE CurrentProcessingDate  ,
       ...
       FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
              ...
              JOIN tt_DPD_42 DPD   ON DPD.AccountEntityID = A.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_DGU_SMA_REPORT_07072023" TO "ADF_CDR_RBL_STGDB";
