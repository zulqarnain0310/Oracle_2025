--------------------------------------------------------
--  DDL for Procedure MOC_VERIFICATION_REPORT_RDM_02052024
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" 
AS
...
BEGIN
   ...
   IF ( utils.object_id('TEMPDB..tt_MOC_DATA_51') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_MOC_DATA_51 ';
   END IF;
   DELETE FROM tt_MOC_DATA_51;
   UTILS.IDENTITY_RESET('tt_MOC_DATA_51');

   INSERT INTO tt_MOC_DATA_51 ( 
   	SELECT UcifEntityID 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_UcifEntityID
      ON tt_MOC_DATA_51 ( UcifEntityID)';
   IF ( utils.object_id('TEMPDB..tt_AccountCal_Hist_14') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountCal_Hist_14 ';
   END IF;
   DELETE FROM tt_AccountCal_Hist_14;
   UTILS.IDENTITY_RESET('tt_AccountCal_Hist_14');

   INSERT INTO tt_AccountCal_Hist_14 ( 
   	SELECT A.UcifEntityID ,
   	  ...
   	  FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
             JOIN tt_MOC_DATA_51 B   ON A.UcifEntityID = B.UcifEntityID
   	 WHERE  EffectiveFromTimeKey <= v_TimeKey
              AND EffectiveToTimeKey >= v_TimeKey );
   --select * from tt_AccountCal_Hist_14 where CustomerAcID='809002712795'
   --select * from tt_DimAcBuSegment_6 where AcBuSegmentcode='1326'
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID
      ON tt_AccountCal_Hist_14 ( CustomerACID)';
   -------------------------------------------------  
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID
      ON tt_CustomerCal_HIST_2 ( CustomerEntityID)';
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_AccountLevelMOC_Mod_2') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountLevelMOC_Mod_2 ';
   END IF;
   DELETE FROM tt_AccountLevelMOC_Mod_2;
   UTILS.IDENTITY_RESET('tt_AccountLevelMOC_Mod_2');

   INSERT INTO tt_AccountLevelMOC_Mod_2 ( 
   	SELECT AccountID ,
           ChangeField ,
           EffectiveFromTimekey ,
           EffectiveToTimekey ,
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_AccountID
      ON tt_AccountLevelMOC_Mod_2 ( AccountID)';
   --select * from tt_AccountLevelMOC_Mod_2
   ---------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CustomerLevelMOC_Mod_2') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerLevelMOC_Mod_2 ';
   END IF;
   DELETE FROM tt_CustomerLevelMOC_Mod_2;
   UTILS.IDENTITY_RESET('tt_CustomerLevelMOC_Mod_2');

   INSERT INTO tt_CustomerLevelMOC_Mod_2 ( 
   	SELECT Entity_Key ,
           CustomerEntityID ,
           ChangeField ,
           EffectiveFromTimekey ,
   ...
   --select * from tt_CustomerLevelMOC_Mod_2
   --select * from CustomerLevelMOC_Mod where CustomerID='2074381'
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID2
      ON tt_CustomerLevelMOC_Mod_2 ( CustomerEntityID)';
   --select * from tt_CustomerLevelMOC_Mod_2 
   --select * from CustomerLevelMOC_Mod where CustomerID='0215012763000004599'
   --MOCDate='2022-06-30'
   -------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_AccountCal_28') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountCal_28 ';
   END IF;
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerACID1
      ON tt_AccountCal_28 ( CustomerACID)';
   --------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_CustomerCal_17') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustomerCal_17 ';
   END IF;
   DELETE FROM tt_CustomerCal_17;
   UTILS.IDENTITY_RESET('tt_CustomerCal_17');

   INSERT INTO tt_CustomerCal_17 ( 
   ...
   EXECUTE IMMEDIATE ' CREATE INDEX INX_CustomerEntityID1
      ON tt_CustomerCal_17 ( CustomerEntityID)';
   ------------------------------------------------------  
   IF ( utils.object_id('TEMPDB..tt_DimAcBuSegment_6') IS NOT NULL ) THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DimAcBuSegment_6 ';
   END IF;
   DELETE FROM tt_DimAcBuSegment_6;
   UTILS.IDENTITY_RESET('tt_DimAcBuSegment_6');

   INSERT INTO tt_DimAcBuSegment_6 SELECT DENSE_RANK() OVER ( PARTITION BY AcBuRevisedSegmentCode ORDER BY AcBuSegmentCode  ) RN  ,
                                          AcBuSegmentCode ,
       ...
       WHERE  EffectiveFromTimeKey <= v_TimeKey
                AND EffectiveToTimeKey >= v_TimeKey;
   ---------------------PreMOC_DATA----------------------  
   IF utils.object_id('Tempdb..tt_Final_14') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Final_14 ';
   END IF;
   --DECLARE  @TimeKey AS INT=26479
   DELETE FROM tt_Final_14;
   UTILS.IDENTITY_RESET('tt_Final_14');

   INSERT INTO tt_Final_14 SELECT ROW_NUMBER() OVER ( ORDER BY A.UcifEntityId  ) SrNo  ,
                                  'Post Moc' Moc_Status  ,
                                  ...
                                  --  --WHEN SourceName='VisionPlus' THEN 'Credit Card'
                                  --    WHEN SourceName='VisionPlus' and c.ProductCode in ('777','780') THEN 'Retail'
                                  --  WHEN SourceName='VisionPlus' and c.ProductCode not in ('777','780') THEN 'Credit Card'
                                  --else DABS.AcBuSegmentDescription end                        AS AcBuSegmentDescription
                                  clm.AuthorisationStatus 
        FROM tt_AccountCal_Hist_14 A
               JOIN DimProduct C   ON C.ProductAlt_Key = A.ProductAlt_Key
               AND C.EffectiveFromTimeKey <= v_TimeKey
               AND C.EffectiveToTimeKey >= v_TimeKey
               LEFT JOIN tt_AccountLevelMOC_Mod_2 ALM   ON ALM.AccountId = A.CustomerAcID
               LEFT JOIN tt_CustomerCal_HIST_2 F   ON F.CustomerEntityId = A.CustomerEntityId
               LEFT JOIN tt_CustomerLevelMOC_Mod_2 CLM   ON F.CustomerEntityId = CLM.CustomerEntityId
               ...
               LEFT JOIN tt_DimAcBuSegment_6 DABS   ON A.ActSegmentCode = DABS.AcBuSegmentCode
      ...
      SELECT ROW_NUMBER() OVER ( ORDER BY A.UcifEntityId  ) SrNo  ,
        ...
        FROM tt_AccountCal_28 A
               ...
               AND C.EffectiveToTimeKey >= v_TimeKey
               LEFT JOIN tt_AccountLevelMOC_Mod_2 ALM   ON ALM.AccountId = A.CustomerAcID
               LEFT JOIN tt_CustomerCal_17 F   ON F.CustomerEntityId = A.CustomerEntityId
               LEFT JOIN tt_CustomerLevelMOC_Mod_2 CLM   ON F.CustomerEntityId = CLM.CustomerEntityId
               LEFT JOIN MOC_ChangeDetails MOC   ON MOC.CustomerEntityId = CLM.CustomerEntityId
               AND MOC.EffectiveFromTimeKey <= v_TimeKey
               AND MOC.EffectiveToTimeKey >= v_TimeKey
      ...
      WHERE  A.CustomerAcID IN ( SELECT CustomerAcID 
                                 FROM tt_AccountCal_Hist_14 A
                                        LEFT JOIN tt_CustomerCal_HIST_2 C   ON C.CustomerEntityId = A.CustomerEntityId
                                  WHERE  ( A.FlgMoc = 'Y'
                                           OR C.FlgMoc = 'Y' ) )
   ...
   OPEN  v_cursor FOR
      SELECT SrNo ,
        ...
        ORDER BY CustomerAcID,
                 CustomerID,
                 Moc_Status DESC ;
      DBMS_SQL.RETURN_RESULT(v_cursor);--DROP TABLE tt_AccountCal_Hist_14,tt_CustomerCal_17_Hist,tt_AccountLevelMOC_Mod_2,tt_CustomerLevelMOC_Mod_2,tt_AccountCal_28,tt_CustomerCal_17,tt_DimAcBuSegment_6  
   --select * from tt_DimAcBuSegment_6 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."MOC_VERIFICATION_REPORT_RDM_02052024" TO "ADF_CDR_RBL_STGDB";
