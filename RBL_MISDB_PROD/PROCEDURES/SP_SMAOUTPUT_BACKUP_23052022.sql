--------------------------------------------------------
--  DDL for Procedure SP_SMAOUTPUT_BACKUP_23052022
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" 
AS
   v_TIMEKEY NUMBER(10,0) := '26419';
...
BEGIN
   ...
   --Drop table if exists   tt_DPD_52 
   IF utils.object_id('TEMPDB..tt_DPD_52') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_DPD_52 ';
   END IF;
   DELETE FROM tt_DPD_52;
   UTILS.IDENTITY_RESET('tt_DPD_52');

   INSERT INTO tt_DPD_52 ( 
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_DPD_52 
   ...
   IF tt_DPD_52_UCIF_ID  --SQLDEV: NOT RECOGNIZED
   DELETE FROM tt_DPD_UCIF_ID_18;
   UTILS.IDENTITY_RESET('tt_DPD_UCIF_ID_18');

   INSERT INTO tt_DPD_UCIF_ID_18 ( 
   	SELECT UCIF_ID ,
   ...
   FROM A ,tt_DPD_52 A
          JOIN tt_DPD_UCIF_ID_18 B   ON A.UCIF_ID = B.UCIF_ID ) src
   ON ( A.ROWID = src.row_id )
   ...
   OPEN  v_cursor FOR
      SELECT v_PROCESSDATE CurrentProcessingDate  ,
        ...
        FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
               ...
               JOIN tt_DPD_52 DPD   ON DPD.AccountEntityID = A.AccountEntityID
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SP_SMAOUTPUT_BACKUP_23052022" TO "ADF_CDR_RBL_STGDB";
