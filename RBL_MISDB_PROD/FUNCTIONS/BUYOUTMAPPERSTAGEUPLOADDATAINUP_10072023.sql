--------------------------------------------------------
--  DDL for Function BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" 
(
...
BEGIN
   ...
   BEGIN
      ...
      IF utils.object_id('TEMPDB..tt_UserIdStatus_3') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserIdStatus_3 ';
      END IF;
      DELETE FROM tt_UserIdStatus_3;
      UTILS.IDENTITY_RESET('tt_UserIdStatus_3');

      INSERT INTO tt_UserIdStatus_3 ( 
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  IF utils.object_id('TempDB..tt_Buyout_Upload_3') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Buyout_Upload_3 ';
                  END IF;
                  DELETE FROM tt_Buyout_Upload_3;
                  INSERT INTO tt_Buyout_Upload_3
                  ...
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_Buyout_Upload_3 B   ON A.CtrlName = B.FieldName 
                  ...
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_33') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_33 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_33;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_33');

                  INSERT INTO tt_NEWTRANCHE_33 SELECT * 
                       FROM ( SELECT ss.AccountNoinRBLHostSystem ,
                                     ss.AccountNoofSeller ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_Buyout_Upload_3 US
                  ...
                  FROM A ,RBL_MISDB_PROD.BuyoutMapperUpload_Mod A
                         JOIN tt_NEWTRANCHE_33 B   ON A.AccountNoinRBLHostSystem = B.AccountNoinRBLHostSystem
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_10072023" TO "ADF_CDR_RBL_STGDB";
