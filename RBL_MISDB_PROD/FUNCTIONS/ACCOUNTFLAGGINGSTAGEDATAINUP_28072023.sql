--------------------------------------------------------
--  DDL for Function ACCOUNTFLAGGINGSTAGEDATAINUP_28072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" 
(
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF utils.object_id('TempDB..tt_Flags_9') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags_9 ';
               END IF;
               DELETE FROM tt_Flags_9;
               UTILS.IDENTITY_RESET('tt_Flags_9');

               INSERT INTO tt_Flags_9 ( 
               	SELECT A.ACID ,
               ...
               FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                      JOIN tt_Flags_9 B   ON A.RefSystemAcId = B.ACID 
               ...
               END IF;
               -----------------------------------------------------------------------END---------------------------------------------------------------------------------
               IF utils.object_id('TempDB..tt_Flags_91') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags1_9 ';
               END IF;
               DELETE FROM tt_Flags1_9;
               UTILS.IDENTITY_RESET('tt_Flags1_9');

               INSERT INTO tt_Flags1_9 ( 
               	SELECT A.ACID ,
                       B.SplCatShortNameEnum 
               	  FROM AccountFlaggingDetails_Mod A
                         JOIN ( SELECT B.ParameterAlt_Key ,
               	 ...
               	 WHERE  A.UploadId = v_UniqueUploadID
                          AND A.ACTION = 'N' );
               IF utils.object_id('TempDB..tt_Temp_15') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp_15 ';
               END IF;
               DELETE FROM tt_Temp_15;
               UTILS.IDENTITY_RESET('tt_Temp_15');

               INSERT INTO tt_Temp_15 ( 
               	SELECT A.AccountentityID ,
                       A.SplFlag 
               	  FROM RBL_MISDB_PROD.AdvAcOtherDetail A
                         JOIN tt_Flags1_9 B   ON A.RefSystemAcId = B.ACID

               	--where A.EffectiveToTimeKey=49999 
               	WHERE  A.EFFECTIVEFROMTIMEKEY <= v_TimeKey
                         AND A.EFFECTIVETOTIMEKEY >= v_TimeKey );
               --Select * from tt_Temp_15
               IF utils.object_id('TEMPDB..tt_SplitValue_9') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SplitValue_9 ';
               END IF;
               DELETE FROM tt_SplitValue_9;
               UTILS.IDENTITY_RESET('tt_SplitValue_9');

               INSERT INTO tt_SplitValue_9 ( 
               ...
               --Select * from tt_SplitValue_9 
               DELETE tt_SplitValue_9

                WHERE  Businesscolvalues1 IN ( SELECT DISTINCT SplCatShortNameEnum 
                                               FROM tt_Flags1_9  )
               ;
               IF utils.object_id('TEMPDB..tt_NEWTRANCHE_25') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_25 ';
               END IF;
               DELETE FROM tt_NEWTRANCHE_25;
               UTILS.IDENTITY_RESET('tt_NEWTRANCHE_25');

               INSERT INTO tt_NEWTRANCHE_25 SELECT * 
                    FROM ( SELECT ss.AccountEntityID ,
                                  utils.stuff(( SELECT ',' || US.BUSINESSCOLVALUES1 
                                                FROM tt_SplitValue_9 US
                                                 WHERE  US.AccountentityID = ss.AccountEntityID ), 1, 1, ' ') REPORTIDSLIST  
                           FROM tt_Temp_15 SS
                             GROUP BY ss.AccountEntityID ) B
                    ORDER BY 1;
               --Select * from tt_NEWTRANCHE_25
               --SELECT * 
               MERGE INTO A 
               USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
               FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                      JOIN tt_NEWTRANCHE_25 B   ON A.AccountentityID = B.AccountentityID 
                WHERE A.EFFECTIVEFROMTIMEKEY <= v_TimeKey
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCOUNTFLAGGINGSTAGEDATAINUP_28072023" TO "ADF_CDR_RBL_STGDB";
