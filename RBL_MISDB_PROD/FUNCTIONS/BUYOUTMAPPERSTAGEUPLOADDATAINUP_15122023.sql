--------------------------------------------------------
--  DDL for Function BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" 
(
...
BEGIN
   ...
   BEGIN
      ...
      IF utils.object_id('TEMPDB..tt_UserIdStatus_4') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserIdStatus_4 ';
      END IF;
      DELETE FROM tt_UserIdStatus_4;
      UTILS.IDENTITY_RESET('tt_UserIdStatus_4');

      INSERT INTO tt_UserIdStatus_4 ( 
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  IF utils.object_id('TempDB..tt_Buyout_Upload_4') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Buyout_Upload_4 ';
                  END IF;
                  DELETE FROM tt_Buyout_Upload_4;
                  INSERT INTO tt_Buyout_Upload_4
                  ...
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_Buyout_Upload_4 B   ON A.CtrlName = B.FieldName 
                  ...
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_34') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_34 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_34;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_34');

                  INSERT INTO tt_NEWTRANCHE_34 SELECT * 
                       FROM ( SELECT ss.AccountNoinRBLHostSystem ,
                                     ss.AccountNoofSeller ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_Buyout_Upload_4 US
                  ...
                  FROM A ,RBL_MISDB_PROD.BuyoutMapperUpload_Mod A
                         JOIN tt_NEWTRANCHE_34 B   ON A.AccountNoinRBLHostSystem = B.AccountNoinRBLHostSystem
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_15122023" TO "ADF_CDR_RBL_STGDB";
