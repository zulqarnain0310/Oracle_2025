--------------------------------------------------------
--  DDL for Function USERUPLOADDATAINUP_06072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" 
--USE YES_MISDB
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               IF utils.object_id('TEMPDB..tt_UserMasterUploadData_3') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserMasterUploadData_3 ';
               END IF;
               --Select * from DimUserInfo
               DELETE FROM tt_UserMasterUploadData_3;
               UTILS.IDENTITY_RESET('tt_UserMasterUploadData_3');

               INSERT INTO tt_UserMasterUploadData_3 ( 
               ...
               , UserExtensionNumbar, IsChecker, IsChecker2, IsActive, sheetname, ActionAU )
                 ( SELECT SrNo ,
                          ...
                          v_FilePathUpload ,
                          Perform 
                   FROM tt_UserMasterUploadData_3  );
               BEGIN
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."USERUPLOADDATAINUP_06072023" TO "ADF_CDR_RBL_STGDB";
