--------------------------------------------------------
--  DDL for Function ACBUSEGMENTINUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACBUSEGMENTINUP" 
--exec [ACBUSegmentInUp] @SourceAlt_Key=N'1',@ACBUSegmentCode=N'abcd1234',@ACBUSegmentDescription=N'12134',@AcBuRevisedSegmentCode = 'SUdESH123',@EffectiveFromTimeKey = 25999,@EffectiveToTimeKey = 49999,@OperationFlag=1,@AuthMode = 'Y'
...
BEGIN
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_final_6 
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM TEMP ,tt_final_6 TEMP
                   JOIN ( SELECT tt_final_6.SourceAlt_Key ,
                                 (v_AcBuSegmentAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
              FROM DUAL  )  )) AcBuSegmentAlt_Key  
                          FROM tt_final_6 
                           WHERE  tt_final_6.AcBuSegmentAlt_Key = 0
                                    OR tt_final_6.AcBuSegmentAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
      ...
      BEGIN
                           ...
                           ELSE
                              ...
                              BEGIN
                                 ...
                                 BEGIN
                                    ...
                                    BEGIN
                                       DBMS_OUTPUT.PUT_LINE('Authorise1');
                                 ...
                                 BEGIN
                                    ...
                                    BEGIN
                                       ...
                                       BEGIN
                                          ...
                                          --ChangeFields=@ACBUSegment_ChangeFields
                                          WHERE  ( EffectiveFromTimeKey <= v_TimeKey
                                            AND EffectiveToTimeKey >= v_TimeKey )
                                    ...
                                    --										from DimAcBuSegment_Mod where AcBuSegmentAlt_Key =@AcBuSegmentAlt_Key
         ...
         BEGIN
            ...
            SELECT utils.stuff(( SELECT DISTINCT ',' || ChangeFields 
              ...
              INTO v_Parameter1
              FROM DUAL ;
            IF utils.object_id('tt_AA_2') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AA_2 ';
            END IF;
            DELETE FROM tt_AA_2;
            UTILS.IDENTITY_RESET('tt_AA_2');
            ...
            FROM A ,DimAcBuSegment_Mod A 
             WHERE ( EffectiveFromTimeKey <= v_tiMEKEY
              AND EffectiveToTimeKey >= v_tiMEKEY )
              AND AcBuSegmentAlt_Key = v_AcBuSegmentAlt_Key) src
            ...
            --	SET @Parameter1 = (select STUFF((	SELECT Distinct ',' +ChangeFields 
            --											from DimAcBuSegment where AcBuSegmentCode = @ACBUSegmentCode
            ...
            -- ) A
            -- )XX
            -- SET @FinalParameter1 = (select STUFF((	SELECT Distinct ',' + Value from tt_AA_2  for XML PATH('')),1,1,''))
            --							UPDATE		A
            --							set			a.ChangeFields = @FinalParameter1							 																																	
            --							from		DimAcBuSegment_Mod   A
            --							WHERE		(EffectiveFromTimeKey<=@tiMEKEY AND EffectiveToTimeKey>=@tiMEKEY) 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACBUSEGMENTINUP" TO "ADF_CDR_RBL_STGDB";
