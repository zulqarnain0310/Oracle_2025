--------------------------------------------------------
--  DDL for Function TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" 
(
...
BEGIN
   ...
   BEGIN
      ...
      END;
      END IF;
      IF utils.object_id('Tempdb..tt_Temp_140') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp_140 ';
      END IF;
      IF utils.object_id('Tempdb..tt_final_79') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_79 ';
      END IF;
      DELETE FROM tt_Temp_140;
      INSERT INTO tt_Temp_140
        VALUES ( v_Transaction_Sub_Type_Code, v_SourceAlt_Key, v_Transaction_Sub_Type_Description );
      DELETE FROM tt_final_79;
      UTILS.IDENTITY_RESET('tt_final_79');

      INSERT INTO tt_final_79 ( 
      ...
      EXECUTE IMMEDIATE ' ALTER TABLE tt_final_79 
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               FROM TEMP ,tt_final_79 TEMP
                      JOIN ( SELECT tt_final_79.SourceAlt_Key ,
                                    (v_Transaction_Sub_TypeAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                                                      FROM DUAL  )  )) Transaction_Sub_TypeAlt_Key  
                             FROM tt_final_79 
                              WHERE  tt_final_79.Transaction_Sub_TypeAlt_Key = 0
                                       OR tt_final_79.Transaction_Sub_TypeAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
      ...
      BEGIN
         ...
         FROM TEMP ,tt_final_79 TEMP ) src
         ON ( TEMP.ROWID = src.row_id )
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               -----------------------------------------------------------
               --	IF Object_id('Tempdb..tt_Temp_140') Is Not Null
               --Drop Table tt_Temp_140
               --	IF Object_id('Tempdb..tt_final_79') Is Not Null
               --Drop Table tt_final_79
               --Create table tt_Temp_140
               --(Transaction_Sub_Type_Code Varchar(5)
               --,SourceAlt_Key Varchar(20)
               --,Transaction_Sub_Type_Description	varchar(50)
               --)
               --Insert into tt_Temp_140 values(@Transaction_Sub_Type_Code,@SourceAlt_Key,@Transaction_Sub_Type_Description)
               --Select A.Businesscolvalues1 as SourceAlt_Key,Transaction_Sub_Type_Code,Transaction_Sub_Type_Description  into tt_final_79 From (
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."TRANSACTIONSUBTYPEMASTERINUP_PROD_24012024" TO "ADF_CDR_RBL_STGDB";
