--------------------------------------------------------
--  DDL for Function SOURCESYSTEMSMASTERINUP_PROD
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" 
(
      ...
      BEGIN
                                 ...
                                 BEGIN
                                    ...
                                    BEGIN
                                       INSERT INTO DIMSOURCEDB
                                         ( SourceAlt_Key, SourceName, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, RecordStatus, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved, StartDate, EndDate, Active_Inactive, Reason )
         ...
         BEGIN
            INSERT INTO DimSourceDB_Mod
              ( SourceAlt_Key, SourceName, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved, StartDate, EndDate, Active_Inactive, Reason )
            ...
            ELSE NULL
               END, CASE 
                         WHEN v_AuthMode = 'Y' THEN v_DateApproved
            ELSE NULL
               END, v_StartDate, v_EndDate, v_Active_Inactive, v_Reason );
            IF v_OperationFlag = 1
              AND v_AUTHMODE = 'Y' THEN
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SOURCESYSTEMSMASTERINUP_PROD" TO "ADF_CDR_RBL_STGDB";
