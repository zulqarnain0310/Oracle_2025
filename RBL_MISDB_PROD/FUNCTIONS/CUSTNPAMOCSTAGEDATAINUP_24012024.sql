--------------------------------------------------------
--  DDL for Function CUSTNPAMOCSTAGEDATAINUP_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" /*
declare @p11 int
set @p11=-1
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     IF utils.object_id('TempDB..tt_CustMocUpload_10') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CustMocUpload_10 ';
                     END IF;
                     DELETE FROM tt_CustMocUpload_10;
                     INSERT INTO tt_CustMocUpload_10
                     ...
                     FROM B ,MetaScreenFieldDetail A
                            JOIN tt_CustMocUpload_10 B   ON A.CtrlName = B.FieldName 
                      WHERE A.MenuId = 128
                       AND A.IsVisible = 'Y') src
                     ON ( B.ROWID = src.row_id )
                     WHEN MATCHED THEN UPDATE SET B.SrNo = src.ScreenFieldNo;
                     ----	-------------------
                     ----	select * from tt_CustMocUpload_10
                     ...
                     ----select * from MetaScreenFieldDetail where menuid=128
                     ---------------------
                     IF utils.object_id('TEMPDB..tt_NEWTRANCHE_57') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_57 ';
                     END IF;
                     DELETE FROM tt_NEWTRANCHE_57;
                     UTILS.IDENTITY_RESET('tt_NEWTRANCHE_57');

                     INSERT INTO tt_NEWTRANCHE_57 SELECT * 
                          FROM ( SELECT ss.CustomerID ,
                                        utils.stuff(( SELECT ',' || US.SrNo 
                                                      FROM tt_CustMocUpload_10 US
                                                       WHERE  US.CustomerID = ss.CustomerID ), 1, 1, ' ') REPORTIDSLIST  
                                 FROM CustlevelNPAMOCDetails_stg SS
                                   GROUP BY ss.CustomerID ) B
                          ORDER BY 1;
                     --Select * from tt_NEWTRANCHE_57
                     --SELECT * 
                     MERGE INTO A 
                     USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                     FROM A ,RBL_MISDB_PROD.CustomerLevelMOC_Mod A
                            JOIN tt_NEWTRANCHE_57 B   ON A.CustomerID = B.CustomerID 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTNPAMOCSTAGEDATAINUP_24012024" TO "ADF_CDR_RBL_STGDB";
