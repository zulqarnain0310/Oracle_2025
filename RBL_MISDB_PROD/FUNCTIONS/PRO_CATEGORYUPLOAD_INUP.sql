--------------------------------------------------------
--  DDL for Function PRO_CATEGORYUPLOAD_INUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  -------------------In Main Table -----------------------
                  IF utils.object_id('TempDB..tt_STD') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_STD ';
                  END IF;
                  DELETE FROM tt_STD;
                  UTILS.IDENTITY_RESET('tt_STD');
                  ...
                  IF utils.object_id('TempDB..tt_STD1') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_STD1 ';
                  END IF;
                  DELETE FROM tt_STD1;
                  UTILS.IDENTITY_RESET('tt_STD1');
                  ...
                  FROM A ,STD_ProvDetail A
                         JOIN tt_STD1 B   ON A.CustomerAcId = B.ACID 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP" TO "ADF_CDR_RBL_STGDB";
