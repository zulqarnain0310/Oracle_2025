--------------------------------------------------------
--  DDL for Function ACNPAMOCSTAGEDATAINUP_08112021
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" 
(
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  IF utils.object_id('TempDB..tt_AccountMocUpload_3') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountMocUpload_3 ';
                  END IF;
                  DELETE FROM tt_AccountMocUpload_3;
                  INSERT INTO tt_AccountMocUpload_3
                    ( AccountID, FieldName )
                    ( SELECT AccountID ,
                             'POSinRs' FieldName  
                      FROM AccountLvlMOCDetails_stg 
                  ...
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_AccountMocUpload_3 B   ON A.CtrlName = B.FieldName 
                   WHERE A.MenuId = 24715
                    AND A.IsVisible = 'Y') src
                  ON ( B.ROWID = src.row_id )
                  WHEN MATCHED THEN UPDATE SET B.SrNo = src.ScreenFieldNo;
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_3') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_3 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_3;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_3');

                  INSERT INTO tt_NEWTRANCHE_3 SELECT * 
                       FROM ( SELECT ss.AccountID ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_AccountMocUpload_3 US
                                                    WHERE  US.AccountID = ss.AccountID ), 1, 1, ' ') REPORTIDSLIST  
                              FROM AccountLvlMOCDetails_stg SS
                                GROUP BY ss.AccountID ) B
                       ORDER BY 1;
                  --Select * from tt_NEWTRANCHE_3
                  --SELECT * 
                  MERGE INTO A 
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.AccountLevelMOC_Mod A
                         JOIN tt_NEWTRANCHE_3 B   ON A.AccountID = B.AccountID 
            ...
            BEGIN
               ...
               IF tt_ACCOUNT_CAL  --SQLDEV: NOT RECOGNIZED
               DELETE FROM tt_ACCOUNT_CAL;
               UTILS.IDENTITY_RESET('tt_ACCOUNT_CAL');

               INSERT INTO tt_ACCOUNT_CAL ( 
               	SELECT A.* 
               	  FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
                         JOIN AccountLevelMOC_Mod B   ON A.CustomerAcID = B.AccountID
               	 WHERE  ( A.EffectiveFromTimeKey <= v_TimeKey
                          AND A.EffectiveToTimeKey >= v_TimeKey ) );
               --Select AccountEntityID,* from tt_ACCOUNT_CAL
               MERGE INTO A 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_08112021" TO "ADF_CDR_RBL_STGDB";
