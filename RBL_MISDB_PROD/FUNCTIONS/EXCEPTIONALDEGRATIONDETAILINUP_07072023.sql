--------------------------------------------------------
--  DDL for Function EXCEPTIONALDEGRATIONDETAILINUP_07072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" 
-- =============================================
 -- Author:				<Amar>
      ...
      BEGIN
                           ...
                           ELSE
                              ...
                              BEGIN
                                 ...
                                 BEGIN
                                    ...
                                    BEGIN
                                       IF utils.object_id('TempDB..tt_Flags_17') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags_17 ';
                                       END IF;
                                       DELETE FROM tt_Flags_17;
                                       UTILS.IDENTITY_RESET('tt_Flags_17');

                                       INSERT INTO tt_Flags_17 ( 
                                       	SELECT A.AccountID ,
                                       ...
                                       FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                              JOIN tt_Flags_17 B   ON A.RefSystemAcId = B.AccountID 
                                    ...
                                    BEGIN
                                       ...
                                       IF utils.object_id('TempDB..tt_Flags_171') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags1_17 ';
                                       END IF;
                                       DELETE FROM tt_Flags1_17;
                                       UTILS.IDENTITY_RESET('tt_Flags1_17');

                                       INSERT INTO tt_Flags1_17 ( 
                                       	SELECT A.AccountID ,
                                               B.SplCatShortNameEnum 
                                       	  FROM ExceptionalDegrationDetail_Mod A
                                                 JOIN ( SELECT B.ParameterAlt_Key ,
                                       	 ...
                                       	 WHERE  A.EffectiveToTimeKey = 49999
                                                  ...
                                                  AND A.Entity_Key = ( SELECT MAX(Entity_Key)  
                                                                       FROM ExceptionalDegrationDetail_Mod 
                                                                        WHERE  AccountID = v_AccountID
                                                                                 AND FlagAlt_Key = v_FlagAlt_Key ) );
                                       IF utils.object_id('TempDB..tt_Temp_71') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp_71 ';
                                       END IF;
                                       DELETE FROM tt_Temp_71;
                                       UTILS.IDENTITY_RESET('tt_Temp_71');

                                       INSERT INTO tt_Temp_71 ( 
                                       	SELECT A.AccountentityID ,
                                               A.SplFlag 
                                       	  FROM CurDat_RBL_MISDB_PROD.AdvAcOtherDetail A
                                                 JOIN tt_Flags1_17 B   ON A.RefSystemAcId = B.AccountID
                                       	 WHERE  A.EffectiveToTimeKey = 49999 );
                                       --Select * from tt_Temp_71
                                       IF utils.object_id('TEMPDB..tt_SplitValue_19') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SplitValue_19 ';
                                       END IF;
                                       DELETE FROM tt_SplitValue_19;
                                       UTILS.IDENTITY_RESET('tt_SplitValue_19');

                                       INSERT INTO tt_SplitValue_19 ( 
                                       ...
                                       --Select * from tt_SplitValue_19 
                                       DELETE tt_SplitValue_19

                                        WHERE  Businesscolvalues1 IN ( SELECT DISTINCT SplCatShortNameEnum 
                                                                       FROM tt_Flags1_17  )
                                       ;
                                       IF utils.object_id('TEMPDB..tt_NEWTRANCHE_62') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_62 ';
                                       END IF;
                                       DELETE FROM tt_NEWTRANCHE_62;
                                       UTILS.IDENTITY_RESET('tt_NEWTRANCHE_62');

                                       INSERT INTO tt_NEWTRANCHE_62 SELECT * 
                                            FROM ( SELECT ss.AccountEntityID ,
                                                          utils.stuff(( SELECT ',' || US.BUSINESSCOLVALUES1 
                                                                        FROM tt_SplitValue_19 US
                                                                         WHERE  US.AccountentityID = ss.AccountEntityID ), 1, 1, ' ') REPORTIDSLIST  
                                                   FROM tt_Temp_71 SS
                                                     GROUP BY ss.AccountEntityID ) B
                                            ORDER BY 1;
                                       --Select * from tt_NEWTRANCHE_62
                                       --SELECT * 
                                       MERGE INTO A 
                                       USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                                       FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                              JOIN tt_NEWTRANCHE_62 B   ON A.AccountentityID = B.AccountentityID 
                                        WHERE A.EFFECTIVEFROMTIMEKEY <= v_TimeKey
         ...
         BEGIN
            ...
            SELECT utils.stuff(( SELECT DISTINCT ',' || ChangeFields 
              ...
              INTO v_Parameter3
              FROM DUAL ;
            IF utils.object_id('tt_AA_17') IS NOT NULL THEN
             EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AA_17 ';
            END IF;
            DELETE FROM tt_AA_17;
            UTILS.IDENTITY_RESET('tt_AA_17');

            INSERT INTO tt_AA_17 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_07072023" TO "ADF_CDR_RBL_STGDB";
