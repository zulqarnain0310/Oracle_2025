--------------------------------------------------------
--  DDL for Function UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" 
(
...
BEGIN
   ...
   SELECT MAX(AccountEntityID)  
    ...
    WHERE  effectivefromTimekey <= 25999
             AND Effectivetotimekey >= 25999
      ...
      BEGIN
         ...
         BEGIN
            INSERT INTO AdvAcPUIDetailSub_mod
              ( CustomerID, AccountID, AccountEntityId, ChangeinProjectScope, FreshOriginalDCCO, RevisedDCCO, CourtCaseArbitration, ChangeinOwnerShip, CIOReferenceDate, CIODCCO, CostOverRun, RevisedProjectCost, RevisedDebt
            --,RevisedDebt_EquityRatio
            , TakeOutFinance, AssetClassSellerBookAlt_key, NPADateSellerBook, Restructuring, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved, InitialExtenstion, ExtnReason_BCP, Npa_date, Npa_Reason, AssetClassAlt_Key, ActualDCCO_Achieved, ActualDCCO_Date )
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."UPDATEPROJSTATUSPUI_INUP_BACKUP_26052022" TO "ADF_CDR_RBL_STGDB";
