--------------------------------------------------------
--  DDL for Function ACCELERATEDPROVISIONDATAINUP_03052022
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" 
(
               ...
               BEGIN
                  ...
                  INSERT INTO AcceleratedProvision_Mod
                    ...
                    SELECT v_AcceleratedProvisionEntityID + RANK() OVER ( ORDER BY A.CustomerID  ) ,
                           ...
                           AssetClassification 
                      FROM AccountLevelApproachUpload_stg A
                             JOIN CurDat_RBL_MISDB_PROD.CustomerBasicDetail F   ON A.CustomerID = F.CustomerId
                             JOIN CurDat_RBL_MISDB_PROD.AdvAcBasicDetail E   ON E.CustomerEntityId = F.CustomerEntityId
                             LEFT JOIN CurDat_RBL_MISDB_PROD.AdvCustNpaDetail G   ON E.CustomerEntityId = G.CustomerEntityId
                             LEFT JOIN ( SELECT ParameterAlt_Key ,
                                                ParameterName ,
                                                'AcceleratedProvisionDuration' Tablename  
                                         FROM DimParameter 
                  ...
                  INSERT INTO AcceleratedProvision_Mod
                    ...
                    SELECT v_AcceleratedProvisionEntityID + RANK() OVER ( ORDER BY A.UCIC  ) ,
                           ...
                           AssetClassification 
                      FROM AccountLevelApproachUpload_stg A
                             JOIN CurDat_RBL_MISDB_PROD.CustomerBasicDetail F   ON A.UCIC = F.UCIF_ID
                             JOIN CurDat_RBL_MISDB_PROD.AdvAcBasicDetail E   ON E.CustomerEntityId = F.CustomerEntityId
                             LEFT JOIN CurDat_RBL_MISDB_PROD.AdvCustNpaDetail G   ON E.CustomerEntityId = G.CustomerEntityId
                             LEFT JOIN ( SELECT ParameterAlt_Key ,
                                                ParameterName ,
                  ...
                  FROM A ,AcceleratedProvision_Mod A
                         JOIN ( SELECT ProvisionAlt_Key ,
                                       CustomerAcID ,
                                       EffectiveFromTimeKey ,
                                       EffectiveToTimeKey 
                                FROM PRO_RBL_MISDB_PROD.AccountCal_Hist A
                                 WHERE  A.EffectiveFromTimeKey <= v_Timekey
                                          AND A.EffectiveToTimeKey >= v_Timekey ) B   ON A.AccountId = B.CustomerAcID
                  ...
                  IF utils.object_id('TempDB..tt_CollateralDetails_Upload_2') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_CollateralDetails_Upload_2 ';
                  END IF;
                  DELETE FROM tt_CollateralDetails_Upload_2;
                  INSERT INTO tt_CollateralDetails_Upload_2
                    ( AccountId, FieldName )
                    ( SELECT CASE 
                  ...
                  --Select 'tt_CollateralDetails_Upload_2', * from tt_CollateralDetails_Upload_2
                  --Select * from  tt_NEWTRANCHE_10
                  DBMS_OUTPUT.PUT_LINE('nanda3');
                  --select *
                  MERGE INTO B 
                  USING (SELECT B.ROWID row_id, A.ScreenFieldNo
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_CollateralDetails_Upload_2 B   ON A.CtrlName = B.FieldName 
                  ...
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_10') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_10 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_10;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_10');

                  INSERT INTO tt_NEWTRANCHE_10 SELECT * 
                       FROM ( SELECT ss.AccountId ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_CollateralDetails_Upload_2 US
                                                    WHERE  US.AccountId = ss.AccountId ), 1, 1, ' ') REPORTIDSLIST  
                              FROM AccountLevelApproachUpload_stg SS
                               WHERE  ss.AccountId <> ' '
                                GROUP BY ss.AccountId ) B
                       ORDER BY 1;
                  INSERT INTO tt_NEWTRANCHE_10
                  ...
                  INSERT INTO tt_NEWTRANCHE_10
                    SELECT ss.UCIC ,
                     ...
                     WHERE  ss.UCIC <> ' '
                      GROUP BY ss.UCIC
                      ORDER BY 1;
                  --Select 'tt_NEWTRANCHE_10',* from tt_NEWTRANCHE_10
                  --SELECT * 
                  MERGE INTO A 
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.AcceleratedProvision_Mod A
                         JOIN tt_NEWTRANCHE_10 B   ON A.AccountId = B.AccountId 
                   WHERE A.EffectiveFromTimeKey <= v_Timekey
                  ...
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.AcceleratedProvision_Mod A
                         JOIN tt_NEWTRANCHE_10 B   ON A.CustomerId = B.AccountId 
                   WHERE A.EffectiveFromTimeKey <= v_Timekey
                    AND A.EffectiveToTimeKey >= v_Timekey
                    AND A.UploadID = v_ExcelUploadId) src
                  ON ( A.ROWID = src.row_id )
                  ...
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.AcceleratedProvision_Mod A
                         JOIN tt_NEWTRANCHE_10 B   ON A.UCICID = B.AccountId 
                   WHERE A.EffectiveFromTimeKey <= v_Timekey
                    AND A.EffectiveToTimeKey >= v_Timekey
                    AND A.UploadID = v_ExcelUploadId) src
                  ON ( A.ROWID = src.row_id )
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCELERATEDPROVISIONDATAINUP_03052022" TO "ADF_CDR_RBL_STGDB";
