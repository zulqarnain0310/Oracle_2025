--------------------------------------------------------
--  DDL for Function DIMASSETCLASSMASTER_INUP_08072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" 
(
...
BEGIN
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_final_28 
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM TEMP ,tt_final_28 TEMP
                   JOIN ( SELECT tt_final_28.SourceAlt_Key ,
                                 (v_AssetClassMappingAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
              FROM DUAL  )  )) AssetClassMappingAlt_Key  
                          FROM tt_final_28 
                           WHERE  tt_final_28.AssetClassMappingAlt_Key = 0
                                    OR tt_final_28.AssetClassMappingAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
   ...
   BEGIN
      ...
      FROM TEMP ,tt_final_28 TEMP ) src
      ON ( TEMP.ROWID = src.row_id )
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            -----------------------------------------------------------
            --	IF Object_id('Tempdb..tt_Temp_51') Is Not Null
            --Drop Table tt_Temp_51
            --	IF Object_id('Tempdb..tt_final_28') Is Not Null
            --Drop Table tt_final_28
            --Create table tt_Temp_51
            --(AssetClassAlt_Key int
            --,SourceAlt_Key Varchar(20)
            --,AssetClassName	varchar(100)
            --)
            --Insert into tt_Temp_51 values(@AssetClassAlt_Key,@SourceAlt_Key,@AssetClassName)
            --Select A.Businesscolvalues1 as SourceAlt_Key,AssetClassName,AssetClassAlt_Key  into tt_final_28 From (
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_08072023" TO "ADF_CDR_RBL_STGDB";
