--------------------------------------------------------
--  DDL for Function CALYPSOACNPAMOCSTAGEDATAINUP_08072023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" 
(
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  IF utils.object_id('TempDB..tt_AccountMocUpload_11') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountMocUpload_11 ';
                  END IF;
                  DELETE FROM tt_AccountMocUpload_11;
                  INSERT INTO tt_AccountMocUpload_11
                    ( AccountID, FieldName )
                  ...
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_AccountMocUpload_11 B   ON A.CtrlName = B.FieldName 
                   WHERE A.MenuId = 27767
                    AND A.IsVisible = 'Y') src
                  ON ( B.ROWID = src.row_id )
                  WHEN MATCHED THEN UPDATE SET B.SrNo = src.ScreenFieldNo;
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_43') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_43 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_43;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_43');

                  INSERT INTO tt_NEWTRANCHE_43 SELECT * 
                       FROM ( SELECT ss.InvestmentIDDerivativeRefNo ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_AccountMocUpload_11 US
                       ...
                       ORDER BY 1;
                  --Select * from tt_NEWTRANCHE_43  
                  --SELECT *   
                  MERGE INTO A 
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.CalypsoAccountLevelMOC_Mod A
                         JOIN tt_NEWTRANCHE_43 B   ON A.AccountID = B.InvestmentIDDerivativeRefNo 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CALYPSOACNPAMOCSTAGEDATAINUP_08072023" TO "ADF_CDR_RBL_STGDB";
