--------------------------------------------------------
--  DDL for Function DIMINDUSTRYMASTER_INUP_15122023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" 
(
...
BEGIN
   ...
   END IF;
   -----------------------------------------------------------
   IF utils.object_id('Tempdb..tt_Temp_62') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp_62 ';
   END IF;
   IF utils.object_id('Tempdb..tt_final_39') IS NOT NULL THEN
    EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_39 ';
   END IF;
   DELETE FROM tt_Temp_62;
   INSERT INTO tt_Temp_62
     VALUES ( v_IndustryAlt_key, v_SourceAlt_Key, v_IndustryName );
   DELETE FROM tt_final_39;
   UTILS.IDENTITY_RESET('tt_final_39');

   INSERT INTO tt_final_39 ( 
   ...
   EXECUTE IMMEDIATE ' ALTER TABLE tt_final_39 
   ...
   */
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            FROM TEMP ,tt_final_39 TEMP
                   JOIN ( SELECT tt_final_39.SourceAlt_Key ,
                                 (v_IndustryMappingAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
              FROM DUAL  )  )) IndustryMappingAlt_Key  
                          FROM tt_final_39 
                           WHERE  tt_final_39.IndustryMappingAlt_Key = 0
                                    OR tt_final_39.IndustryMappingAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
   ...
   BEGIN
      ...
      FROM TEMP ,tt_final_39 TEMP ) src
      ON ( TEMP.ROWID = src.row_id )
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            -----------------------------------------------------------
            --	IF Object_id('Tempdb..tt_Temp_62') Is Not Null
            --Drop Table tt_Temp_62
            --	IF Object_id('Tempdb..tt_final_39') Is Not Null
            --Drop Table tt_final_39
            --Create table tt_Temp_62
            --(IndustryAlt_key int
            --,SourceAlt_Key Varchar(20)
            --,IndustryName	varchar(100)
            --)
            --Insert into tt_Temp_62 values(@IndustryAlt_key,@SourceAlt_Key,@IndustryName)
            --Select A.Businesscolvalues1 as SourceAlt_Key,IndustryAlt_key,IndustryName  into tt_final_39 From (
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMINDUSTRYMASTER_INUP_15122023" TO "ADF_CDR_RBL_STGDB";
