--------------------------------------------------------
--  DDL for Function PRO_CATEGORYUPLOAD_INUP_04122023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" 
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               -------------------In Main Table -----------------------
               IF utils.object_id('TempDB..tt_STD_2') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_STD_2 ';
               END IF;
               DELETE FROM tt_STD_2;
               UTILS.IDENTITY_RESET('tt_STD_2');

               INSERT INTO tt_STD_2 ( 
               ...
               IF utils.object_id('TempDB..tt_STD_21') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_STD1_2 ';
               END IF;
               DELETE FROM tt_STD1_2;
               UTILS.IDENTITY_RESET('tt_STD1_2');

               INSERT INTO tt_STD1_2 ( 
               	SELECT A.* 
               	  FROM tt_STD_2 A
                         JOIN ( SELECT ACID ,
               ...
               FROM A ,STD_ProvDetail A
                      JOIN tt_STD1_2 B   ON A.CustomerAcId = B.ACID 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRO_CATEGORYUPLOAD_INUP_04122023" TO "ADF_CDR_RBL_STGDB";
