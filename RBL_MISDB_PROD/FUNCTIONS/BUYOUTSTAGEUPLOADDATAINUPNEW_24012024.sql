--------------------------------------------------------
--  DDL for Function BUYOUTSTAGEUPLOADDATAINUPNEW_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" 
(
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     IF utils.object_id('TempDB..tt_Buyout_Upload_9') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Buyout_Upload_9 ';
                     END IF;
                     DELETE FROM tt_Buyout_Upload_9;
                     INSERT INTO tt_Buyout_Upload_9
                       ( AccountNo, FieldName )
                       ( 
                     ...
                     FROM B ,MetaScreenFieldDetail A
                            JOIN tt_Buyout_Upload_9 B   ON A.CtrlName = B.FieldName 
                     ...
                     IF utils.object_id('TEMPDB..tt_NEWTRANCHE_39') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_39 ';
                     END IF;
                     DELETE FROM tt_NEWTRANCHE_39;
                     UTILS.IDENTITY_RESET('tt_NEWTRANCHE_39');

                     INSERT INTO tt_NEWTRANCHE_39 SELECT * 
                          FROM ( SELECT ss.AccountNo ,
                                        utils.stuff(( SELECT ',' || US.SrNo 
                                                      FROM tt_Buyout_Upload_9 US
                                                       WHERE  US.AccountNo = ss.AccountNo ), 1, 1, ' ') REPORTIDSLIST  
                                 FROM BuyoutUploadDetails_stg SS
                                   GROUP BY ss.AccountNo ) B
                          ORDER BY 1;
                     --Select * from tt_NEWTRANCHE_39  
                     --SELECT *   
                     MERGE INTO A 
                     USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                     FROM A ,RBL_MISDB_PROD.BuyoutUploadDetails_Mod A
                            JOIN tt_NEWTRANCHE_39 B   ON A.CustomerAcID = B.AccountNo 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW_24012024" TO "ADF_CDR_RBL_STGDB";
