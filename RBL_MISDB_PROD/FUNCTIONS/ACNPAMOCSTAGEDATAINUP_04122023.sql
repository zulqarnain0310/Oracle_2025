--------------------------------------------------------
--  DDL for Function ACNPAMOCSTAGEDATAINUP_04122023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" 
(
         ...
         BEGIN
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  IF utils.object_id('TempDB..tt_AccountMocUpload_2') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AccountMocUpload_2 ';
                  END IF;
                  DELETE FROM tt_AccountMocUpload_2;
                  INSERT INTO tt_AccountMocUpload_2
                    ( AccountID, FieldName )
                    ( SELECT AccountID ,
                             'POSinRs' FieldName  
                      FROM AccountLvlMOCDetails_stg 
                  ...
                  FROM B ,MetaScreenFieldDetail A
                         JOIN tt_AccountMocUpload_2 B   ON A.CtrlName = B.FieldName 
                   WHERE A.MenuId = 24715
                    AND A.IsVisible = 'Y') src
                  ON ( B.ROWID = src.row_id )
                  WHEN MATCHED THEN UPDATE SET B.SrNo = src.ScreenFieldNo;
                  IF utils.object_id('TEMPDB..tt_NEWTRANCHE_2') IS NOT NULL THEN
                   EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_2 ';
                  END IF;
                  DELETE FROM tt_NEWTRANCHE_2;
                  UTILS.IDENTITY_RESET('tt_NEWTRANCHE_2');

                  INSERT INTO tt_NEWTRANCHE_2 SELECT * 
                       FROM ( SELECT ss.AccountID ,
                                     utils.stuff(( SELECT ',' || US.SrNo 
                                                   FROM tt_AccountMocUpload_2 US
                                                    WHERE  US.AccountID = ss.AccountID ), 1, 1, ' ') REPORTIDSLIST  
                              FROM AccountLvlMOCDetails_stg SS
                                GROUP BY ss.AccountID ) B
                       ORDER BY 1;
                  --Select * from tt_NEWTRANCHE_2
                  --SELECT * 
                  MERGE INTO A 
                  USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                  FROM A ,RBL_MISDB_PROD.AccountLevelMOC_Mod A
                         JOIN tt_NEWTRANCHE_2 B   ON A.AccountID = B.AccountID 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACNPAMOCSTAGEDATAINUP_04122023" TO "ADF_CDR_RBL_STGDB";
