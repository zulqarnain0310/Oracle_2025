--------------------------------------------------------
--  DDL for Function BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" 
(
...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF utils.object_id('TEMPDB..tt_UserIdStatus_5') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_UserIdStatus_5 ';
         END IF;
         DELETE FROM tt_UserIdStatus_5;
         UTILS.IDENTITY_RESET('tt_UserIdStatus_5');

         INSERT INTO tt_UserIdStatus_5 ( 
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     IF utils.object_id('TempDB..tt_Buyout_Upload_5') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Buyout_Upload_5 ';
                     END IF;
                     DELETE FROM tt_Buyout_Upload_5;
                     INSERT INTO tt_Buyout_Upload_5
                     ...
                     FROM B ,MetaScreenFieldDetail A
                            JOIN tt_Buyout_Upload_5 B   ON A.CtrlName = B.FieldName 
                     ...
                     IF utils.object_id('TEMPDB..tt_NEWTRANCHE_35') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_35 ';
                     END IF;
                     DELETE FROM tt_NEWTRANCHE_35;
                     UTILS.IDENTITY_RESET('tt_NEWTRANCHE_35');

                     INSERT INTO tt_NEWTRANCHE_35 SELECT * 
                          FROM ( SELECT ss.AccountNoinRBLHostSystem ,
                                        ss.AccountNoofSeller ,
                                        utils.stuff(( SELECT ',' || US.SrNo 
                                                      FROM tt_Buyout_Upload_5 US
                     ...
                     FROM A ,RBL_MISDB_PROD.BuyoutMapperUpload_Mod A
                            JOIN tt_NEWTRANCHE_35 B   ON A.AccountNoinRBLHostSystem = B.AccountNoinRBLHostSystem
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTMAPPERSTAGEUPLOADDATAINUP_24012024" TO "ADF_CDR_RBL_STGDB";
