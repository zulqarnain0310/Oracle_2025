--------------------------------------------------------
--  DDL for Function EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" 
-- =============================================
 -- Author:				<Amar>
                           ...
                           ELSE
                              ...
                              BEGIN
                                 ...
                                 BEGIN
                                    ...
                                    BEGIN
                                       IF utils.object_id('TempDB..tt_Flags_21') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags_21 ';
                                       END IF;
                                       DELETE FROM tt_Flags_21;
                                       UTILS.IDENTITY_RESET('tt_Flags_21');

                                       INSERT INTO tt_Flags_21 ( 
                                       	SELECT A.AccountID ,
                                       ...
                                       FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                              JOIN tt_Flags_21 B   ON A.RefSystemAcId = B.AccountID 
                                    ...
                                    BEGIN
                                       ...
                                       ON ( B.ROWID = src.row_id )
                                       WHEN MATCHED THEN UPDATE SET B.EffectiveToTimeKey = src.EffectiveToTimeKey;
                                       IF utils.object_id('TempDB..tt_Flags_211') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Flags1_21 ';
                                       END IF;
                                       DELETE FROM tt_Flags1_21;
                                       UTILS.IDENTITY_RESET('tt_Flags1_21');

                                       INSERT INTO tt_Flags1_21 ( 
                                       	SELECT A.AccountID ,
                                               B.SplCatShortNameEnum 
                                       	  FROM ExceptionalDegrationDetail_Mod A
                                                 JOIN ( SELECT B.ParameterAlt_Key ,
                                       ...
                                       INSERT INTO tt_Temp_75 ( 
                                       	SELECT A.AccountentityID ,
                                       	  ...
                                       	  FROM CurDat_RBL_MISDB_PROD.AdvAcOtherDetail A
                                                 JOIN tt_Flags1_21 B   ON A.RefSystemAcId = B.AccountID
                                       	 WHERE  A.EffectiveToTimeKey = 49999 );
                                       --Select * from tt_Temp_75
                                       IF utils.object_id('TEMPDB..tt_SplitValue_23') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SplitValue_23 ';
                                       END IF;
                                       DELETE FROM tt_SplitValue_23;
                                       UTILS.IDENTITY_RESET('tt_SplitValue_23');

                                       INSERT INTO tt_SplitValue_23 ( 
                                       ...
                                       --Select * from tt_SplitValue_23 
                                       DELETE tt_SplitValue_23

                                        WHERE  Businesscolvalues1 IN ( SELECT DISTINCT SplCatShortNameEnum 
                                                                       FROM tt_Flags1_21  )
                                       ;
                                       IF utils.object_id('TEMPDB..tt_NEWTRANCHE_66') IS NOT NULL THEN
                                        EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_66 ';
                                       END IF;
                                       DELETE FROM tt_NEWTRANCHE_66;
                                       UTILS.IDENTITY_RESET('tt_NEWTRANCHE_66');

                                       INSERT INTO tt_NEWTRANCHE_66 SELECT * 
                                            FROM ( SELECT ss.AccountEntityID ,
                                                          utils.stuff(( SELECT ',' || US.BUSINESSCOLVALUES1 
                                                                        FROM tt_SplitValue_23 US
                                                                         WHERE  US.AccountentityID = ss.AccountEntityID ), 1, 1, ' ') REPORTIDSLIST  
                                                   FROM tt_Temp_75 SS
                                                     GROUP BY ss.AccountEntityID ) B
                                            ORDER BY 1;
                                       --Select * from tt_NEWTRANCHE_66
                                       --SELECT * 
                                       MERGE INTO A 
                                       USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                                       FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                              JOIN tt_NEWTRANCHE_66 B   ON A.AccountentityID = B.AccountentityID 
                                        WHERE A.EFFECTIVEFROMTIMEKEY <= v_TimeKey
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."EXCEPTIONALDEGRATIONDETAILINUP_BACKUP_25022022" TO "ADF_CDR_RBL_STGDB";
