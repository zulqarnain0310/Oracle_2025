--------------------------------------------------------
--  DDL for Function SMAMASTERINUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."SMAMASTERINUP" 
(
      ...
      BEGIN
         ...
         BEGIN
                                       ...
                                       BEGIN
                                          ...
                                          BEGIN
                                             ...
                                             FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                                  --INNER JOIN tt_Temp_108 V  ON A.AccountEntityId=V.AccountEntityId
                                          ...
                                          BEGIN
                                             ...
                                             --Select * from tt_Temp1_2
                                             IF utils.object_id('TEMPDB..tt_SplitValue_34') IS NOT NULL THEN
                                              EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SplitValue_34 ';
                                             END IF;
                                             DELETE FROM tt_SplitValue_34;
                                             UTILS.IDENTITY_RESET('tt_SplitValue_34');

                                             INSERT INTO tt_SplitValue_34 ( 
                                             	SELECT AccountentityID ,
                                             ...
                                             --Select * from tt_SplitValue_34 
                                             DELETE tt_SplitValue_34

                                              WHERE  Businesscolvalues1 = 'SMA0';
                                             IF utils.object_id('TEMPDB..tt_NEWTRANCHE_79') IS NOT NULL THEN
                                              EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_79 ';
                                             END IF;
                                             DELETE FROM tt_NEWTRANCHE_79;
                                             UTILS.IDENTITY_RESET('tt_NEWTRANCHE_79');

                                             INSERT INTO tt_NEWTRANCHE_79 SELECT * 
                                                  FROM ( SELECT ss.AccountEntityID ,
                                                                utils.stuff(( SELECT ',' || US.BUSINESSCOLVALUES1 
                                                                              FROM tt_SplitValue_34 US
                                                                               WHERE  US.AccountentityID = ss.AccountEntityID ), 1, 1, ' ') REPORTIDSLIST  
                                                         FROM tt_Temp1_2 SS
                                                           GROUP BY ss.AccountEntityID ) B
                                                  ORDER BY 1;
                                             --Select * from tt_NEWTRANCHE_79
                                             --SELECT * 
                                             MERGE INTO A 
                                             USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                                             FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                                    JOIN tt_NEWTRANCHE_79 B   ON A.AccountentityID = B.AccountentityID 
            ...
            BEGIN
               ...
               END IF;
               IF utils.object_id('Tempdb..tt_final_66') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_66 ';
               END IF;
               DELETE FROM tt_Temp_108;
               INSERT INTO tt_Temp_108
                 VALUES ( v_CustomerId, v_ValueAlt_Key, v_CustomerName );
               DELETE FROM tt_final_66;
               UTILS.IDENTITY_RESET('tt_final_66');

               INSERT INTO tt_final_66 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP" TO "ADF_CDR_RBL_STGDB";
