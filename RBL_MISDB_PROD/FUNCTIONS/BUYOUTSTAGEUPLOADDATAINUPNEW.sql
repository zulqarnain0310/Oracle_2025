--------------------------------------------------------
--  DDL for Function BUYOUTSTAGEUPLOADDATAINUPNEW
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" 
(
            ...
            BEGIN
               ...
               BEGIN
                  ...
                  BEGIN
                     ...
                     IF utils.object_id('TempDB..tt_Buyout_Upload_6') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Buyout_Upload_6 ';
                     END IF;
                     DELETE FROM tt_Buyout_Upload_6;
                     INSERT INTO tt_Buyout_Upload_6
                       ( AccountNo, FieldName )
                       ( 
                     ...
                     FROM B ,MetaScreenFieldDetail A
                            JOIN tt_Buyout_Upload_6 B   ON A.CtrlName = B.FieldName 
                     ...
                     IF utils.object_id('TEMPDB..tt_NEWTRANCHE_36') IS NOT NULL THEN
                      EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_36 ';
                     END IF;
                     DELETE FROM tt_NEWTRANCHE_36;
                     UTILS.IDENTITY_RESET('tt_NEWTRANCHE_36');

                     INSERT INTO tt_NEWTRANCHE_36 SELECT * 
                          FROM ( SELECT ss.AccountNo ,
                                        utils.stuff(( SELECT ',' || US.SrNo 
                                                      FROM tt_Buyout_Upload_6 US
                                                       WHERE  US.AccountNo = ss.AccountNo ), 1, 1, ' ') REPORTIDSLIST  
                                 FROM BuyoutUploadDetails_stg SS
                                   GROUP BY ss.AccountNo ) B
                          ORDER BY 1;
                     --Select * from tt_NEWTRANCHE_36  
                     --SELECT *   
                     MERGE INTO A 
                     USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                     FROM A ,RBL_MISDB_PROD.BuyoutUploadDetails_Mod A
                            JOIN tt_NEWTRANCHE_36 B   ON A.CustomerAcID = B.AccountNo 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."BUYOUTSTAGEUPLOADDATAINUPNEW" TO "ADF_CDR_RBL_STGDB";
