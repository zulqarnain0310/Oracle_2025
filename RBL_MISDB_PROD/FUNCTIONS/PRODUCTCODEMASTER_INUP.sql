--------------------------------------------------------
--  DDL for Function PRODUCTCODEMASTER_INUP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" 
(
...
BEGIN
   ...
   BEGIN
      ...
      END IF;
      IF utils.object_id('Tempdb..tt_final_65') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_65 ';
      END IF;
      DELETE FROM tt_Temp_106;
      INSERT INTO tt_Temp_106
        VALUES ( v_ProductCode, v_SourceAlt_Key, v_ProductDescription );
      DELETE FROM tt_final_65;
      UTILS.IDENTITY_RESET('tt_final_65');

      INSERT INTO tt_final_65 ( 
      ...
      EXECUTE IMMEDIATE ' ALTER TABLE tt_final_65 
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               FROM TEMP ,tt_final_65 TEMP
                      JOIN ( SELECT tt_final_65.SourceAlt_Key ,
                                    (v_ProductAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                                         FROM DUAL  )  )) ProductAlt_Key  
                             FROM tt_final_65 
                              WHERE  tt_final_65.ProductAlt_Key = 0
                                       OR tt_final_65.ProductAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
      ...
      BEGIN
         ...
         FROM TEMP ,tt_final_65 TEMP ) src
         ON ( TEMP.ROWID = src.row_id )
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               -----------------------------------------------------------
               --	IF Object_id('Tempdb..tt_Temp_106') Is Not Null
               --Drop Table tt_Temp_106
               --	IF Object_id('Tempdb..tt_final_65') Is Not Null
               --Drop Table tt_final_65
               --Create table tt_Temp_106
               --(ProductCode Varchar(20)
               --,SourceAlt_Key Varchar(20)
               --,ProductDescription Varchar(500)
               --)
               --Insert into tt_Temp_106 values(@ProductCode,@SourceAlt_Key,@ProductDescription)
               --Select A.Businesscolvalues1 as SourceAlt_Key,ProductCode,ProductDescription  into tt_final_65 From (
               ...
               SELECT utils.stuff(( SELECT ',' || ChangeFields 
                 ...
                 INTO v_Parameter3
                 FROM DUAL ;
               IF utils.object_id('tt_AA_31') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_AA_31 ';
               END IF;
               DELETE FROM tt_AA_31;
               UTILS.IDENTITY_RESET('tt_AA_31');

               INSERT INTO tt_AA_31 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."PRODUCTCODEMASTER_INUP" TO "ADF_CDR_RBL_STGDB";
