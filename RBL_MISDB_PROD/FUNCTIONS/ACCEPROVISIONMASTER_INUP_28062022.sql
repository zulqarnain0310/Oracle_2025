--------------------------------------------------------
--  DDL for Function ACCEPROVISIONMASTER_INUP_28062022
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" 
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               FROM A ,AcceleratedProvision_Mod A
                      JOIN CurDat_RBL_MISDB_PROD.CustomerBasicDetail C   ON A.CustomerId = C.CustomerID 
                WHERE C.CustomerID = v_CustomerId) src
               ON ( A.ROWID = src.row_id )
               ...
               FROM A ,AcceleratedProvision_Mod A
                ...
                WHERE A.CustomerId = v_CustomerId) src
               ON ( A.ROWID = src.row_id )
            ...
            BEGIN
               ...
               FROM A ,AcceleratedProvision_Mod A
                      JOIN CurDat_RBL_MISDB_PROD.AdvAcBasicDetail B   ON A.AccountId = B.CustomerACID 
                WHERE B.CustomerACID = v_AccountId) src
               ON ( A.ROWID = src.row_id )
               WHEN MATCHED THEN UPDATE SET A.AccountEntityId = src.AccountEntityId;
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."ACCEPROVISIONMASTER_INUP_28062022" TO "ADF_CDR_RBL_STGDB";
