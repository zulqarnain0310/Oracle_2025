--------------------------------------------------------
--  DDL for Function CUSTOMERACCOUNTMOC_04122023
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" 
(
...
BEGIN
   ...
   SELECT TIMEKEY 
     ...
     FROM SysDayMatrix 
    WHERE  TIMEKEY = v_TIMEKEY;
   DELETE FROM tt_CUST_AC_MOC_4;
   UTILS.IDENTITY_RESET('tt_CUST_AC_MOC_4');

   INSERT INTO tt_CUST_AC_MOC_4 ( 
   ...
   INSERT INTO tt_CUST_AC_MOC_4
     ( SELECT A.CustomerEntityId ,
       ...
       FROM DataUpload_RBL_MISDB_PROD.MocCustomerDataUpload A
              ...
              AND ( D.EffectiveFromTimeKey <= v_MocTimeKey
              AND D.EffectiveToTimeKey >= v_MocTimeKey )
              LEFT JOIN tt_CUST_AC_MOC_4 E   ON E.AccountEntityid = B.AccountEntityid
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF tt_CustNpa_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_CustNpa_4;
         UTILS.IDENTITY_RESET('tt_CustNpa_4');

         INSERT INTO tt_CustNpa_4 ( 
         	SELECT A.CustomerEntityId ,
                 CustomerId ,
                 CASE 
         ...
         IF tt_Npadt_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_Npadt_4;
         UTILS.IDENTITY_RESET('tt_Npadt_4');

         INSERT INTO tt_Npadt_4 ( 
         ...
         ELSE NULL
            END AS pos_3
         FROM N ,tt_Npadt_4 N
                JOIN tt_CustNpa_4 C   ON N.CustomerEntityId = C.CustomerEntityId
         ...
         FROM A ,tt_CustNpa_4 A
                JOIN tt_Npadt_4 B   ON A.CustomerEntityId = B.CustomerEntityId ) src
         ...
         IF utils.object_id('Tempdb..tt_TmpCustNPA_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TmpCustNPA_4 ';
         END IF;
         DELETE FROM tt_TmpCustNPA_4;
         UTILS.IDENTITY_RESET('tt_TmpCustNPA_4');

         INSERT INTO tt_TmpCustNPA_4 ( 
         	SELECT NPA.* 
         ...
         FROM NPA ,AdvCustNPADetail NPA
                JOIN tt_TmpCustNPA_4 T   ON NPA.CustomerEntityId = T.CustomerEntityId
                AND ( NPA.EffectiveFromTimeKey <= v_MocTimeKey
                AND NPA.EffectiveToTimeKey >= v_MocTimeKey ) 
         ...
         FROM NPA ,AdvCustNPADetail NPA
                JOIN tt_Npadt_4 SD   ON NPA.CustomerEntityId = SD.CustomerEntityId
         ...
         IF utils.object_id('Tempdb..tt_TmpAcBalance_4') IS NOT NULL THEN
          EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_TmpAcBalance_4 ';
         END IF;
         DELETE FROM tt_TmpAcBalance_4;
         UTILS.IDENTITY_RESET('tt_TmpAcBalance_4');

         INSERT INTO tt_TmpAcBalance_4 ( 
         	SELECT AABD.* 
         	  FROM RBL_MISDB_PROD.AdvAcBalanceDetail AABD
                   ...
                   JOIN tt_CUST_AC_MOC_4 T   ON ( ABD.AccountEntityId = T.AccountEntityId ) );
         DBMS_OUTPUT.PUT_LINE('Expire data');
         MERGE INTO AABD 
         USING (SELECT AABD.ROWID row_id, v_MocTimeKey - 1 AS EffectiveToTimeKey
         FROM AABD ,RBL_MISDB_PROD.AdvAcBalanceDetail AABD
                JOIN tt_TmpAcBalance_4 T   ON AABD.AccountEntityId = T.AccountEntityId
                AND ( AABD.EffectiveFromTimeKey <= v_MocTimeKey
                AND AABD.EffectiveToTimeKey >= v_MocTimeKey ) 
         ...
         ELSE AABD.NPS_Balance
            END AS pos_11
         FROM AABD ,RBL_MISDB_PROD.AdvAcBalanceDetail AABD
                JOIN tt_CUST_AC_MOC_4 T   ON AABD.AccountEntityId = T.AccountEntityId
                AND ( AABD.EffectiveFromTimeKey <= v_MocTimeKey
                AND AABD.EffectiveToTimeKey >= v_MocTimeKey )
         ...
         , OverduePrincipal, Overdueinterest, AdvanceRecovery, NotionalInttAmt, PrincipalBalance )
           ( SELECT A.AccountEntityId ,
                    ...
                    A.NotionalInttAmt ,
                    A.PrincipalBalance 
             FROM tt_TmpAcBalance_4 A
                    LEFT JOIN tt_CUST_AC_MOC_4 SD   ON A.AccountEntityId = SD.AccountEntityId
         ...
         */
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_TempCustBalance_New_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_TempCustBalance_New_4;
         UTILS.IDENTITY_RESET('tt_TempCustBalance_New_4');

         INSERT INTO tt_TempCustBalance_New_4 ( 
         	SELECT ABD.CustomerEntityId ,
                 ABD.BranchCode ,
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AdvCustFinancialDetail_O_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvCustFinancialDetail_O_4;
         UTILS.IDENTITY_RESET('tt_AdvCustFinancialDetail_O_4');

         INSERT INTO tt_AdvCustFinancialDetail_O_4 ( 
         	SELECT F.* 
         	  FROM AdvCustFinancialDetail F
                   JOIN tt_TempCustBalance_New_4 N   ON F.EffectiveFromTimeKey <= v_MocTimeKey
         ...
         FROM ACFD ,AdvCustFinancialDetail ACFD
                JOIN tt_TempCustBalance_New_4 T   ON ACFD.CustomerEntityId = T.CustomerEntityId
         ...
         INSERT INTO PreMoc_RBL_MISDB_PROD.AdvCustFinancialDetail
           ...
           ( SELECT T.CustomerEntityId ,
                    ...
                    SYSDATE MocDate  ,
                    T.MocTypeAlt_Key 
             FROM tt_AdvCustFinancialDetail_O_4 T
                    JOIN tt_TempCustBalance_New_4 N   ON T.EffectiveFromTimeKey <= v_MocTimeKey
                    AND T.EffectiveToTimeKey >= v_MocTimeKey
         ...
         INSERT INTO AdvCustFinancialDetail
           ...
           ( SELECT A.CustomerEntityId ,
                    ...
                    SYSDATE MocDate  ,
                    MocTypeAlt_Key 
             FROM tt_TempCustBalance_New_4 A
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AdvAcFinancialDetail_ORG_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvAcFinancialDetail_ORG_4;
         UTILS.IDENTITY_RESET('tt_AdvAcFinancialDetail_ORG_4');

         INSERT INTO tt_AdvAcFinancialDetail_ORG_4 ( 
         	SELECT F.* 
         ...
         IF  --SQLDEV: NOT RECOGNIZED
         IF tt_AdvAcFinancialDetail_New_4  --SQLDEV: NOT RECOGNIZED
         DELETE FROM tt_AdvAcFinancialDetail_New_4;
         UTILS.IDENTITY_RESET('tt_AdvAcFinancialDetail_New_4');

         INSERT INTO tt_AdvAcFinancialDetail_New_4 ( 
         	SELECT O.AccountEntityId ,
                 NVL(S.PostMoc_NPAdt, '1900-01-01') NpaDt  
         	  FROM tt_AdvAcFinancialDetail_ORG_4 O
         ...
         , RefCustomerId, RefSystemAcId, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved, MocDate, MocTypeAlt_Key, CropDuration, Ac_ReviewAuthLevelAlt_Key )
           ( SELECT T.AccountEntityId ,
             ...
             FROM tt_AdvAcFinancialDetail_ORG_4 T
                    JOIN tt_AdvAcFinancialDetail_New_4 N   ON T.EffectiveFromTimeKey <= v_MocTimeKey
                    AND T.EffectiveToTimeKey >= v_MocTimeKey
         ...
         , RefCustomerId, RefSystemAcId, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved, MocDate, MocTypeAlt_Key, CropDuration, Ac_ReviewAuthLevelAlt_Key )
           ( SELECT A.AccountEntityId ,
             ...
             FROM tt_AdvAcFinancialDetail_New_4 A
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."CUSTOMERACCOUNTMOC_04122023" TO "ADF_CDR_RBL_STGDB";
