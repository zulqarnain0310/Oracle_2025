--------------------------------------------------------
--  DDL for Function SMAMASTERINUP_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" 
(
      ...
      BEGIN
         ...
         BEGIN
                                       ...
                                       BEGIN
                                          ...
                                          BEGIN
                                             ...
                                             FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                                  --INNER JOIN tt_Temp_111 V  ON A.AccountEntityId=V.AccountEntityId
                                          ...
                                          BEGIN
                                             IF utils.object_id('TempDB..tt_Temp1_5') IS NOT NULL THEN
                                              EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp1_5 ';
                                             END IF;
                                             DELETE FROM tt_Temp1_5;
                                             UTILS.IDENTITY_RESET('tt_Temp1_5');

                                             INSERT INTO tt_Temp1_5 ( 
                                             ...
                                             --Select * from tt_Temp1_5
                                             IF utils.object_id('TEMPDB..tt_SplitValue_37') IS NOT NULL THEN
                                              EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_SplitValue_37 ';
                                             END IF;
                                             DELETE FROM tt_SplitValue_37;
                                             UTILS.IDENTITY_RESET('tt_SplitValue_37');

                                             INSERT INTO tt_SplitValue_37 ( 
                                             	SELECT AccountentityID ,
                                             ...
                                             --Select * from tt_SplitValue_37 
                                             DELETE tt_SplitValue_37

                                              WHERE  Businesscolvalues1 = 'SMA0';
                                             IF utils.object_id('TEMPDB..tt_NEWTRANCHE_82') IS NOT NULL THEN
                                              EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_NEWTRANCHE_82 ';
                                             END IF;
                                             DELETE FROM tt_NEWTRANCHE_82;
                                             UTILS.IDENTITY_RESET('tt_NEWTRANCHE_82');

                                             INSERT INTO tt_NEWTRANCHE_82 SELECT * 
                                                  FROM ( SELECT ss.AccountEntityID ,
                                                                utils.stuff(( SELECT ',' || US.BUSINESSCOLVALUES1 
                                                                              FROM tt_SplitValue_37 US
                                                                               WHERE  US.AccountentityID = ss.AccountEntityID ), 1, 1, ' ') REPORTIDSLIST  
                                                         FROM tt_Temp1_5 SS
                                                           GROUP BY ss.AccountEntityID ) B
                                                  ORDER BY 1;
                                             --Select * from tt_NEWTRANCHE_82
                                             --SELECT * 
                                             MERGE INTO A 
                                             USING (SELECT A.ROWID row_id, B.REPORTIDSLIST
                                             FROM A ,RBL_MISDB_PROD.AdvAcOtherDetail A
                                                    JOIN tt_NEWTRANCHE_82 B   ON A.AccountentityID = B.AccountentityID 
            ...
            BEGIN
               ...
               END IF;
               IF utils.object_id('Tempdb..tt_final_69') IS NOT NULL THEN
                EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_69 ';
               END IF;
               DELETE FROM tt_Temp_111;
               INSERT INTO tt_Temp_111
                 VALUES ( v_CustomerId, v_ValueAlt_Key, v_CustomerName );
               DELETE FROM tt_final_69;
               UTILS.IDENTITY_RESET('tt_final_69');

               INSERT INTO tt_final_69 ( 
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."SMAMASTERINUP_24012024" TO "ADF_CDR_RBL_STGDB";
