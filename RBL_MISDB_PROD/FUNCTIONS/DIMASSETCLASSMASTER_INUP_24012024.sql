--------------------------------------------------------
--  DDL for Function DIMASSETCLASSMASTER_INUP_24012024
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" 
(
...
BEGIN
   ...
   BEGIN
      ...
      END IF;
      -------------------------------------------------
      IF utils.object_id('Tempdb..tt_Temp_53') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_Temp_53 ';
      END IF;
      IF utils.object_id('Tempdb..tt_final_30') IS NOT NULL THEN
       EXECUTE IMMEDIATE ' TRUNCATE TABLE tt_final_30 ';
      END IF;
      DELETE FROM tt_Temp_53;
      INSERT INTO tt_Temp_53
        VALUES ( v_AssetClassAlt_Key, v_SourceAlt_Key, v_AssetClassName );
      DELETE FROM tt_final_30;
      UTILS.IDENTITY_RESET('tt_final_30');

      INSERT INTO tt_final_30 ( 
      ...
      EXECUTE IMMEDIATE ' ALTER TABLE tt_final_30 
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               FROM TEMP ,tt_final_30 TEMP
                      JOIN ( SELECT tt_final_30.SourceAlt_Key ,
                                    (v_AssetClassMappingAlt_Key + ROW_NUMBER() OVER ( ORDER BY ( SELECT 1 
                                                                                                   FROM DUAL  )  )) AssetClassMappingAlt_Key  
                             FROM tt_final_30 
                              WHERE  tt_final_30.AssetClassMappingAlt_Key = 0
                                       OR tt_final_30.AssetClassMappingAlt_Key IS NULL ) ACCT   ON TEMP.SourceAlt_Key = ACCT.SourceAlt_Key ) src
      ...
      BEGIN
         ...
         FROM TEMP ,tt_final_30 TEMP ) src
         ON ( TEMP.ROWID = src.row_id )
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               -----------------------------------------------------------
               --	IF Object_id('Tempdb..tt_Temp_53') Is Not Null
               --Drop Table tt_Temp_53
               --	IF Object_id('Tempdb..tt_final_30') Is Not Null
               --Drop Table tt_final_30
               --Create table tt_Temp_53
               --(AssetClassAlt_Key int
               --,SourceAlt_Key Varchar(20)
               --,AssetClassName	varchar(100)
               --)
               --Insert into tt_Temp_53 values(@AssetClassAlt_Key,@SourceAlt_Key,@AssetClassName)
               --Select A.Businesscolvalues1 as SourceAlt_Key,AssetClassName,AssetClassAlt_Key  into tt_final_30 From (
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."DIMASSETCLASSMASTER_INUP_24012024" TO "ADF_CDR_RBL_STGDB";
