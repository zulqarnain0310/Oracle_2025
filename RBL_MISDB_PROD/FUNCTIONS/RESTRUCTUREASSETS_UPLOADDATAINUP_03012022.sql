--------------------------------------------------------
--  DDL for Function RESTRUCTUREASSETS_UPLOADDATAINUP_03012022
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" 
(
         ...
         BEGIN
                  ...
                  , UploadID, RestructureFacility, RevisedBusinessSeg, DisbursementDate, ReferenceDate, InvocationDate, DateofConversionintoEquity, PrinRpymntStartDate, InttRpymntStartDate, AssetClassatRstrctr, IfNPANPADate, NPAQuarter, TypeofRestructuring, CovidMoratoriamMSME, CovidOTRCategory, BankingRelationship, DateofRestructuring, RestructuringApprovingAuth, DateofIstDefaultonCRILIC, ReportingBank, DateofSigningICA, OSasondateofRstrctr, POSasondateofRstrctr, InvestmentGrade, CreditProvisionRs, DFVProvisionRs, MTMProvisionRs, SheetName, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated )
                    ( 
                      ...
                      SELECT SrNo ,
                             ...
                             AssetClassatRstrctr ,
                             CASE 
                                  WHEN NPADate <> ' ' THEN UTILS.CONVERT_TO_VARCHAR2(NPADate,200)
                             ELSE NULL
                                END NPADate  ,
                             NPAQuarter ,
                             TypeofRestructuring ,
            ...
            BEGIN
               ...
               INSERT INTO CurDat_RBL_MISDB_PROD.AdvAcRestructureDetail
                 ( RefSystemAcId, AccountEntityId, RefCustomerId, RestructureCatgAlt_Key ---RestructureFacility
               , RevisedBusinessSegment ---RevisedBusinessSeg
               , DisbursementDate, RefDate, InvocationDate, ConversionDate, RepaymentStartDate, IntRepayStartDate, RestructureAssetClassAlt_key, PreRestrucNPA_Date, Npa_Qtr, RestructureTypeAlt_Key, Is_COVID_Morat, COVID_OTR_Catg, BankingType, RestructureDate, ApprovingAuthAlt_Key, CRILIC_Fst_DefaultDate, FstDefaultReportingBank --,ReportingBank  
               , ICA_SignDate, RestructureAmt, RestructurePOS, Is_InvestmentGrade, CreditProvision, DFVProvision, MTMProvision, AuthorisationStatus, EffectiveFromTimeKey, EffectiveToTimeKey, CreatedBy, DateCreated, ModifiedBy, DateModified, ApprovedBy, DateApproved )
                 ( SELECT AccountID ,
                          B.AccountEntityID ,
                          B.RefCustomerId ,
                          --,@ExcelUploadId
...
/
  ...
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "QPI_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ALERT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "DWH_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "MAIN_PRO";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "BS_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ACL_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ROLE_LOCAL_RBL_MISDB_PROD_ORACLE";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "PREMOC_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "QPI_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ALERT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "DWH_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "MAIN_PRO";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "D2KMNTR_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "CURDAT_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "BS_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ACL_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ETL_MAIN_RBL_MISDB_PROD";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "DATAUPLOAD_RBL_MISDB_PROD";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ROLE_ALL_DB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "CC_CDR_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_BI_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "BSG_READ_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "STD_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_TEMPDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "STG_FIN_RBL_STGDB";
  GRANT EXECUTE ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ADF_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ROLE_ALL_DB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "CC_CDR_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_BI_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "BSG_READ_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "STD_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ETL_TEMP_RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "RBL_TEMPDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "STG_FIN_RBL_STGDB";
  GRANT DEBUG ON "RBL_MISDB_PROD"."RESTRUCTUREASSETS_UPLOADDATAINUP_03012022" TO "ADF_CDR_RBL_STGDB";
