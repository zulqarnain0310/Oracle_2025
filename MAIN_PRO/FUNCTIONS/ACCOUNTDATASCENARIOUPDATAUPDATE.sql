...
BEGIN
   ...
   BEGIN
      ...
      FROM MAIN_PRO.ACCOUNTCAL  A
       WHERE A.CustomerAcID = v_CustomerAcid) src
      ...
      ELSE A.FraudDt
         END AS FraudDt
      FROM MAIN_PRO.CUSTOMERCAL A
             JOIN MAIN_PRO.ACCOUNTCAL B   ON A.RefCustomerID = B.RefCustomerID ) src
      ON ( A.ROWID = src.row_id )
