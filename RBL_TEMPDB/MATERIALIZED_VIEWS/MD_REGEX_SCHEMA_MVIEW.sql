...
--------------------------------------------------------
  ...
  CREATE MATERIALIZED VIEW "RBL_TEMPDB"."MD_REGEX_SCHEMA_MVIEW" ("PROJECT_ID", "CONNECTION_ID", "CONNECTION_NAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "ITEM", "VALUE")
 ...
 NOCOMPRESS LOGGING
  ...
  AS SELECT  PROJECT_ID, CONNECTION_ID, CONNECTION_NAME,CATALOG_ID,
   ...
   COMMENT ON MATERIALIZED VIEW "RBL_TEMPDB"."MD_REGEX_SCHEMA_MVIEW"  IS 'snapshot table for snapshot RBL_TEMPDB.MD_REGEX_SCHEMA_MVIEW';
